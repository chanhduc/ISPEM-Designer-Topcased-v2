...
public class WhitepaperPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, WhitepaperPropertiesEditionPart {
	...
	protected Composite createGuidanceAdvancedReferencesTable(Composite parent) {
		String label = getDescription(UmaViewsRepository.Whitepaper.Properties.guidance, UmaMessages.WhitepaperPropertiesEditionPart_GuidanceLabel);		 
	...
	protected Composite createMetricAdvancedReferencesTable(Composite parent) {
		String label = getDescription(UmaViewsRepository.Whitepaper.Properties.metric, UmaMessages.WhitepaperPropertiesEditionPart_MetricLabel);		 
	...
	protected Composite createCategoryAdvancedReferencesTable(Composite parent) {
		String label = getDescription(UmaViewsRepository.Whitepaper.Properties.category, UmaMessages.WhitepaperPropertiesEditionPart_CategoryLabel);		 
	...
	protected Composite createAuthorMultiValuedEditor(Composite parent) {
		...
		editAuthor.setText(getDescription(UmaViewsRepository.Whitepaper.Properties.author, UmaMessages.WhitepaperPropertiesEditionPart_AuthorLabel));
