 ...
 * 
 */
public class ArtifactDefinitionPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, ArtifactDefinitionPropertiesEditionPart {
	 ...
	 */
	public ArtifactDefinitionPropertiesEditionPartForm() { super(); }
	 ...
	 * 
	 */
	public ArtifactDefinitionPropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(IspemMessages.ArtifactDefinitionPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createKindFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		kind = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(IspemViewsRepository.ArtifactDefinition.Properties.kind, IspemViewsRepository.FORM_KIND));
		...
		kind.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArtifactDefinitionPropertiesEditionPartForm.this, IspemViewsRepository.ArtifactDefinition.Properties.kind, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getKind()));
			}

		});
		kind.setID(IspemViewsRepository.ArtifactDefinition.Properties.kind);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(IspemViewsRepository.ArtifactDefinition.Properties.kind, IspemViewsRepository.FORM_KIND), null); //$NON-NLS-1$
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							ArtifactDefinitionPropertiesEditionPartForm.this,
							IspemViewsRepository.ArtifactDefinition.Properties.presentationName,
		...
		presentationName.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArtifactDefinitionPropertiesEditionPartForm.this, IspemViewsRepository.ArtifactDefinition.Properties.presentationName, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, presentationName.getText()));
				}
			}
		});
		EditingUtils.setID(presentationName, IspemViewsRepository.ArtifactDefinition.Properties.presentationName);
		EditingUtils.setEEFtype(presentationName, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(IspemViewsRepository.ArtifactDefinition.Properties.presentationName, IspemViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createBriefDescriptionText(FormToolkit widgetFactory, Composite parent) {
		...
		briefDescription.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							ArtifactDefinitionPropertiesEditionPartForm.this,
							IspemViewsRepository.ArtifactDefinition.Properties.briefDescription,
		...
		briefDescription.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArtifactDefinitionPropertiesEditionPartForm.this, IspemViewsRepository.ArtifactDefinition.Properties.briefDescription, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, briefDescription.getText()));
				}
			}
		});
		EditingUtils.setID(briefDescription, IspemViewsRepository.ArtifactDefinition.Properties.briefDescription);
		EditingUtils.setEEFtype(briefDescription, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(IspemViewsRepository.ArtifactDefinition.Properties.briefDescription, IspemViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createMainDescriptionText(FormToolkit widgetFactory, Composite parent) {
		...
		mainDescription.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							ArtifactDefinitionPropertiesEditionPartForm.this,
							IspemViewsRepository.ArtifactDefinition.Properties.mainDescription,
		...
		mainDescription.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArtifactDefinitionPropertiesEditionPartForm.this, IspemViewsRepository.ArtifactDefinition.Properties.mainDescription, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, mainDescription.getText()));
				}
			}
		});
		EditingUtils.setID(mainDescription, IspemViewsRepository.ArtifactDefinition.Properties.mainDescription);
		EditingUtils.setEEFtype(mainDescription, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(IspemViewsRepository.ArtifactDefinition.Properties.mainDescription, IspemViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createPurposeText(FormToolkit widgetFactory, Composite parent) {
		...
		purpose.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							ArtifactDefinitionPropertiesEditionPartForm.this,
							IspemViewsRepository.ArtifactDefinition.Properties.purpose,
		...
		purpose.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArtifactDefinitionPropertiesEditionPartForm.this, IspemViewsRepository.ArtifactDefinition.Properties.purpose, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, purpose.getText()));
				}
			}
		});
		EditingUtils.setID(purpose, IspemViewsRepository.ArtifactDefinition.Properties.purpose);
		EditingUtils.setEEFtype(purpose, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(IspemViewsRepository.ArtifactDefinition.Properties.purpose, IspemViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createGuidanceReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.guidance = new ReferencesTable(getDescription(IspemViewsRepository.ArtifactDefinition.Properties.guidance, IspemMessages.ArtifactDefinitionPropertiesEditionPart_GuidanceLabel), new ReferencesTableListener	() {
		...
		this.guidance.setHelpText(propertiesEditionComponent.getHelpContent(IspemViewsRepository.ArtifactDefinition.Properties.guidance, IspemViewsRepository.FORM_KIND));
		this.guidance.createControls(parent, widgetFactory);
		this.guidance.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArtifactDefinitionPropertiesEditionPartForm.this, IspemViewsRepository.ArtifactDefinition.Properties.guidance, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		"guidance", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArtifactDefinitionPropertiesEditionPartForm.this, IspemViewsRepository.ArtifactDefinition.Properties.guidance,
	...
	protected void moveGuidance(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArtifactDefinitionPropertiesEditionPartForm.this, IspemViewsRepository.ArtifactDefinition.Properties.guidance, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		guidance.refresh();
	}
	...
	protected void removeFromGuidance(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArtifactDefinitionPropertiesEditionPartForm.this, IspemViewsRepository.ArtifactDefinition.Properties.guidance, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		guidance.refresh();
	}
	...
	protected Composite createMetricReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.metric = new ReferencesTable(getDescription(IspemViewsRepository.ArtifactDefinition.Properties.metric, IspemMessages.ArtifactDefinitionPropertiesEditionPart_MetricLabel), new ReferencesTableListener	() {
		...
		this.metric.setHelpText(propertiesEditionComponent.getHelpContent(IspemViewsRepository.ArtifactDefinition.Properties.metric, IspemViewsRepository.FORM_KIND));
		this.metric.createControls(parent, widgetFactory);
		this.metric.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArtifactDefinitionPropertiesEditionPartForm.this, IspemViewsRepository.ArtifactDefinition.Properties.metric, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addMetric() {
		...
		"metric", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArtifactDefinitionPropertiesEditionPartForm.this, IspemViewsRepository.ArtifactDefinition.Properties.metric,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
				metric.refresh();
			}
	...
	protected void moveMetric(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArtifactDefinitionPropertiesEditionPartForm.this, IspemViewsRepository.ArtifactDefinition.Properties.metric, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		metric.refresh();
	}
	...
	protected void removeFromMetric(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArtifactDefinitionPropertiesEditionPartForm.this, IspemViewsRepository.ArtifactDefinition.Properties.metric, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		metric.refresh();
	}
	...
	protected Composite createCategoryReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.category = new ReferencesTable(getDescription(IspemViewsRepository.ArtifactDefinition.Properties.category, IspemMessages.ArtifactDefinitionPropertiesEditionPart_CategoryLabel), new ReferencesTableListener	() {
		...
		this.category.setHelpText(propertiesEditionComponent.getHelpContent(IspemViewsRepository.ArtifactDefinition.Properties.category, IspemViewsRepository.FORM_KIND));
		this.category.createControls(parent, widgetFactory);
		this.category.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArtifactDefinitionPropertiesEditionPartForm.this, IspemViewsRepository.ArtifactDefinition.Properties.category, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addCategory() {
		...
		"category", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArtifactDefinitionPropertiesEditionPartForm.this, IspemViewsRepository.ArtifactDefinition.Properties.category,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
				category.refresh();
			}
	...
	protected void moveCategory(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArtifactDefinitionPropertiesEditionPartForm.this, IspemViewsRepository.ArtifactDefinition.Properties.category, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		category.refresh();
	}
	...
	protected void removeFromCategory(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArtifactDefinitionPropertiesEditionPartForm.this, IspemViewsRepository.ArtifactDefinition.Properties.category, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		category.refresh();
	}
	...
	protected Composite createCopyrightText(FormToolkit widgetFactory, Composite parent) {
		...
		copyright.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							ArtifactDefinitionPropertiesEditionPartForm.this,
							IspemViewsRepository.ArtifactDefinition.Properties.copyright,
		...
		copyright.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArtifactDefinitionPropertiesEditionPartForm.this, IspemViewsRepository.ArtifactDefinition.Properties.copyright, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, copyright.getText()));
				}
			}
		});
		EditingUtils.setID(copyright, IspemViewsRepository.ArtifactDefinition.Properties.copyright);
		EditingUtils.setEEFtype(copyright, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(IspemViewsRepository.ArtifactDefinition.Properties.copyright, IspemViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createAuthorMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
		...
		editAuthor = widgetFactory.createButton(parent, getDescription(IspemViewsRepository.ArtifactDefinition.Properties.author, IspemMessages.ArtifactDefinitionPropertiesEditionPart_AuthorLabel), SWT.NONE);
		...
		editAuthor.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				if (dialog.open() == Window.OK) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArtifactDefinitionPropertiesEditionPartForm.this, IspemViewsRepository.ArtifactDefinition.Properties.author, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new BasicEList(authorList)));
					setHasChanged(true);
				}
			}
		});
	...
	protected Composite createChangeDateText(FormToolkit widgetFactory, Composite parent) {
		...
		changeDate.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							ArtifactDefinitionPropertiesEditionPartForm.this,
							IspemViewsRepository.ArtifactDefinition.Properties.changeDate,
		...
		changeDate.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArtifactDefinitionPropertiesEditionPartForm.this, IspemViewsRepository.ArtifactDefinition.Properties.changeDate, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, changeDate.getText()));
				}
			}
		});
		EditingUtils.setID(changeDate, IspemViewsRepository.ArtifactDefinition.Properties.changeDate);
		EditingUtils.setEEFtype(changeDate, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(IspemViewsRepository.ArtifactDefinition.Properties.changeDate, IspemViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createChangeDescriptionText(FormToolkit widgetFactory, Composite parent) {
		...
		changeDescription.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							ArtifactDefinitionPropertiesEditionPartForm.this,
							IspemViewsRepository.ArtifactDefinition.Properties.changeDescription,
		...
		changeDescription.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArtifactDefinitionPropertiesEditionPartForm.this, IspemViewsRepository.ArtifactDefinition.Properties.changeDescription, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, changeDescription.getText()));
				}
			}
		});
		EditingUtils.setID(changeDescription, IspemViewsRepository.ArtifactDefinition.Properties.changeDescription);
		EditingUtils.setEEFtype(changeDescription, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(IspemViewsRepository.ArtifactDefinition.Properties.changeDescription, IspemViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createVersionText(FormToolkit widgetFactory, Composite parent) {
		...
		version.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							ArtifactDefinitionPropertiesEditionPartForm.this,
							IspemViewsRepository.ArtifactDefinition.Properties.version,
		...
		version.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArtifactDefinitionPropertiesEditionPartForm.this, IspemViewsRepository.ArtifactDefinition.Properties.version, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, version.getText()));
				}
			}
		});
		EditingUtils.setID(version, IspemViewsRepository.ArtifactDefinition.Properties.version);
		EditingUtils.setEEFtype(version, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(IspemViewsRepository.ArtifactDefinition.Properties.version, IspemViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createUriText(FormToolkit widgetFactory, Composite parent) {
		...
		uri.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							ArtifactDefinitionPropertiesEditionPartForm.this,
							IspemViewsRepository.ArtifactDefinition.Properties.uri,
		...
		uri.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArtifactDefinitionPropertiesEditionPartForm.this, IspemViewsRepository.ArtifactDefinition.Properties.uri, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, uri.getText()));
				}
			}
		});
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(IspemViewsRepository.ArtifactDefinition.Properties.uri, IspemViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							ArtifactDefinitionPropertiesEditionPartForm.this,
							IspemViewsRepository.ArtifactDefinition.Properties.name,
		...
		name.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArtifactDefinitionPropertiesEditionPartForm.this, IspemViewsRepository.ArtifactDefinition.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
				}
			}
		});
		EditingUtils.setID(name, IspemViewsRepository.ArtifactDefinition.Properties.name);
		EditingUtils.setEEFtype(name, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(IspemViewsRepository.ArtifactDefinition.Properties.name, IspemViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createVariabilityTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
		...
		variabilityType.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArtifactDefinitionPropertiesEditionPartForm.this, IspemViewsRepository.ArtifactDefinition.Properties.variabilityType, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getVariabilityType()));
			}

		});
		variabilityType.setID(IspemViewsRepository.ArtifactDefinition.Properties.variabilityType);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(IspemViewsRepository.ArtifactDefinition.Properties.variabilityType, IspemViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createVariabilityBasedOnElementFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		variabilityBasedOnElement = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(IspemViewsRepository.ArtifactDefinition.Properties.variabilityBasedOnElement, IspemViewsRepository.FORM_KIND));
		...
		variabilityBasedOnElement.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArtifactDefinitionPropertiesEditionPartForm.this, IspemViewsRepository.ArtifactDefinition.Properties.variabilityBasedOnElement, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getVariabilityBasedOnElement()));
			}

		});
		variabilityBasedOnElement.setID(IspemViewsRepository.ArtifactDefinition.Properties.variabilityBasedOnElement);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(IspemViewsRepository.ArtifactDefinition.Properties.variabilityBasedOnElement, IspemViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createMethodContentKindFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		methodContentKind = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(IspemViewsRepository.ArtifactDefinition.Properties.methodContentKind, IspemViewsRepository.FORM_KIND));
		...
		methodContentKind.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArtifactDefinitionPropertiesEditionPartForm.this, IspemViewsRepository.ArtifactDefinition.Properties.methodContentKind, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getMethodContentKind()));
			}

		});
		methodContentKind.setID(IspemViewsRepository.ArtifactDefinition.Properties.methodContentKind);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(IspemViewsRepository.ArtifactDefinition.Properties.methodContentKind, IspemViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createRootElementFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		rootElement = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(IspemViewsRepository.ArtifactDefinition.Properties.rootElement, IspemViewsRepository.FORM_KIND));
		...
		rootElement.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArtifactDefinitionPropertiesEditionPartForm.this, IspemViewsRepository.ArtifactDefinition.Properties.rootElement, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getRootElement()));
			}

		});
		rootElement.setID(IspemViewsRepository.ArtifactDefinition.Properties.rootElement);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(IspemViewsRepository.ArtifactDefinition.Properties.rootElement, IspemViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createUsedReferencesReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.usedReferences = new ReferencesTable(getDescription(IspemViewsRepository.ArtifactDefinition.Properties.usedReferences, IspemMessages.ArtifactDefinitionPropertiesEditionPart_UsedReferencesLabel), new ReferencesTableListener	() {
		...
		this.usedReferences.setHelpText(propertiesEditionComponent.getHelpContent(IspemViewsRepository.ArtifactDefinition.Properties.usedReferences, IspemViewsRepository.FORM_KIND));
		this.usedReferences.createControls(parent, widgetFactory);
		this.usedReferences.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArtifactDefinitionPropertiesEditionPartForm.this, IspemViewsRepository.ArtifactDefinition.Properties.usedReferences, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addUsedReferences() {
		...
		"usedReferences", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArtifactDefinitionPropertiesEditionPartForm.this, IspemViewsRepository.ArtifactDefinition.Properties.usedReferences,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveUsedReferences(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArtifactDefinitionPropertiesEditionPartForm.this, IspemViewsRepository.ArtifactDefinition.Properties.usedReferences, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		usedReferences.refresh();
	}
	...
	protected void removeFromUsedReferences(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArtifactDefinitionPropertiesEditionPartForm.this, IspemViewsRepository.ArtifactDefinition.Properties.usedReferences, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		usedReferences.refresh();
	}
	...
	protected Composite createMetamodelFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		metamodel = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(IspemViewsRepository.ArtifactDefinition.Properties.metamodel, IspemViewsRepository.FORM_KIND));
		...
		metamodel.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ArtifactDefinitionPropertiesEditionPartForm.this, IspemViewsRepository.ArtifactDefinition.Properties.metamodel, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getMetamodel()));
			}

		});
		metamodel.setID(IspemViewsRepository.ArtifactDefinition.Properties.metamodel);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(IspemViewsRepository.ArtifactDefinition.Properties.metamodel, IspemViewsRepository.FORM_KIND), null); //$NON-NLS-1$
