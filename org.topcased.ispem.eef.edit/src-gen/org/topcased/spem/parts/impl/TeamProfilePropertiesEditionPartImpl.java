...
public class TeamProfilePropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, TeamProfilePropertiesEditionPart {
	...
	protected Composite createGuidanceAdvancedReferencesTable(Composite parent) {
		String label = getDescription(SpemViewsRepository.TeamProfile.Properties.guidance, SpemMessages.TeamProfilePropertiesEditionPart_GuidanceLabel);		 
	...
	protected Composite createMetricAdvancedReferencesTable(Composite parent) {
		String label = getDescription(SpemViewsRepository.TeamProfile.Properties.metric, SpemMessages.TeamProfilePropertiesEditionPart_MetricLabel);		 
	...
	protected Composite createCategoryAdvancedReferencesTable(Composite parent) {
		String label = getDescription(SpemViewsRepository.TeamProfile.Properties.category, SpemMessages.TeamProfilePropertiesEditionPart_CategoryLabel);		 
	...
	protected Composite createAuthorMultiValuedEditor(Composite parent) {
		...
		editAuthor.setText(getDescription(SpemViewsRepository.TeamProfile.Properties.author, SpemMessages.TeamProfilePropertiesEditionPart_AuthorLabel));
	...
	protected Composite createHasMultipleOccurrencesCheckbox(Composite parent) {
		...
		hasMultipleOccurrences.setText(getDescription(SpemViewsRepository.TeamProfile.Properties.hasMultipleOccurrences, SpemMessages.TeamProfilePropertiesEditionPart_HasMultipleOccurrencesLabel));
	...
	protected Composite createIsOptionalCheckbox(Composite parent) {
		...
		isOptional.setText(getDescription(SpemViewsRepository.TeamProfile.Properties.isOptional, SpemMessages.TeamProfilePropertiesEditionPart_IsOptionalLabel));
	...
	protected Composite createIsPlannedCheckbox(Composite parent) {
		...
		isPlanned.setText(getDescription(SpemViewsRepository.TeamProfile.Properties.isPlanned, SpemMessages.TeamProfilePropertiesEditionPart_IsPlannedLabel));
	...
	protected Composite createTeamRoleAdvancedReferencesTable(Composite parent) {
		String label = getDescription(SpemViewsRepository.TeamProfile.Properties.teamRole, SpemMessages.TeamProfilePropertiesEditionPart_TeamRoleLabel);		 
		this.teamRole = new ReferencesTable(label, new ReferencesTableListener() {
