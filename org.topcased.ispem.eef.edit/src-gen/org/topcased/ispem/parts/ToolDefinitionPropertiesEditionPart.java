...
public interface ToolDefinitionPropertiesEditionPart {
	...
	/**
	 * Init the supportedEngineringDomain
	 * @param settings settings for the supportedEngineringDomain ReferencesTable 
	 */
	public void initSupportedEngineringDomain(ReferencesTableSettings settings);

	/**
	 * Update the supportedEngineringDomain
	 * @param newValue the supportedEngineringDomain to update
	 * 
	 */
	public void updateSupportedEngineringDomain();

	/**
	 * Adds the given filter to the supportedEngineringDomain edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return true if the given element is contained inside the supportedEngineringDomain table
	 * 
	 */
	...
	/**
	 * Init the supportedRepresentativeLanguage
	 * @param settings settings for the supportedRepresentativeLanguage ReferencesTable 
	 */
	public void initSupportedRepresentativeLanguage(ReferencesTableSettings settings);

	/**
	 * Update the supportedRepresentativeLanguage
	 * @param newValue the supportedRepresentativeLanguage to update
	 * 
	 */
	public void updateSupportedRepresentativeLanguage();

	/**
	 * Adds the given filter to the supportedRepresentativeLanguage edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return true if the given element is contained inside the supportedRepresentativeLanguage table
	 * 
	 */
