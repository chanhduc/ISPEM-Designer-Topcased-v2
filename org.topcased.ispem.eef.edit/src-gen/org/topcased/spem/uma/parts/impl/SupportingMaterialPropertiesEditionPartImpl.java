...
public class SupportingMaterialPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, SupportingMaterialPropertiesEditionPart {
	...
	protected Composite createGuidanceAdvancedReferencesTable(Composite parent) {
		String label = getDescription(UmaViewsRepository.SupportingMaterial.Properties.guidance, UmaMessages.SupportingMaterialPropertiesEditionPart_GuidanceLabel);		 
	...
	protected Composite createMetricAdvancedReferencesTable(Composite parent) {
		String label = getDescription(UmaViewsRepository.SupportingMaterial.Properties.metric, UmaMessages.SupportingMaterialPropertiesEditionPart_MetricLabel);		 
	...
	protected Composite createCategoryAdvancedReferencesTable(Composite parent) {
		String label = getDescription(UmaViewsRepository.SupportingMaterial.Properties.category, UmaMessages.SupportingMaterialPropertiesEditionPart_CategoryLabel);		 
	...
	protected Composite createAuthorMultiValuedEditor(Composite parent) {
		...
		editAuthor.setText(getDescription(UmaViewsRepository.SupportingMaterial.Properties.author, UmaMessages.SupportingMaterialPropertiesEditionPart_AuthorLabel));
