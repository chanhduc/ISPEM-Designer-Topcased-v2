 ...
 * 
 */
public class CompositeRolePropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, CompositeRolePropertiesEditionPart {
	 ...
	 */
	public CompositeRolePropertiesEditionPartForm() { super(); }
	...
	protected Composite createKindFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		createDescription(parent, SpemViewsRepository.CompositeRole.Properties.kind, SpemMessages.CompositeRolePropertiesEditionPart_KindLabel);
	...
	protected Composite createPresentationNameText(FormToolkit widgetFactory, Composite parent) {
		createDescription(parent, SpemViewsRepository.CompositeRole.Properties.presentationName, SpemMessages.CompositeRolePropertiesEditionPart_PresentationNameLabel);
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							CompositeRolePropertiesEditionPartForm.this,
							SpemViewsRepository.CompositeRole.Properties.presentationName,
	...
	protected Composite createBriefDescriptionText(FormToolkit widgetFactory, Composite parent) {
		createDescription(parent, SpemViewsRepository.CompositeRole.Properties.briefDescription, SpemMessages.CompositeRolePropertiesEditionPart_BriefDescriptionLabel);
		...
		briefDescription.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							CompositeRolePropertiesEditionPartForm.this,
							SpemViewsRepository.CompositeRole.Properties.briefDescription,
	...
	protected Composite createMainDescriptionText(FormToolkit widgetFactory, Composite parent) {
		createDescription(parent, SpemViewsRepository.CompositeRole.Properties.mainDescription, SpemMessages.CompositeRolePropertiesEditionPart_MainDescriptionLabel);
		...
		mainDescription.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							CompositeRolePropertiesEditionPartForm.this,
							SpemViewsRepository.CompositeRole.Properties.mainDescription,
	...
	protected Composite createPurposeText(FormToolkit widgetFactory, Composite parent) {
		createDescription(parent, SpemViewsRepository.CompositeRole.Properties.purpose, SpemMessages.CompositeRolePropertiesEditionPart_PurposeLabel);
		...
		purpose.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							CompositeRolePropertiesEditionPartForm.this,
							SpemViewsRepository.CompositeRole.Properties.purpose,
	...
	protected Composite createGuidanceReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.guidance = new ReferencesTable(getDescription(SpemViewsRepository.CompositeRole.Properties.guidance, SpemMessages.CompositeRolePropertiesEditionPart_GuidanceLabel), new ReferencesTableListener	() {
	...
	protected Composite createMetricReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.metric = new ReferencesTable(getDescription(SpemViewsRepository.CompositeRole.Properties.metric, SpemMessages.CompositeRolePropertiesEditionPart_MetricLabel), new ReferencesTableListener	() {
	...
	protected Composite createCategoryReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.category = new ReferencesTable(getDescription(SpemViewsRepository.CompositeRole.Properties.category, SpemMessages.CompositeRolePropertiesEditionPart_CategoryLabel), new ReferencesTableListener	() {
	...
	protected Composite createCopyrightText(FormToolkit widgetFactory, Composite parent) {
		createDescription(parent, SpemViewsRepository.CompositeRole.Properties.copyright, SpemMessages.CompositeRolePropertiesEditionPart_CopyrightLabel);
		...
		copyright.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							CompositeRolePropertiesEditionPartForm.this,
							SpemViewsRepository.CompositeRole.Properties.copyright,
	...
	protected Composite createAuthorMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
		...
		editAuthor = widgetFactory.createButton(parent, getDescription(SpemViewsRepository.CompositeRole.Properties.author, SpemMessages.CompositeRolePropertiesEditionPart_AuthorLabel), SWT.NONE);
	...
	protected Composite createChangeDateText(FormToolkit widgetFactory, Composite parent) {
		createDescription(parent, SpemViewsRepository.CompositeRole.Properties.changeDate, SpemMessages.CompositeRolePropertiesEditionPart_ChangeDateLabel);
		...
		changeDate.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							CompositeRolePropertiesEditionPartForm.this,
							SpemViewsRepository.CompositeRole.Properties.changeDate,
	...
	protected Composite createChangeDescriptionText(FormToolkit widgetFactory, Composite parent) {
		createDescription(parent, SpemViewsRepository.CompositeRole.Properties.changeDescription, SpemMessages.CompositeRolePropertiesEditionPart_ChangeDescriptionLabel);
		...
		changeDescription.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							CompositeRolePropertiesEditionPartForm.this,
							SpemViewsRepository.CompositeRole.Properties.changeDescription,
	...
	protected Composite createVersionText(FormToolkit widgetFactory, Composite parent) {
		createDescription(parent, SpemViewsRepository.CompositeRole.Properties.version, SpemMessages.CompositeRolePropertiesEditionPart_VersionLabel);
		...
		version.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							CompositeRolePropertiesEditionPartForm.this,
							SpemViewsRepository.CompositeRole.Properties.version,
	...
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		createDescription(parent, SpemViewsRepository.CompositeRole.Properties.name, SpemMessages.CompositeRolePropertiesEditionPart_NameLabel);
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							CompositeRolePropertiesEditionPartForm.this,
							SpemViewsRepository.CompositeRole.Properties.name,
	...
	protected Composite createHasMultipleOccurrencesCheckbox(FormToolkit widgetFactory, Composite parent) {
		hasMultipleOccurrences = widgetFactory.createButton(parent, getDescription(SpemViewsRepository.CompositeRole.Properties.hasMultipleOccurrences, SpemMessages.CompositeRolePropertiesEditionPart_HasMultipleOccurrencesLabel), SWT.CHECK);
	...
	protected Composite createIsOptionalCheckbox(FormToolkit widgetFactory, Composite parent) {
		isOptional = widgetFactory.createButton(parent, getDescription(SpemViewsRepository.CompositeRole.Properties.isOptional, SpemMessages.CompositeRolePropertiesEditionPart_IsOptionalLabel), SWT.CHECK);
	...
	protected Composite createIsPlannedCheckbox(FormToolkit widgetFactory, Composite parent) {
		isPlanned = widgetFactory.createButton(parent, getDescription(SpemViewsRepository.CompositeRole.Properties.isPlanned, SpemMessages.CompositeRolePropertiesEditionPart_IsPlannedLabel), SWT.CHECK);
	...
	protected Composite createIsSynchronizedWithSourceCheckbox(FormToolkit widgetFactory, Composite parent) {
		isSynchronizedWithSource = widgetFactory.createButton(parent, getDescription(SpemViewsRepository.CompositeRole.Properties.isSynchronizedWithSource, SpemMessages.CompositeRolePropertiesEditionPart_IsSynchronizedWithSourceLabel), SWT.CHECK);
	...
	protected Composite createRoleFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		createDescription(parent, SpemViewsRepository.CompositeRole.Properties.role, SpemMessages.CompositeRolePropertiesEditionPart_RoleLabel);
	...
	protected Composite createAppliedQualificationReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.appliedQualification = new ReferencesTable(getDescription(SpemViewsRepository.CompositeRole.Properties.appliedQualification, SpemMessages.CompositeRolePropertiesEditionPart_AppliedQualificationLabel), new ReferencesTableListener	() {
		...
		// Start of user code for createAppliedQualificationReferencesTable
	...
	protected Composite createAggregatedRoleReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.aggregatedRole = new ReferencesTable(getDescription(SpemViewsRepository.CompositeRole.Properties.aggregatedRole, SpemMessages.CompositeRolePropertiesEditionPart_AggregatedRoleLabel), new ReferencesTableListener	() {
		...
		// Start of user code for createAggregatedRoleReferencesTable
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.CompositeRolePropertiesEditionPart#getKind()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.CompositeRolePropertiesEditionPart#initKind(EObjectFlatComboSettings)
	 */
	public void initKind(EObjectFlatComboSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.CompositeRole.Properties.kind);
		if (eefElementEditorReadOnlyState && kind.isEnabled()) {
			kind.setEnabled(false);
			kind.setToolTipText(SpemMessages.CompositeRole_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.CompositeRolePropertiesEditionPart#setKind(EObject newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.CompositeRolePropertiesEditionPart#setKindButtonMode(ButtonsModeEnum newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.CompositeRolePropertiesEditionPart#addFilterKind(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.CompositeRolePropertiesEditionPart#addBusinessFilterKind(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.CompositeRolePropertiesEditionPart#getPresentationName()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.CompositeRolePropertiesEditionPart#setPresentationName(String newValue)
	 * 
	 */
	public void setPresentationName(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.CompositeRole.Properties.presentationName);
		if (eefElementEditorReadOnlyState && presentationName.isEnabled()) {
			presentationName.setEnabled(false);
			presentationName.setToolTipText(SpemMessages.CompositeRole_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.CompositeRolePropertiesEditionPart#getBriefDescription()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.CompositeRolePropertiesEditionPart#setBriefDescription(String newValue)
	 * 
	 */
	public void setBriefDescription(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.CompositeRole.Properties.briefDescription);
		if (eefElementEditorReadOnlyState && briefDescription.isEnabled()) {
			briefDescription.setEnabled(false);
			briefDescription.setToolTipText(SpemMessages.CompositeRole_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.CompositeRolePropertiesEditionPart#getMainDescription()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.CompositeRolePropertiesEditionPart#setMainDescription(String newValue)
	 * 
	 */
	public void setMainDescription(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.CompositeRole.Properties.mainDescription);
		if (eefElementEditorReadOnlyState && mainDescription.isEnabled()) {
			mainDescription.setEnabled(false);
			mainDescription.setToolTipText(SpemMessages.CompositeRole_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.CompositeRolePropertiesEditionPart#getPurpose()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.CompositeRolePropertiesEditionPart#setPurpose(String newValue)
	 * 
	 */
	public void setPurpose(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.CompositeRole.Properties.purpose);
		if (eefElementEditorReadOnlyState && purpose.isEnabled()) {
			purpose.setEnabled(false);
			purpose.setToolTipText(SpemMessages.CompositeRole_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.CompositeRolePropertiesEditionPart#initGuidance(org.eclipse.emf.eef.runtime.ui.widgets.referencestable.ReferencesTableSettings)
	 */
	public void initGuidance(ReferencesTableSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.CompositeRole.Properties.guidance);
		if (eefElementEditorReadOnlyState && guidance.getTable().isEnabled()) {
			guidance.setEnabled(false);
			guidance.setToolTipText(SpemMessages.CompositeRole_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.CompositeRolePropertiesEditionPart#updateGuidance()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.CompositeRolePropertiesEditionPart#addFilterGuidance(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.CompositeRolePropertiesEditionPart#addBusinessFilterGuidance(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.CompositeRolePropertiesEditionPart#isContainedInGuidanceTable(EObject element)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.CompositeRolePropertiesEditionPart#initMetric(org.eclipse.emf.eef.runtime.ui.widgets.referencestable.ReferencesTableSettings)
	 */
	public void initMetric(ReferencesTableSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.CompositeRole.Properties.metric);
		if (eefElementEditorReadOnlyState && metric.getTable().isEnabled()) {
			metric.setEnabled(false);
			metric.setToolTipText(SpemMessages.CompositeRole_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.CompositeRolePropertiesEditionPart#updateMetric()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.CompositeRolePropertiesEditionPart#addFilterMetric(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.CompositeRolePropertiesEditionPart#addBusinessFilterMetric(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.CompositeRolePropertiesEditionPart#isContainedInMetricTable(EObject element)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.CompositeRolePropertiesEditionPart#initCategory(org.eclipse.emf.eef.runtime.ui.widgets.referencestable.ReferencesTableSettings)
	 */
	public void initCategory(ReferencesTableSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.CompositeRole.Properties.category);
		if (eefElementEditorReadOnlyState && category.getTable().isEnabled()) {
			category.setEnabled(false);
			category.setToolTipText(SpemMessages.CompositeRole_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.CompositeRolePropertiesEditionPart#updateCategory()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.CompositeRolePropertiesEditionPart#addFilterCategory(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.CompositeRolePropertiesEditionPart#addBusinessFilterCategory(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.CompositeRolePropertiesEditionPart#isContainedInCategoryTable(EObject element)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.CompositeRolePropertiesEditionPart#getCopyright()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.CompositeRolePropertiesEditionPart#setCopyright(String newValue)
	 * 
	 */
	public void setCopyright(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.CompositeRole.Properties.copyright);
		if (eefElementEditorReadOnlyState && copyright.isEnabled()) {
			copyright.setEnabled(false);
			copyright.setToolTipText(SpemMessages.CompositeRole_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.CompositeRolePropertiesEditionPart#getAuthor()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.CompositeRolePropertiesEditionPart#setAuthor(EList newValue)
	 * 
	 */
	public void setAuthor(EList newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.CompositeRole.Properties.author);
		if (eefElementEditorReadOnlyState && author.isEnabled()) {
			author.setEnabled(false);
			author.setToolTipText(SpemMessages.CompositeRole_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.CompositeRolePropertiesEditionPart#getChangeDate()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.CompositeRolePropertiesEditionPart#setChangeDate(String newValue)
	 * 
	 */
	public void setChangeDate(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.CompositeRole.Properties.changeDate);
		if (eefElementEditorReadOnlyState && changeDate.isEnabled()) {
			changeDate.setEnabled(false);
			changeDate.setToolTipText(SpemMessages.CompositeRole_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.CompositeRolePropertiesEditionPart#getChangeDescription()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.CompositeRolePropertiesEditionPart#setChangeDescription(String newValue)
	 * 
	 */
	public void setChangeDescription(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.CompositeRole.Properties.changeDescription);
		if (eefElementEditorReadOnlyState && changeDescription.isEnabled()) {
			changeDescription.setEnabled(false);
			changeDescription.setToolTipText(SpemMessages.CompositeRole_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.CompositeRolePropertiesEditionPart#getVersion()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.CompositeRolePropertiesEditionPart#setVersion(String newValue)
	 * 
	 */
	public void setVersion(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.CompositeRole.Properties.version);
		if (eefElementEditorReadOnlyState && version.isEnabled()) {
			version.setEnabled(false);
			version.setToolTipText(SpemMessages.CompositeRole_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.CompositeRolePropertiesEditionPart#getName()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.CompositeRolePropertiesEditionPart#setName(String newValue)
	 * 
	 */
	public void setName(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.CompositeRole.Properties.name);
		if (eefElementEditorReadOnlyState && name.isEnabled()) {
			name.setEnabled(false);
			name.setToolTipText(SpemMessages.CompositeRole_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.CompositeRolePropertiesEditionPart#getHasMultipleOccurrences()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.CompositeRolePropertiesEditionPart#setHasMultipleOccurrences(Boolean newValue)
	 * 
	 */
	public void setHasMultipleOccurrences(Boolean newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.CompositeRole.Properties.hasMultipleOccurrences);
		if (eefElementEditorReadOnlyState && hasMultipleOccurrences.isEnabled()) {
			hasMultipleOccurrences.setEnabled(false);
			hasMultipleOccurrences.setToolTipText(SpemMessages.CompositeRole_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.CompositeRolePropertiesEditionPart#getIsOptional()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.CompositeRolePropertiesEditionPart#setIsOptional(Boolean newValue)
	 * 
	 */
	public void setIsOptional(Boolean newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.CompositeRole.Properties.isOptional);
		if (eefElementEditorReadOnlyState && isOptional.isEnabled()) {
			isOptional.setEnabled(false);
			isOptional.setToolTipText(SpemMessages.CompositeRole_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.CompositeRolePropertiesEditionPart#getIsPlanned()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.CompositeRolePropertiesEditionPart#setIsPlanned(Boolean newValue)
	 * 
	 */
	public void setIsPlanned(Boolean newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.CompositeRole.Properties.isPlanned);
		if (eefElementEditorReadOnlyState && isPlanned.isEnabled()) {
			isPlanned.setEnabled(false);
			isPlanned.setToolTipText(SpemMessages.CompositeRole_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.CompositeRolePropertiesEditionPart#getIsSynchronizedWithSource()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.CompositeRolePropertiesEditionPart#setIsSynchronizedWithSource(Boolean newValue)
	 * 
	 */
	public void setIsSynchronizedWithSource(Boolean newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.CompositeRole.Properties.isSynchronizedWithSource);
		if (eefElementEditorReadOnlyState && isSynchronizedWithSource.isEnabled()) {
			isSynchronizedWithSource.setEnabled(false);
			isSynchronizedWithSource.setToolTipText(SpemMessages.CompositeRole_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.CompositeRolePropertiesEditionPart#getRole()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.CompositeRolePropertiesEditionPart#initRole(EObjectFlatComboSettings)
	 */
	public void initRole(EObjectFlatComboSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.CompositeRole.Properties.role);
		if (eefElementEditorReadOnlyState && role.isEnabled()) {
			role.setEnabled(false);
			role.setToolTipText(SpemMessages.CompositeRole_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.CompositeRolePropertiesEditionPart#setRole(EObject newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.CompositeRolePropertiesEditionPart#setRoleButtonMode(ButtonsModeEnum newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.CompositeRolePropertiesEditionPart#addFilterRole(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.CompositeRolePropertiesEditionPart#addBusinessFilterRole(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.CompositeRolePropertiesEditionPart#initAppliedQualification(org.eclipse.emf.eef.runtime.ui.widgets.referencestable.ReferencesTableSettings)
	 */
	public void initAppliedQualification(ReferencesTableSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.CompositeRole.Properties.appliedQualification);
		if (eefElementEditorReadOnlyState && appliedQualification.getTable().isEnabled()) {
			appliedQualification.setEnabled(false);
			appliedQualification.setToolTipText(SpemMessages.CompositeRole_ReadOnly);
		} else if (!eefElementEditorReadOnlyState && !appliedQualification.getTable().isEnabled()) {
			appliedQualification.setEnabled(true);
		}
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.CompositeRolePropertiesEditionPart#updateAppliedQualification()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.CompositeRolePropertiesEditionPart#addFilterAppliedQualification(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.CompositeRolePropertiesEditionPart#addBusinessFilterAppliedQualification(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.CompositeRolePropertiesEditionPart#isContainedInAppliedQualificationTable(EObject element)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.CompositeRolePropertiesEditionPart#initAggregatedRole(org.eclipse.emf.eef.runtime.ui.widgets.referencestable.ReferencesTableSettings)
	 */
	public void initAggregatedRole(ReferencesTableSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.CompositeRole.Properties.aggregatedRole);
		if (eefElementEditorReadOnlyState && aggregatedRole.getTable().isEnabled()) {
			aggregatedRole.setEnabled(false);
			aggregatedRole.setToolTipText(SpemMessages.CompositeRole_ReadOnly);
		} else if (!eefElementEditorReadOnlyState && !aggregatedRole.getTable().isEnabled()) {
			aggregatedRole.setEnabled(true);
		}
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.CompositeRolePropertiesEditionPart#updateAggregatedRole()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.CompositeRolePropertiesEditionPart#addFilterAggregatedRole(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.CompositeRolePropertiesEditionPart#addBusinessFilterAggregatedRole(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.CompositeRolePropertiesEditionPart#isContainedInAggregatedRoleTable(EObject element)
	 * 
	 */
