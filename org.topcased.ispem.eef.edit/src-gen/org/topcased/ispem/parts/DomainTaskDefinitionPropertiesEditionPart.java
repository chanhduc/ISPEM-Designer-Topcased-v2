 ...
 * 
 */
public interface DomainTaskDefinitionPropertiesEditionPart {
	...
	/**
	 * Init the applies
	 * @param settings settings for the applies ReferencesTable 
	 */
	public void initApplies(ReferencesTableSettings settings);

	/**
	 * Update the applies
	 * @param newValue the applies to update
	 * 
	 */
	public void updateApplies();

	/**
	 * Adds the given filter to the applies edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return true if the given element is contained inside the applies table
	 * 
	 */
