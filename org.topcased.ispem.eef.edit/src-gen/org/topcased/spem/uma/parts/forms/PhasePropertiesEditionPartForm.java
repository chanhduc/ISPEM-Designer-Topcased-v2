 ...
 * 
 */
public class PhasePropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, PhasePropertiesEditionPart {
	 ...
	 */
	public PhasePropertiesEditionPartForm() { super(); }
	...
	protected Composite createPreConditionMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
		...
		editPreCondition = widgetFactory.createButton(parent, getDescription(UmaViewsRepository.Phase.Properties.preCondition, UmaMessages.PhasePropertiesEditionPart_PreConditionLabel), SWT.NONE);
	...
	protected Composite createPostConditionMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
		...
		editPostCondition = widgetFactory.createButton(parent, getDescription(UmaViewsRepository.Phase.Properties.postCondition, UmaMessages.PhasePropertiesEditionPart_PostConditionLabel), SWT.NONE);
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							PhasePropertiesEditionPartForm.this,
							UmaViewsRepository.Phase.Properties.presentationName,
		...
		briefDescription.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							PhasePropertiesEditionPartForm.this,
							UmaViewsRepository.Phase.Properties.briefDescription,
		...
		mainDescription.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							PhasePropertiesEditionPartForm.this,
							UmaViewsRepository.Phase.Properties.mainDescription,
		...
		purpose.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							PhasePropertiesEditionPartForm.this,
							UmaViewsRepository.Phase.Properties.purpose,
	...
	protected Composite createGuidanceReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.guidance = new ReferencesTable(getDescription(UmaViewsRepository.Phase.Properties.guidance, UmaMessages.PhasePropertiesEditionPart_GuidanceLabel), new ReferencesTableListener	() {
	...
	protected Composite createMetricReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.metric = new ReferencesTable(getDescription(UmaViewsRepository.Phase.Properties.metric, UmaMessages.PhasePropertiesEditionPart_MetricLabel), new ReferencesTableListener	() {
	...
	protected Composite createCategoryReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.category = new ReferencesTable(getDescription(UmaViewsRepository.Phase.Properties.category, UmaMessages.PhasePropertiesEditionPart_CategoryLabel), new ReferencesTableListener	() {
		...
		copyright.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							PhasePropertiesEditionPartForm.this,
							UmaViewsRepository.Phase.Properties.copyright,
	...
	protected Composite createAuthorMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
		...
		editAuthor = widgetFactory.createButton(parent, getDescription(UmaViewsRepository.Phase.Properties.author, UmaMessages.PhasePropertiesEditionPart_AuthorLabel), SWT.NONE);
		...
		changeDate.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							PhasePropertiesEditionPartForm.this,
							UmaViewsRepository.Phase.Properties.changeDate,
		...
		changeDescription.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							PhasePropertiesEditionPartForm.this,
							UmaViewsRepository.Phase.Properties.changeDescription,
		...
		version.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							PhasePropertiesEditionPartForm.this,
							UmaViewsRepository.Phase.Properties.version,
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							PhasePropertiesEditionPartForm.this,
							UmaViewsRepository.Phase.Properties.name,
	...
	protected Composite createHasMultipleOccurrencesCheckbox(FormToolkit widgetFactory, Composite parent) {
		hasMultipleOccurrences = widgetFactory.createButton(parent, getDescription(UmaViewsRepository.Phase.Properties.hasMultipleOccurrences, UmaMessages.PhasePropertiesEditionPart_HasMultipleOccurrencesLabel), SWT.CHECK);
	...
	protected Composite createIsOptionalCheckbox(FormToolkit widgetFactory, Composite parent) {
		isOptional = widgetFactory.createButton(parent, getDescription(UmaViewsRepository.Phase.Properties.isOptional, UmaMessages.PhasePropertiesEditionPart_IsOptionalLabel), SWT.CHECK);
	...
	protected Composite createIsPlannedCheckbox(FormToolkit widgetFactory, Composite parent) {
		isPlanned = widgetFactory.createButton(parent, getDescription(UmaViewsRepository.Phase.Properties.isPlanned, UmaMessages.PhasePropertiesEditionPart_IsPlannedLabel), SWT.CHECK);
	...
	protected Composite createIsRepeatableCheckbox(FormToolkit widgetFactory, Composite parent) {
		isRepeatable = widgetFactory.createButton(parent, getDescription(UmaViewsRepository.Phase.Properties.isRepeatable, UmaMessages.PhasePropertiesEditionPart_IsRepeatableLabel), SWT.CHECK);
	...
	protected Composite createIsOngoingCheckbox(FormToolkit widgetFactory, Composite parent) {
		isOngoing = widgetFactory.createButton(parent, getDescription(UmaViewsRepository.Phase.Properties.isOngoing, UmaMessages.PhasePropertiesEditionPart_IsOngoingLabel), SWT.CHECK);
	...
	protected Composite createIsEventDrivenCheckbox(FormToolkit widgetFactory, Composite parent) {
		isEventDriven = widgetFactory.createButton(parent, getDescription(UmaViewsRepository.Phase.Properties.isEventDriven, UmaMessages.PhasePropertiesEditionPart_IsEventDrivenLabel), SWT.CHECK);
	...
	protected Composite createLinkToPredecessorReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.linkToPredecessor = new ReferencesTable(getDescription(UmaViewsRepository.Phase.Properties.linkToPredecessor, UmaMessages.PhasePropertiesEditionPart_LinkToPredecessorLabel), new ReferencesTableListener	() {
	...
	protected Composite createLinkToSuccessorReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.linkToSuccessor = new ReferencesTable(getDescription(UmaViewsRepository.Phase.Properties.linkToSuccessor, UmaMessages.PhasePropertiesEditionPart_LinkToSuccessorLabel), new ReferencesTableListener	() {
	...
	protected Composite createSuppressedBreakdownElementReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.suppressedBreakdownElement = new ReferencesTable(getDescription(UmaViewsRepository.Phase.Properties.suppressedBreakdownElement, UmaMessages.PhasePropertiesEditionPart_SuppressedBreakdownElementLabel), new ReferencesTableListener	() {
	...
	protected Composite createValidContextReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.validContext = new ReferencesTable(getDescription(UmaViewsRepository.Phase.Properties.validContext, UmaMessages.PhasePropertiesEditionPart_ValidContextLabel), new ReferencesTableListener	() {
	...
	protected Composite createIsEnactableCheckbox(FormToolkit widgetFactory, Composite parent) {
		isEnactable = widgetFactory.createButton(parent, getDescription(UmaViewsRepository.Phase.Properties.isEnactable, UmaMessages.PhasePropertiesEditionPart_IsEnactableLabel), SWT.CHECK);
		isEnactable.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(PhasePropertiesEditionPartForm.this, UmaViewsRepository.Phase.Properties.isEnactable, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new Boolean(isEnactable.getSelection())));
			}
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(UmaViewsRepository.Phase.Properties.isEnactable, UmaViewsRepository.FORM_KIND), null); //$NON-NLS-1$
