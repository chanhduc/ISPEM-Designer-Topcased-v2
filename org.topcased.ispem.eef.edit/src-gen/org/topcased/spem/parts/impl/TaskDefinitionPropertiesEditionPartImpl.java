...
public class TaskDefinitionPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, TaskDefinitionPropertiesEditionPart {
	...
	protected Composite createPreConditionMultiValuedEditor(Composite parent) {
		...
		editPreCondition.setText(getDescription(SpemViewsRepository.TaskDefinition.Properties.preCondition, SpemMessages.TaskDefinitionPropertiesEditionPart_PreConditionLabel));
	...
	protected Composite createPostConditionMultiValuedEditor(Composite parent) {
		...
		editPostCondition.setText(getDescription(SpemViewsRepository.TaskDefinition.Properties.postCondition, SpemMessages.TaskDefinitionPropertiesEditionPart_PostConditionLabel));
	...
	protected Composite createGuidanceAdvancedReferencesTable(Composite parent) {
		String label = getDescription(SpemViewsRepository.TaskDefinition.Properties.guidance, SpemMessages.TaskDefinitionPropertiesEditionPart_GuidanceLabel);		 
	...
	protected Composite createMetricAdvancedReferencesTable(Composite parent) {
		String label = getDescription(SpemViewsRepository.TaskDefinition.Properties.metric, SpemMessages.TaskDefinitionPropertiesEditionPart_MetricLabel);		 
	...
	protected Composite createCategoryAdvancedReferencesTable(Composite parent) {
		String label = getDescription(SpemViewsRepository.TaskDefinition.Properties.category, SpemMessages.TaskDefinitionPropertiesEditionPart_CategoryLabel);		 
	...
	protected Composite createAuthorMultiValuedEditor(Composite parent) {
		...
		editAuthor.setText(getDescription(SpemViewsRepository.TaskDefinition.Properties.author, SpemMessages.TaskDefinitionPropertiesEditionPart_AuthorLabel));
	...
	protected Composite createRequiredQualificationAdvancedReferencesTable(Composite parent) {
		String label = getDescription(SpemViewsRepository.TaskDefinition.Properties.requiredQualification, SpemMessages.TaskDefinitionPropertiesEditionPart_RequiredQualificationLabel);		 
	...
	protected Composite createUsedToolAdvancedReferencesTable(Composite parent) {
		String label = getDescription(SpemViewsRepository.TaskDefinition.Properties.usedTool, SpemMessages.TaskDefinitionPropertiesEditionPart_UsedToolLabel);		 
