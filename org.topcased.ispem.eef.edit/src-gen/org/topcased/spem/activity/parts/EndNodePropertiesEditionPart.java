 ...
 * 
 */
public interface EndNodePropertiesEditionPart {
	...
	/**
	 * Init the incomingEdge
	 * @param settings settings for the incomingEdge ReferencesTable 
	 */
	public void initIncomingEdge(ReferencesTableSettings settings);

	/**
	 * Update the incomingEdge
	 * @param newValue the incomingEdge to update
	 * 
	 */
	public void updateIncomingEdge();

	/**
	 * Adds the given filter to the incomingEdge edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return true if the given element is contained inside the incomingEdge table
	 * 
	 */
	...
	/**
	 * Init the outgoingEdge
	 * @param settings settings for the outgoingEdge ReferencesTable 
	 */
	public void initOutgoingEdge(ReferencesTableSettings settings);

	/**
	 * Update the outgoingEdge
	 * @param newValue the outgoingEdge to update
	 * 
	 */
	public void updateOutgoingEdge();

	/**
	 * Adds the given filter to the outgoingEdge edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return true if the given element is contained inside the outgoingEdge table
	 * 
	 */
