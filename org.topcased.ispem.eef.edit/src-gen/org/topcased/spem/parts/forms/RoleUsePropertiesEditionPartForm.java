 ...
 * 
 */
public class RoleUsePropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, RoleUsePropertiesEditionPart {
	 ...
	 */
	public RoleUsePropertiesEditionPartForm() { super(); }
	...
	protected Composite createKindFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		createDescription(parent, SpemViewsRepository.RoleUse.Properties.kind, SpemMessages.RoleUsePropertiesEditionPart_KindLabel);
	...
	protected Composite createPresentationNameText(FormToolkit widgetFactory, Composite parent) {
		createDescription(parent, SpemViewsRepository.RoleUse.Properties.presentationName, SpemMessages.RoleUsePropertiesEditionPart_PresentationNameLabel);
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							RoleUsePropertiesEditionPartForm.this,
							SpemViewsRepository.RoleUse.Properties.presentationName,
	...
	protected Composite createBriefDescriptionText(FormToolkit widgetFactory, Composite parent) {
		createDescription(parent, SpemViewsRepository.RoleUse.Properties.briefDescription, SpemMessages.RoleUsePropertiesEditionPart_BriefDescriptionLabel);
		...
		briefDescription.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							RoleUsePropertiesEditionPartForm.this,
							SpemViewsRepository.RoleUse.Properties.briefDescription,
	...
	protected Composite createMainDescriptionText(FormToolkit widgetFactory, Composite parent) {
		createDescription(parent, SpemViewsRepository.RoleUse.Properties.mainDescription, SpemMessages.RoleUsePropertiesEditionPart_MainDescriptionLabel);
		...
		mainDescription.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							RoleUsePropertiesEditionPartForm.this,
							SpemViewsRepository.RoleUse.Properties.mainDescription,
	...
	protected Composite createPurposeText(FormToolkit widgetFactory, Composite parent) {
		createDescription(parent, SpemViewsRepository.RoleUse.Properties.purpose, SpemMessages.RoleUsePropertiesEditionPart_PurposeLabel);
		...
		purpose.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							RoleUsePropertiesEditionPartForm.this,
							SpemViewsRepository.RoleUse.Properties.purpose,
	...
	protected Composite createGuidanceReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.guidance = new ReferencesTable(getDescription(SpemViewsRepository.RoleUse.Properties.guidance, SpemMessages.RoleUsePropertiesEditionPart_GuidanceLabel), new ReferencesTableListener	() {
	...
	protected Composite createMetricReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.metric = new ReferencesTable(getDescription(SpemViewsRepository.RoleUse.Properties.metric, SpemMessages.RoleUsePropertiesEditionPart_MetricLabel), new ReferencesTableListener	() {
	...
	protected Composite createCategoryReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.category = new ReferencesTable(getDescription(SpemViewsRepository.RoleUse.Properties.category, SpemMessages.RoleUsePropertiesEditionPart_CategoryLabel), new ReferencesTableListener	() {
	...
	protected Composite createCopyrightText(FormToolkit widgetFactory, Composite parent) {
		createDescription(parent, SpemViewsRepository.RoleUse.Properties.copyright, SpemMessages.RoleUsePropertiesEditionPart_CopyrightLabel);
		...
		copyright.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							RoleUsePropertiesEditionPartForm.this,
							SpemViewsRepository.RoleUse.Properties.copyright,
	...
	protected Composite createAuthorMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
		...
		editAuthor = widgetFactory.createButton(parent, getDescription(SpemViewsRepository.RoleUse.Properties.author, SpemMessages.RoleUsePropertiesEditionPart_AuthorLabel), SWT.NONE);
	...
	protected Composite createChangeDateText(FormToolkit widgetFactory, Composite parent) {
		createDescription(parent, SpemViewsRepository.RoleUse.Properties.changeDate, SpemMessages.RoleUsePropertiesEditionPart_ChangeDateLabel);
		...
		changeDate.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							RoleUsePropertiesEditionPartForm.this,
							SpemViewsRepository.RoleUse.Properties.changeDate,
	...
	protected Composite createChangeDescriptionText(FormToolkit widgetFactory, Composite parent) {
		createDescription(parent, SpemViewsRepository.RoleUse.Properties.changeDescription, SpemMessages.RoleUsePropertiesEditionPart_ChangeDescriptionLabel);
		...
		changeDescription.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							RoleUsePropertiesEditionPartForm.this,
							SpemViewsRepository.RoleUse.Properties.changeDescription,
	...
	protected Composite createVersionText(FormToolkit widgetFactory, Composite parent) {
		createDescription(parent, SpemViewsRepository.RoleUse.Properties.version, SpemMessages.RoleUsePropertiesEditionPart_VersionLabel);
		...
		version.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							RoleUsePropertiesEditionPartForm.this,
							SpemViewsRepository.RoleUse.Properties.version,
	...
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		createDescription(parent, SpemViewsRepository.RoleUse.Properties.name, SpemMessages.RoleUsePropertiesEditionPart_NameLabel);
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							RoleUsePropertiesEditionPartForm.this,
							SpemViewsRepository.RoleUse.Properties.name,
	...
	protected Composite createHasMultipleOccurrencesCheckbox(FormToolkit widgetFactory, Composite parent) {
		hasMultipleOccurrences = widgetFactory.createButton(parent, getDescription(SpemViewsRepository.RoleUse.Properties.hasMultipleOccurrences, SpemMessages.RoleUsePropertiesEditionPart_HasMultipleOccurrencesLabel), SWT.CHECK);
	...
	protected Composite createIsOptionalCheckbox(FormToolkit widgetFactory, Composite parent) {
		isOptional = widgetFactory.createButton(parent, getDescription(SpemViewsRepository.RoleUse.Properties.isOptional, SpemMessages.RoleUsePropertiesEditionPart_IsOptionalLabel), SWT.CHECK);
	...
	protected Composite createIsPlannedCheckbox(FormToolkit widgetFactory, Composite parent) {
		isPlanned = widgetFactory.createButton(parent, getDescription(SpemViewsRepository.RoleUse.Properties.isPlanned, SpemMessages.RoleUsePropertiesEditionPart_IsPlannedLabel), SWT.CHECK);
	...
	protected Composite createIsSynchronizedWithSourceCheckbox(FormToolkit widgetFactory, Composite parent) {
		isSynchronizedWithSource = widgetFactory.createButton(parent, getDescription(SpemViewsRepository.RoleUse.Properties.isSynchronizedWithSource, SpemMessages.RoleUsePropertiesEditionPart_IsSynchronizedWithSourceLabel), SWT.CHECK);
	...
	protected Composite createRoleFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		createDescription(parent, SpemViewsRepository.RoleUse.Properties.role, SpemMessages.RoleUsePropertiesEditionPart_RoleLabel);
	...
	protected Composite createAppliedQualificationReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.appliedQualification = new ReferencesTable(getDescription(SpemViewsRepository.RoleUse.Properties.appliedQualification, SpemMessages.RoleUsePropertiesEditionPart_AppliedQualificationLabel), new ReferencesTableListener	() {
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.RoleUsePropertiesEditionPart#getKind()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.RoleUsePropertiesEditionPart#initKind(EObjectFlatComboSettings)
	 */
	public void initKind(EObjectFlatComboSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.RoleUse.Properties.kind);
		if (eefElementEditorReadOnlyState && kind.isEnabled()) {
			kind.setEnabled(false);
			kind.setToolTipText(SpemMessages.RoleUse_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.RoleUsePropertiesEditionPart#setKind(EObject newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.RoleUsePropertiesEditionPart#setKindButtonMode(ButtonsModeEnum newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.RoleUsePropertiesEditionPart#addFilterKind(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.RoleUsePropertiesEditionPart#addBusinessFilterKind(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.RoleUsePropertiesEditionPart#getPresentationName()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.RoleUsePropertiesEditionPart#setPresentationName(String newValue)
	 * 
	 */
	public void setPresentationName(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.RoleUse.Properties.presentationName);
		if (eefElementEditorReadOnlyState && presentationName.isEnabled()) {
			presentationName.setEnabled(false);
			presentationName.setToolTipText(SpemMessages.RoleUse_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.RoleUsePropertiesEditionPart#getBriefDescription()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.RoleUsePropertiesEditionPart#setBriefDescription(String newValue)
	 * 
	 */
	public void setBriefDescription(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.RoleUse.Properties.briefDescription);
		if (eefElementEditorReadOnlyState && briefDescription.isEnabled()) {
			briefDescription.setEnabled(false);
			briefDescription.setToolTipText(SpemMessages.RoleUse_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.RoleUsePropertiesEditionPart#getMainDescription()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.RoleUsePropertiesEditionPart#setMainDescription(String newValue)
	 * 
	 */
	public void setMainDescription(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.RoleUse.Properties.mainDescription);
		if (eefElementEditorReadOnlyState && mainDescription.isEnabled()) {
			mainDescription.setEnabled(false);
			mainDescription.setToolTipText(SpemMessages.RoleUse_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.RoleUsePropertiesEditionPart#getPurpose()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.RoleUsePropertiesEditionPart#setPurpose(String newValue)
	 * 
	 */
	public void setPurpose(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.RoleUse.Properties.purpose);
		if (eefElementEditorReadOnlyState && purpose.isEnabled()) {
			purpose.setEnabled(false);
			purpose.setToolTipText(SpemMessages.RoleUse_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.RoleUsePropertiesEditionPart#initGuidance(org.eclipse.emf.eef.runtime.ui.widgets.referencestable.ReferencesTableSettings)
	 */
	public void initGuidance(ReferencesTableSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.RoleUse.Properties.guidance);
		if (eefElementEditorReadOnlyState && guidance.getTable().isEnabled()) {
			guidance.setEnabled(false);
			guidance.setToolTipText(SpemMessages.RoleUse_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.RoleUsePropertiesEditionPart#updateGuidance()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.RoleUsePropertiesEditionPart#addFilterGuidance(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.RoleUsePropertiesEditionPart#addBusinessFilterGuidance(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.RoleUsePropertiesEditionPart#isContainedInGuidanceTable(EObject element)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.RoleUsePropertiesEditionPart#initMetric(org.eclipse.emf.eef.runtime.ui.widgets.referencestable.ReferencesTableSettings)
	 */
	public void initMetric(ReferencesTableSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.RoleUse.Properties.metric);
		if (eefElementEditorReadOnlyState && metric.getTable().isEnabled()) {
			metric.setEnabled(false);
			metric.setToolTipText(SpemMessages.RoleUse_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.RoleUsePropertiesEditionPart#updateMetric()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.RoleUsePropertiesEditionPart#addFilterMetric(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.RoleUsePropertiesEditionPart#addBusinessFilterMetric(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.RoleUsePropertiesEditionPart#isContainedInMetricTable(EObject element)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.RoleUsePropertiesEditionPart#initCategory(org.eclipse.emf.eef.runtime.ui.widgets.referencestable.ReferencesTableSettings)
	 */
	public void initCategory(ReferencesTableSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.RoleUse.Properties.category);
		if (eefElementEditorReadOnlyState && category.getTable().isEnabled()) {
			category.setEnabled(false);
			category.setToolTipText(SpemMessages.RoleUse_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.RoleUsePropertiesEditionPart#updateCategory()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.RoleUsePropertiesEditionPart#addFilterCategory(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.RoleUsePropertiesEditionPart#addBusinessFilterCategory(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.RoleUsePropertiesEditionPart#isContainedInCategoryTable(EObject element)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.RoleUsePropertiesEditionPart#getCopyright()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.RoleUsePropertiesEditionPart#setCopyright(String newValue)
	 * 
	 */
	public void setCopyright(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.RoleUse.Properties.copyright);
		if (eefElementEditorReadOnlyState && copyright.isEnabled()) {
			copyright.setEnabled(false);
			copyright.setToolTipText(SpemMessages.RoleUse_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.RoleUsePropertiesEditionPart#getAuthor()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.RoleUsePropertiesEditionPart#setAuthor(EList newValue)
	 * 
	 */
	public void setAuthor(EList newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.RoleUse.Properties.author);
		if (eefElementEditorReadOnlyState && author.isEnabled()) {
			author.setEnabled(false);
			author.setToolTipText(SpemMessages.RoleUse_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.RoleUsePropertiesEditionPart#getChangeDate()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.RoleUsePropertiesEditionPart#setChangeDate(String newValue)
	 * 
	 */
	public void setChangeDate(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.RoleUse.Properties.changeDate);
		if (eefElementEditorReadOnlyState && changeDate.isEnabled()) {
			changeDate.setEnabled(false);
			changeDate.setToolTipText(SpemMessages.RoleUse_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.RoleUsePropertiesEditionPart#getChangeDescription()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.RoleUsePropertiesEditionPart#setChangeDescription(String newValue)
	 * 
	 */
	public void setChangeDescription(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.RoleUse.Properties.changeDescription);
		if (eefElementEditorReadOnlyState && changeDescription.isEnabled()) {
			changeDescription.setEnabled(false);
			changeDescription.setToolTipText(SpemMessages.RoleUse_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.RoleUsePropertiesEditionPart#getVersion()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.RoleUsePropertiesEditionPart#setVersion(String newValue)
	 * 
	 */
	public void setVersion(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.RoleUse.Properties.version);
		if (eefElementEditorReadOnlyState && version.isEnabled()) {
			version.setEnabled(false);
			version.setToolTipText(SpemMessages.RoleUse_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.RoleUsePropertiesEditionPart#getName()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.RoleUsePropertiesEditionPart#setName(String newValue)
	 * 
	 */
	public void setName(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.RoleUse.Properties.name);
		if (eefElementEditorReadOnlyState && name.isEnabled()) {
			name.setEnabled(false);
			name.setToolTipText(SpemMessages.RoleUse_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.RoleUsePropertiesEditionPart#getHasMultipleOccurrences()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.RoleUsePropertiesEditionPart#setHasMultipleOccurrences(Boolean newValue)
	 * 
	 */
	public void setHasMultipleOccurrences(Boolean newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.RoleUse.Properties.hasMultipleOccurrences);
		if (eefElementEditorReadOnlyState && hasMultipleOccurrences.isEnabled()) {
			hasMultipleOccurrences.setEnabled(false);
			hasMultipleOccurrences.setToolTipText(SpemMessages.RoleUse_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.RoleUsePropertiesEditionPart#getIsOptional()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.RoleUsePropertiesEditionPart#setIsOptional(Boolean newValue)
	 * 
	 */
	public void setIsOptional(Boolean newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.RoleUse.Properties.isOptional);
		if (eefElementEditorReadOnlyState && isOptional.isEnabled()) {
			isOptional.setEnabled(false);
			isOptional.setToolTipText(SpemMessages.RoleUse_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.RoleUsePropertiesEditionPart#getIsPlanned()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.RoleUsePropertiesEditionPart#setIsPlanned(Boolean newValue)
	 * 
	 */
	public void setIsPlanned(Boolean newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.RoleUse.Properties.isPlanned);
		if (eefElementEditorReadOnlyState && isPlanned.isEnabled()) {
			isPlanned.setEnabled(false);
			isPlanned.setToolTipText(SpemMessages.RoleUse_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.RoleUsePropertiesEditionPart#getIsSynchronizedWithSource()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.RoleUsePropertiesEditionPart#setIsSynchronizedWithSource(Boolean newValue)
	 * 
	 */
	public void setIsSynchronizedWithSource(Boolean newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.RoleUse.Properties.isSynchronizedWithSource);
		if (eefElementEditorReadOnlyState && isSynchronizedWithSource.isEnabled()) {
			isSynchronizedWithSource.setEnabled(false);
			isSynchronizedWithSource.setToolTipText(SpemMessages.RoleUse_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.RoleUsePropertiesEditionPart#getRole()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.RoleUsePropertiesEditionPart#initRole(EObjectFlatComboSettings)
	 */
	public void initRole(EObjectFlatComboSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.RoleUse.Properties.role);
		if (eefElementEditorReadOnlyState && role.isEnabled()) {
			role.setEnabled(false);
			role.setToolTipText(SpemMessages.RoleUse_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.RoleUsePropertiesEditionPart#setRole(EObject newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.RoleUsePropertiesEditionPart#setRoleButtonMode(ButtonsModeEnum newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.RoleUsePropertiesEditionPart#addFilterRole(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.RoleUsePropertiesEditionPart#addBusinessFilterRole(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.RoleUsePropertiesEditionPart#initAppliedQualification(org.eclipse.emf.eef.runtime.ui.widgets.referencestable.ReferencesTableSettings)
	 */
	public void initAppliedQualification(ReferencesTableSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.RoleUse.Properties.appliedQualification);
		if (eefElementEditorReadOnlyState && appliedQualification.getTable().isEnabled()) {
			appliedQualification.setEnabled(false);
			appliedQualification.setToolTipText(SpemMessages.RoleUse_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.RoleUsePropertiesEditionPart#updateAppliedQualification()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.RoleUsePropertiesEditionPart#addFilterAppliedQualification(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.RoleUsePropertiesEditionPart#addBusinessFilterAppliedQualification(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.RoleUsePropertiesEditionPart#isContainedInAppliedQualificationTable(EObject element)
	 * 
	 */
