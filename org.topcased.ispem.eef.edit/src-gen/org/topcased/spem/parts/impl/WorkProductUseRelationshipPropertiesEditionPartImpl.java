...
public class WorkProductUseRelationshipPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, WorkProductUseRelationshipPropertiesEditionPart {
	...
	protected Composite createGuidanceAdvancedReferencesTable(Composite parent) {
		String label = getDescription(SpemViewsRepository.WorkProductUseRelationship.Properties.guidance, SpemMessages.WorkProductUseRelationshipPropertiesEditionPart_GuidanceLabel);		 
	...
	protected Composite createMetricAdvancedReferencesTable(Composite parent) {
		String label = getDescription(SpemViewsRepository.WorkProductUseRelationship.Properties.metric, SpemMessages.WorkProductUseRelationshipPropertiesEditionPart_MetricLabel);		 
	...
	protected Composite createCategoryAdvancedReferencesTable(Composite parent) {
		String label = getDescription(SpemViewsRepository.WorkProductUseRelationship.Properties.category, SpemMessages.WorkProductUseRelationshipPropertiesEditionPart_CategoryLabel);		 
	...
	protected Composite createAuthorMultiValuedEditor(Composite parent) {
		...
		editAuthor.setText(getDescription(SpemViewsRepository.WorkProductUseRelationship.Properties.author, SpemMessages.WorkProductUseRelationshipPropertiesEditionPart_AuthorLabel));
	...
	protected Composite createHasMultipleOccurrencesCheckbox(Composite parent) {
		...
		hasMultipleOccurrences.setText(getDescription(SpemViewsRepository.WorkProductUseRelationship.Properties.hasMultipleOccurrences, SpemMessages.WorkProductUseRelationshipPropertiesEditionPart_HasMultipleOccurrencesLabel));
	...
	protected Composite createIsOptionalCheckbox(Composite parent) {
		...
		isOptional.setText(getDescription(SpemViewsRepository.WorkProductUseRelationship.Properties.isOptional, SpemMessages.WorkProductUseRelationshipPropertiesEditionPart_IsOptionalLabel));
	...
	protected Composite createIsPlannedCheckbox(Composite parent) {
		...
		isPlanned.setText(getDescription(SpemViewsRepository.WorkProductUseRelationship.Properties.isPlanned, SpemMessages.WorkProductUseRelationshipPropertiesEditionPart_IsPlannedLabel));
	...
	protected Composite createTargetAdvancedReferencesTable(Composite parent) {
		String label = getDescription(SpemViewsRepository.WorkProductUseRelationship.Properties.target, SpemMessages.WorkProductUseRelationshipPropertiesEditionPart_TargetLabel);		 
