 ...
 * 
 */
public interface EngineeringDomainPropertiesEditionPart {
	...
	/**
	 * Init the defines
	 * @param settings settings for the defines ReferencesTable 
	 */
	public void initDefines(ReferencesTableSettings settings);

	/**
	 * Update the defines
	 * @param newValue the defines to update
	 * 
	 */
	public void updateDefines();

	/**
	 * Adds the given filter to the defines edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return true if the given element is contained inside the defines table
	 * 
	 */
	...
	/**
	 * Init the realizes
	 * @param settings settings for the realizes ReferencesTable 
	 */
	public void initRealizes(ReferencesTableSettings settings);

	/**
	 * Update the realizes
	 * @param newValue the realizes to update
	 * 
	 */
	public void updateRealizes();

	/**
	 * Adds the given filter to the realizes edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return true if the given element is contained inside the realizes table
	 * 
	 */
