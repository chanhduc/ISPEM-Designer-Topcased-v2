...
public class ProcessPerformerPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, ProcessPerformerPropertiesEditionPart {
	...
	protected Composite createGuidanceAdvancedReferencesTable(Composite parent) {
		String label = getDescription(SpemViewsRepository.ProcessPerformer.Properties.guidance, SpemMessages.ProcessPerformerPropertiesEditionPart_GuidanceLabel);		 
	...
	protected Composite createMetricAdvancedReferencesTable(Composite parent) {
		String label = getDescription(SpemViewsRepository.ProcessPerformer.Properties.metric, SpemMessages.ProcessPerformerPropertiesEditionPart_MetricLabel);		 
	...
	protected Composite createCategoryAdvancedReferencesTable(Composite parent) {
		String label = getDescription(SpemViewsRepository.ProcessPerformer.Properties.category, SpemMessages.ProcessPerformerPropertiesEditionPart_CategoryLabel);		 
	...
	protected Composite createAuthorMultiValuedEditor(Composite parent) {
		...
		editAuthor.setText(getDescription(SpemViewsRepository.ProcessPerformer.Properties.author, SpemMessages.ProcessPerformerPropertiesEditionPart_AuthorLabel));
	...
	protected Composite createHasMultipleOccurrencesCheckbox(Composite parent) {
		...
		hasMultipleOccurrences.setText(getDescription(SpemViewsRepository.ProcessPerformer.Properties.hasMultipleOccurrences, SpemMessages.ProcessPerformerPropertiesEditionPart_HasMultipleOccurrencesLabel));
	...
	protected Composite createIsOptionalCheckbox(Composite parent) {
		...
		isOptional.setText(getDescription(SpemViewsRepository.ProcessPerformer.Properties.isOptional, SpemMessages.ProcessPerformerPropertiesEditionPart_IsOptionalLabel));
	...
	protected Composite createIsPlannedCheckbox(Composite parent) {
		...
		isPlanned.setText(getDescription(SpemViewsRepository.ProcessPerformer.Properties.isPlanned, SpemMessages.ProcessPerformerPropertiesEditionPart_IsPlannedLabel));
	...
	protected Composite createLinkedRoleUseAdvancedReferencesTable(Composite parent) {
		String label = getDescription(SpemViewsRepository.ProcessPerformer.Properties.linkedRoleUse, SpemMessages.ProcessPerformerPropertiesEditionPart_LinkedRoleUseLabel);		 
