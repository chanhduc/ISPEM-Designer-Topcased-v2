 ...
 * 
 */
public class WorkProductUseRelationshipPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, WorkProductUseRelationshipPropertiesEditionPart {
	 ...
	 */
	public WorkProductUseRelationshipPropertiesEditionPartForm() { super(); }
	...
	protected Composite createKindFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		createDescription(parent, SpemViewsRepository.WorkProductUseRelationship.Properties.kind, SpemMessages.WorkProductUseRelationshipPropertiesEditionPart_KindLabel);
	...
	protected Composite createPresentationNameText(FormToolkit widgetFactory, Composite parent) {
		createDescription(parent, SpemViewsRepository.WorkProductUseRelationship.Properties.presentationName, SpemMessages.WorkProductUseRelationshipPropertiesEditionPart_PresentationNameLabel);
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							WorkProductUseRelationshipPropertiesEditionPartForm.this,
							SpemViewsRepository.WorkProductUseRelationship.Properties.presentationName,
	...
	protected Composite createBriefDescriptionText(FormToolkit widgetFactory, Composite parent) {
		createDescription(parent, SpemViewsRepository.WorkProductUseRelationship.Properties.briefDescription, SpemMessages.WorkProductUseRelationshipPropertiesEditionPart_BriefDescriptionLabel);
		...
		briefDescription.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							WorkProductUseRelationshipPropertiesEditionPartForm.this,
							SpemViewsRepository.WorkProductUseRelationship.Properties.briefDescription,
	...
	protected Composite createMainDescriptionText(FormToolkit widgetFactory, Composite parent) {
		createDescription(parent, SpemViewsRepository.WorkProductUseRelationship.Properties.mainDescription, SpemMessages.WorkProductUseRelationshipPropertiesEditionPart_MainDescriptionLabel);
		...
		mainDescription.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							WorkProductUseRelationshipPropertiesEditionPartForm.this,
							SpemViewsRepository.WorkProductUseRelationship.Properties.mainDescription,
	...
	protected Composite createPurposeText(FormToolkit widgetFactory, Composite parent) {
		createDescription(parent, SpemViewsRepository.WorkProductUseRelationship.Properties.purpose, SpemMessages.WorkProductUseRelationshipPropertiesEditionPart_PurposeLabel);
		...
		purpose.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							WorkProductUseRelationshipPropertiesEditionPartForm.this,
							SpemViewsRepository.WorkProductUseRelationship.Properties.purpose,
	...
	protected Composite createGuidanceReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.guidance = new ReferencesTable(getDescription(SpemViewsRepository.WorkProductUseRelationship.Properties.guidance, SpemMessages.WorkProductUseRelationshipPropertiesEditionPart_GuidanceLabel), new ReferencesTableListener	() {
	...
	protected Composite createMetricReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.metric = new ReferencesTable(getDescription(SpemViewsRepository.WorkProductUseRelationship.Properties.metric, SpemMessages.WorkProductUseRelationshipPropertiesEditionPart_MetricLabel), new ReferencesTableListener	() {
	...
	protected Composite createCategoryReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.category = new ReferencesTable(getDescription(SpemViewsRepository.WorkProductUseRelationship.Properties.category, SpemMessages.WorkProductUseRelationshipPropertiesEditionPart_CategoryLabel), new ReferencesTableListener	() {
	...
	protected Composite createCopyrightText(FormToolkit widgetFactory, Composite parent) {
		createDescription(parent, SpemViewsRepository.WorkProductUseRelationship.Properties.copyright, SpemMessages.WorkProductUseRelationshipPropertiesEditionPart_CopyrightLabel);
		...
		copyright.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							WorkProductUseRelationshipPropertiesEditionPartForm.this,
							SpemViewsRepository.WorkProductUseRelationship.Properties.copyright,
	...
	protected Composite createAuthorMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
		...
		editAuthor = widgetFactory.createButton(parent, getDescription(SpemViewsRepository.WorkProductUseRelationship.Properties.author, SpemMessages.WorkProductUseRelationshipPropertiesEditionPart_AuthorLabel), SWT.NONE);
	...
	protected Composite createChangeDateText(FormToolkit widgetFactory, Composite parent) {
		createDescription(parent, SpemViewsRepository.WorkProductUseRelationship.Properties.changeDate, SpemMessages.WorkProductUseRelationshipPropertiesEditionPart_ChangeDateLabel);
		...
		changeDate.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							WorkProductUseRelationshipPropertiesEditionPartForm.this,
							SpemViewsRepository.WorkProductUseRelationship.Properties.changeDate,
	...
	protected Composite createChangeDescriptionText(FormToolkit widgetFactory, Composite parent) {
		createDescription(parent, SpemViewsRepository.WorkProductUseRelationship.Properties.changeDescription, SpemMessages.WorkProductUseRelationshipPropertiesEditionPart_ChangeDescriptionLabel);
		...
		changeDescription.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							WorkProductUseRelationshipPropertiesEditionPartForm.this,
							SpemViewsRepository.WorkProductUseRelationship.Properties.changeDescription,
	...
	protected Composite createVersionText(FormToolkit widgetFactory, Composite parent) {
		createDescription(parent, SpemViewsRepository.WorkProductUseRelationship.Properties.version, SpemMessages.WorkProductUseRelationshipPropertiesEditionPart_VersionLabel);
		...
		version.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							WorkProductUseRelationshipPropertiesEditionPartForm.this,
							SpemViewsRepository.WorkProductUseRelationship.Properties.version,
	...
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		createDescription(parent, SpemViewsRepository.WorkProductUseRelationship.Properties.name, SpemMessages.WorkProductUseRelationshipPropertiesEditionPart_NameLabel);
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							WorkProductUseRelationshipPropertiesEditionPartForm.this,
							SpemViewsRepository.WorkProductUseRelationship.Properties.name,
	...
	protected Composite createHasMultipleOccurrencesCheckbox(FormToolkit widgetFactory, Composite parent) {
		hasMultipleOccurrences = widgetFactory.createButton(parent, getDescription(SpemViewsRepository.WorkProductUseRelationship.Properties.hasMultipleOccurrences, SpemMessages.WorkProductUseRelationshipPropertiesEditionPart_HasMultipleOccurrencesLabel), SWT.CHECK);
	...
	protected Composite createIsOptionalCheckbox(FormToolkit widgetFactory, Composite parent) {
		isOptional = widgetFactory.createButton(parent, getDescription(SpemViewsRepository.WorkProductUseRelationship.Properties.isOptional, SpemMessages.WorkProductUseRelationshipPropertiesEditionPart_IsOptionalLabel), SWT.CHECK);
	...
	protected Composite createIsPlannedCheckbox(FormToolkit widgetFactory, Composite parent) {
		isPlanned = widgetFactory.createButton(parent, getDescription(SpemViewsRepository.WorkProductUseRelationship.Properties.isPlanned, SpemMessages.WorkProductUseRelationshipPropertiesEditionPart_IsPlannedLabel), SWT.CHECK);
	...
	protected Composite createSourceFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		createDescription(parent, SpemViewsRepository.WorkProductUseRelationship.Properties.source, SpemMessages.WorkProductUseRelationshipPropertiesEditionPart_SourceLabel);
	...
	protected Composite createTargetReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.target = new ReferencesTable(getDescription(SpemViewsRepository.WorkProductUseRelationship.Properties.target, SpemMessages.WorkProductUseRelationshipPropertiesEditionPart_TargetLabel), new ReferencesTableListener	() {
	...
	protected Composite createRelationshipKindEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
		createDescription(parent, SpemViewsRepository.WorkProductUseRelationship.Properties.relationshipKind, SpemMessages.WorkProductUseRelationshipPropertiesEditionPart_RelationshipKindLabel);
		relationshipKind = new EMFComboViewer(parent);
		relationshipKind.setContentProvider(new ArrayContentProvider());
		relationshipKind.setLabelProvider(new AdapterFactoryLabelProvider(EEFRuntimePlugin.getDefault().getAdapterFactory()));
		...
		// Start of user code for createRelationshipKindEMFComboViewer
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.WorkProductUseRelationshipPropertiesEditionPart#getKind()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.WorkProductUseRelationshipPropertiesEditionPart#initKind(EObjectFlatComboSettings)
	 */
	public void initKind(EObjectFlatComboSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.WorkProductUseRelationship.Properties.kind);
		if (eefElementEditorReadOnlyState && kind.isEnabled()) {
			kind.setEnabled(false);
			kind.setToolTipText(SpemMessages.WorkProductUseRelationship_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.WorkProductUseRelationshipPropertiesEditionPart#setKind(EObject newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.WorkProductUseRelationshipPropertiesEditionPart#setKindButtonMode(ButtonsModeEnum newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.WorkProductUseRelationshipPropertiesEditionPart#addFilterKind(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.WorkProductUseRelationshipPropertiesEditionPart#addBusinessFilterKind(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.WorkProductUseRelationshipPropertiesEditionPart#getPresentationName()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.WorkProductUseRelationshipPropertiesEditionPart#setPresentationName(String newValue)
	 * 
	 */
	public void setPresentationName(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.WorkProductUseRelationship.Properties.presentationName);
		if (eefElementEditorReadOnlyState && presentationName.isEnabled()) {
			presentationName.setEnabled(false);
			presentationName.setToolTipText(SpemMessages.WorkProductUseRelationship_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.WorkProductUseRelationshipPropertiesEditionPart#getBriefDescription()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.WorkProductUseRelationshipPropertiesEditionPart#setBriefDescription(String newValue)
	 * 
	 */
	public void setBriefDescription(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.WorkProductUseRelationship.Properties.briefDescription);
		if (eefElementEditorReadOnlyState && briefDescription.isEnabled()) {
			briefDescription.setEnabled(false);
			briefDescription.setToolTipText(SpemMessages.WorkProductUseRelationship_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.WorkProductUseRelationshipPropertiesEditionPart#getMainDescription()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.WorkProductUseRelationshipPropertiesEditionPart#setMainDescription(String newValue)
	 * 
	 */
	public void setMainDescription(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.WorkProductUseRelationship.Properties.mainDescription);
		if (eefElementEditorReadOnlyState && mainDescription.isEnabled()) {
			mainDescription.setEnabled(false);
			mainDescription.setToolTipText(SpemMessages.WorkProductUseRelationship_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.WorkProductUseRelationshipPropertiesEditionPart#getPurpose()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.WorkProductUseRelationshipPropertiesEditionPart#setPurpose(String newValue)
	 * 
	 */
	public void setPurpose(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.WorkProductUseRelationship.Properties.purpose);
		if (eefElementEditorReadOnlyState && purpose.isEnabled()) {
			purpose.setEnabled(false);
			purpose.setToolTipText(SpemMessages.WorkProductUseRelationship_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.WorkProductUseRelationshipPropertiesEditionPart#initGuidance(org.eclipse.emf.eef.runtime.ui.widgets.referencestable.ReferencesTableSettings)
	 */
	public void initGuidance(ReferencesTableSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.WorkProductUseRelationship.Properties.guidance);
		if (eefElementEditorReadOnlyState && guidance.getTable().isEnabled()) {
			guidance.setEnabled(false);
			guidance.setToolTipText(SpemMessages.WorkProductUseRelationship_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.WorkProductUseRelationshipPropertiesEditionPart#updateGuidance()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.WorkProductUseRelationshipPropertiesEditionPart#addFilterGuidance(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.WorkProductUseRelationshipPropertiesEditionPart#addBusinessFilterGuidance(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.WorkProductUseRelationshipPropertiesEditionPart#isContainedInGuidanceTable(EObject element)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.WorkProductUseRelationshipPropertiesEditionPart#initMetric(org.eclipse.emf.eef.runtime.ui.widgets.referencestable.ReferencesTableSettings)
	 */
	public void initMetric(ReferencesTableSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.WorkProductUseRelationship.Properties.metric);
		if (eefElementEditorReadOnlyState && metric.getTable().isEnabled()) {
			metric.setEnabled(false);
			metric.setToolTipText(SpemMessages.WorkProductUseRelationship_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.WorkProductUseRelationshipPropertiesEditionPart#updateMetric()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.WorkProductUseRelationshipPropertiesEditionPart#addFilterMetric(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.WorkProductUseRelationshipPropertiesEditionPart#addBusinessFilterMetric(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.WorkProductUseRelationshipPropertiesEditionPart#isContainedInMetricTable(EObject element)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.WorkProductUseRelationshipPropertiesEditionPart#initCategory(org.eclipse.emf.eef.runtime.ui.widgets.referencestable.ReferencesTableSettings)
	 */
	public void initCategory(ReferencesTableSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.WorkProductUseRelationship.Properties.category);
		if (eefElementEditorReadOnlyState && category.getTable().isEnabled()) {
			category.setEnabled(false);
			category.setToolTipText(SpemMessages.WorkProductUseRelationship_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.WorkProductUseRelationshipPropertiesEditionPart#updateCategory()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.WorkProductUseRelationshipPropertiesEditionPart#addFilterCategory(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.WorkProductUseRelationshipPropertiesEditionPart#addBusinessFilterCategory(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.WorkProductUseRelationshipPropertiesEditionPart#isContainedInCategoryTable(EObject element)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.WorkProductUseRelationshipPropertiesEditionPart#getCopyright()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.WorkProductUseRelationshipPropertiesEditionPart#setCopyright(String newValue)
	 * 
	 */
	public void setCopyright(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.WorkProductUseRelationship.Properties.copyright);
		if (eefElementEditorReadOnlyState && copyright.isEnabled()) {
			copyright.setEnabled(false);
			copyright.setToolTipText(SpemMessages.WorkProductUseRelationship_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.WorkProductUseRelationshipPropertiesEditionPart#getAuthor()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.WorkProductUseRelationshipPropertiesEditionPart#setAuthor(EList newValue)
	 * 
	 */
	public void setAuthor(EList newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.WorkProductUseRelationship.Properties.author);
		if (eefElementEditorReadOnlyState && author.isEnabled()) {
			author.setEnabled(false);
			author.setToolTipText(SpemMessages.WorkProductUseRelationship_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.WorkProductUseRelationshipPropertiesEditionPart#getChangeDate()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.WorkProductUseRelationshipPropertiesEditionPart#setChangeDate(String newValue)
	 * 
	 */
	public void setChangeDate(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.WorkProductUseRelationship.Properties.changeDate);
		if (eefElementEditorReadOnlyState && changeDate.isEnabled()) {
			changeDate.setEnabled(false);
			changeDate.setToolTipText(SpemMessages.WorkProductUseRelationship_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.WorkProductUseRelationshipPropertiesEditionPart#getChangeDescription()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.WorkProductUseRelationshipPropertiesEditionPart#setChangeDescription(String newValue)
	 * 
	 */
	public void setChangeDescription(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.WorkProductUseRelationship.Properties.changeDescription);
		if (eefElementEditorReadOnlyState && changeDescription.isEnabled()) {
			changeDescription.setEnabled(false);
			changeDescription.setToolTipText(SpemMessages.WorkProductUseRelationship_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.WorkProductUseRelationshipPropertiesEditionPart#getVersion()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.WorkProductUseRelationshipPropertiesEditionPart#setVersion(String newValue)
	 * 
	 */
	public void setVersion(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.WorkProductUseRelationship.Properties.version);
		if (eefElementEditorReadOnlyState && version.isEnabled()) {
			version.setEnabled(false);
			version.setToolTipText(SpemMessages.WorkProductUseRelationship_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.WorkProductUseRelationshipPropertiesEditionPart#getName()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.WorkProductUseRelationshipPropertiesEditionPart#setName(String newValue)
	 * 
	 */
	public void setName(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.WorkProductUseRelationship.Properties.name);
		if (eefElementEditorReadOnlyState && name.isEnabled()) {
			name.setEnabled(false);
			name.setToolTipText(SpemMessages.WorkProductUseRelationship_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.WorkProductUseRelationshipPropertiesEditionPart#getHasMultipleOccurrences()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.WorkProductUseRelationshipPropertiesEditionPart#setHasMultipleOccurrences(Boolean newValue)
	 * 
	 */
	public void setHasMultipleOccurrences(Boolean newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.WorkProductUseRelationship.Properties.hasMultipleOccurrences);
		if (eefElementEditorReadOnlyState && hasMultipleOccurrences.isEnabled()) {
			hasMultipleOccurrences.setEnabled(false);
			hasMultipleOccurrences.setToolTipText(SpemMessages.WorkProductUseRelationship_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.WorkProductUseRelationshipPropertiesEditionPart#getIsOptional()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.WorkProductUseRelationshipPropertiesEditionPart#setIsOptional(Boolean newValue)
	 * 
	 */
	public void setIsOptional(Boolean newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.WorkProductUseRelationship.Properties.isOptional);
		if (eefElementEditorReadOnlyState && isOptional.isEnabled()) {
			isOptional.setEnabled(false);
			isOptional.setToolTipText(SpemMessages.WorkProductUseRelationship_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.WorkProductUseRelationshipPropertiesEditionPart#getIsPlanned()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.WorkProductUseRelationshipPropertiesEditionPart#setIsPlanned(Boolean newValue)
	 * 
	 */
	public void setIsPlanned(Boolean newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.WorkProductUseRelationship.Properties.isPlanned);
		if (eefElementEditorReadOnlyState && isPlanned.isEnabled()) {
			isPlanned.setEnabled(false);
			isPlanned.setToolTipText(SpemMessages.WorkProductUseRelationship_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.WorkProductUseRelationshipPropertiesEditionPart#getSource()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.WorkProductUseRelationshipPropertiesEditionPart#initSource(EObjectFlatComboSettings)
	 */
	public void initSource(EObjectFlatComboSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.WorkProductUseRelationship.Properties.source);
		if (eefElementEditorReadOnlyState && source.isEnabled()) {
			source.setEnabled(false);
			source.setToolTipText(SpemMessages.WorkProductUseRelationship_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.WorkProductUseRelationshipPropertiesEditionPart#setSource(EObject newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.WorkProductUseRelationshipPropertiesEditionPart#setSourceButtonMode(ButtonsModeEnum newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.WorkProductUseRelationshipPropertiesEditionPart#addFilterSource(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.WorkProductUseRelationshipPropertiesEditionPart#addBusinessFilterSource(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.WorkProductUseRelationshipPropertiesEditionPart#initTarget(org.eclipse.emf.eef.runtime.ui.widgets.referencestable.ReferencesTableSettings)
	 */
	public void initTarget(ReferencesTableSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.WorkProductUseRelationship.Properties.target);
		if (eefElementEditorReadOnlyState && target.getTable().isEnabled()) {
			target.setEnabled(false);
			target.setToolTipText(SpemMessages.WorkProductUseRelationship_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.WorkProductUseRelationshipPropertiesEditionPart#updateTarget()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.WorkProductUseRelationshipPropertiesEditionPart#addFilterTarget(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.WorkProductUseRelationshipPropertiesEditionPart#addBusinessFilterTarget(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.WorkProductUseRelationshipPropertiesEditionPart#isContainedInTargetTable(EObject element)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.WorkProductUseRelationshipPropertiesEditionPart#getRelationshipKind()
	 * 
	 */
	public Enumerator getRelationshipKind() {
		Enumerator selection = (Enumerator) ((StructuredSelection) relationshipKind.getSelection()).getFirstElement();
		return selection;
	}
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.WorkProductUseRelationshipPropertiesEditionPart#initRelationshipKind(Object input, Enumerator current)
	 */
	public void initRelationshipKind(Object input, Enumerator current) {
		relationshipKind.setInput(input);
		relationshipKind.modelUpdating(new StructuredSelection(current));
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.WorkProductUseRelationship.Properties.relationshipKind);
		if (eefElementEditorReadOnlyState && relationshipKind.isEnabled()) {
			relationshipKind.setEnabled(false);
			relationshipKind.setToolTipText(SpemMessages.WorkProductUseRelationship_ReadOnly);
		} else if (!eefElementEditorReadOnlyState && !relationshipKind.isEnabled()) {
			relationshipKind.setEnabled(true);
		}	
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.WorkProductUseRelationshipPropertiesEditionPart#setRelationshipKind(Enumerator newValue)
	 * 
	 */
