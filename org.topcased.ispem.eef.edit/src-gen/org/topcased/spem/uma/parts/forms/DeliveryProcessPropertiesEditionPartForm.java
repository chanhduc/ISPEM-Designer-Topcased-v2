 ...
 * 
 */
public class DeliveryProcessPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, DeliveryProcessPropertiesEditionPart {
	 ...
	 */
	public DeliveryProcessPropertiesEditionPartForm() { super(); }
	...
	protected Composite createPreConditionMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
		...
		editPreCondition = widgetFactory.createButton(parent, getDescription(UmaViewsRepository.DeliveryProcess.Properties.preCondition, UmaMessages.DeliveryProcessPropertiesEditionPart_PreConditionLabel), SWT.NONE);
	...
	protected Composite createPostConditionMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
		...
		editPostCondition = widgetFactory.createButton(parent, getDescription(UmaViewsRepository.DeliveryProcess.Properties.postCondition, UmaMessages.DeliveryProcessPropertiesEditionPart_PostConditionLabel), SWT.NONE);
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							DeliveryProcessPropertiesEditionPartForm.this,
							UmaViewsRepository.DeliveryProcess.Properties.presentationName,
		...
		briefDescription.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							DeliveryProcessPropertiesEditionPartForm.this,
							UmaViewsRepository.DeliveryProcess.Properties.briefDescription,
		...
		mainDescription.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							DeliveryProcessPropertiesEditionPartForm.this,
							UmaViewsRepository.DeliveryProcess.Properties.mainDescription,
		...
		purpose.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							DeliveryProcessPropertiesEditionPartForm.this,
							UmaViewsRepository.DeliveryProcess.Properties.purpose,
	...
	protected Composite createGuidanceReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.guidance = new ReferencesTable(getDescription(UmaViewsRepository.DeliveryProcess.Properties.guidance, UmaMessages.DeliveryProcessPropertiesEditionPart_GuidanceLabel), new ReferencesTableListener	() {
	...
	protected Composite createMetricReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.metric = new ReferencesTable(getDescription(UmaViewsRepository.DeliveryProcess.Properties.metric, UmaMessages.DeliveryProcessPropertiesEditionPart_MetricLabel), new ReferencesTableListener	() {
	...
	protected Composite createCategoryReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.category = new ReferencesTable(getDescription(UmaViewsRepository.DeliveryProcess.Properties.category, UmaMessages.DeliveryProcessPropertiesEditionPart_CategoryLabel), new ReferencesTableListener	() {
		...
		copyright.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							DeliveryProcessPropertiesEditionPartForm.this,
							UmaViewsRepository.DeliveryProcess.Properties.copyright,
	...
	protected Composite createAuthorMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
		...
		editAuthor = widgetFactory.createButton(parent, getDescription(UmaViewsRepository.DeliveryProcess.Properties.author, UmaMessages.DeliveryProcessPropertiesEditionPart_AuthorLabel), SWT.NONE);
		...
		changeDate.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							DeliveryProcessPropertiesEditionPartForm.this,
							UmaViewsRepository.DeliveryProcess.Properties.changeDate,
		...
		changeDescription.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							DeliveryProcessPropertiesEditionPartForm.this,
							UmaViewsRepository.DeliveryProcess.Properties.changeDescription,
		...
		version.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							DeliveryProcessPropertiesEditionPartForm.this,
							UmaViewsRepository.DeliveryProcess.Properties.version,
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							DeliveryProcessPropertiesEditionPartForm.this,
							UmaViewsRepository.DeliveryProcess.Properties.name,
	...
	protected Composite createHasMultipleOccurrencesCheckbox(FormToolkit widgetFactory, Composite parent) {
		hasMultipleOccurrences = widgetFactory.createButton(parent, getDescription(UmaViewsRepository.DeliveryProcess.Properties.hasMultipleOccurrences, UmaMessages.DeliveryProcessPropertiesEditionPart_HasMultipleOccurrencesLabel), SWT.CHECK);
	...
	protected Composite createIsOptionalCheckbox(FormToolkit widgetFactory, Composite parent) {
		isOptional = widgetFactory.createButton(parent, getDescription(UmaViewsRepository.DeliveryProcess.Properties.isOptional, UmaMessages.DeliveryProcessPropertiesEditionPart_IsOptionalLabel), SWT.CHECK);
	...
	protected Composite createIsPlannedCheckbox(FormToolkit widgetFactory, Composite parent) {
		isPlanned = widgetFactory.createButton(parent, getDescription(UmaViewsRepository.DeliveryProcess.Properties.isPlanned, UmaMessages.DeliveryProcessPropertiesEditionPart_IsPlannedLabel), SWT.CHECK);
	...
	protected Composite createIsRepeatableCheckbox(FormToolkit widgetFactory, Composite parent) {
		isRepeatable = widgetFactory.createButton(parent, getDescription(UmaViewsRepository.DeliveryProcess.Properties.isRepeatable, UmaMessages.DeliveryProcessPropertiesEditionPart_IsRepeatableLabel), SWT.CHECK);
	...
	protected Composite createIsOngoingCheckbox(FormToolkit widgetFactory, Composite parent) {
		isOngoing = widgetFactory.createButton(parent, getDescription(UmaViewsRepository.DeliveryProcess.Properties.isOngoing, UmaMessages.DeliveryProcessPropertiesEditionPart_IsOngoingLabel), SWT.CHECK);
	...
	protected Composite createIsEventDrivenCheckbox(FormToolkit widgetFactory, Composite parent) {
		isEventDriven = widgetFactory.createButton(parent, getDescription(UmaViewsRepository.DeliveryProcess.Properties.isEventDriven, UmaMessages.DeliveryProcessPropertiesEditionPart_IsEventDrivenLabel), SWT.CHECK);
	...
	protected Composite createLinkToPredecessorReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.linkToPredecessor = new ReferencesTable(getDescription(UmaViewsRepository.DeliveryProcess.Properties.linkToPredecessor, UmaMessages.DeliveryProcessPropertiesEditionPart_LinkToPredecessorLabel), new ReferencesTableListener	() {
	...
	protected Composite createLinkToSuccessorReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.linkToSuccessor = new ReferencesTable(getDescription(UmaViewsRepository.DeliveryProcess.Properties.linkToSuccessor, UmaMessages.DeliveryProcessPropertiesEditionPart_LinkToSuccessorLabel), new ReferencesTableListener	() {
	...
	protected Composite createSuppressedBreakdownElementReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.suppressedBreakdownElement = new ReferencesTable(getDescription(UmaViewsRepository.DeliveryProcess.Properties.suppressedBreakdownElement, UmaMessages.DeliveryProcessPropertiesEditionPart_SuppressedBreakdownElementLabel), new ReferencesTableListener	() {
	...
	protected Composite createValidContextReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.validContext = new ReferencesTable(getDescription(UmaViewsRepository.DeliveryProcess.Properties.validContext, UmaMessages.DeliveryProcessPropertiesEditionPart_ValidContextLabel), new ReferencesTableListener	() {
	...
	protected Composite createIsEnactableCheckbox(FormToolkit widgetFactory, Composite parent) {
		isEnactable = widgetFactory.createButton(parent, getDescription(UmaViewsRepository.DeliveryProcess.Properties.isEnactable, UmaMessages.DeliveryProcessPropertiesEditionPart_IsEnactableLabel), SWT.CHECK);
		isEnactable.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DeliveryProcessPropertiesEditionPartForm.this, UmaViewsRepository.DeliveryProcess.Properties.isEnactable, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new Boolean(isEnactable.getSelection())));
			}
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(UmaViewsRepository.DeliveryProcess.Properties.isEnactable, UmaViewsRepository.FORM_KIND), null); //$NON-NLS-1$
		...
		scope.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							DeliveryProcessPropertiesEditionPartForm.this,
							UmaViewsRepository.DeliveryProcess.Properties.scope,
	...
	protected Composite createUsageNoteMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
		...
		editUsageNote = widgetFactory.createButton(parent, getDescription(UmaViewsRepository.DeliveryProcess.Properties.usageNote, UmaMessages.DeliveryProcessPropertiesEditionPart_UsageNoteLabel), SWT.NONE);
		...
		scale.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							DeliveryProcessPropertiesEditionPartForm.this,
							UmaViewsRepository.DeliveryProcess.Properties.scale,
		...
		projectCharacteristics.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							DeliveryProcessPropertiesEditionPartForm.this,
							UmaViewsRepository.DeliveryProcess.Properties.projectCharacteristics,
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, projectCharacteristics.getText()));
					propertiesEditionComponent
							.firePropertiesChanged(new PropertiesEditionEvent(
									DeliveryProcessPropertiesEditionPartForm.this,
									UmaViewsRepository.DeliveryProcess.Properties.projectCharacteristics,
									PropertiesEditionEvent.FOCUS_CHANGED, PropertiesEditionEvent.FOCUS_LOST,
									null, projectCharacteristics.getText()));
				}
			}
	...
	protected Composite createCommunicationMaterialReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.communicationMaterial = new ReferencesTable(getDescription(UmaViewsRepository.DeliveryProcess.Properties.communicationMaterial, UmaMessages.DeliveryProcessPropertiesEditionPart_CommunicationMaterialLabel), new ReferencesTableListener	() {
		...
		// Start of user code for createCommunicationMaterialReferencesTable
	...
	protected Composite createEducationalMaterialReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.educationalMaterial = new ReferencesTable(getDescription(UmaViewsRepository.DeliveryProcess.Properties.educationalMaterial, UmaMessages.DeliveryProcessPropertiesEditionPart_EducationalMaterialLabel), new ReferencesTableListener	() {
		...
		// Start of user code for createEducationalMaterialReferencesTable
