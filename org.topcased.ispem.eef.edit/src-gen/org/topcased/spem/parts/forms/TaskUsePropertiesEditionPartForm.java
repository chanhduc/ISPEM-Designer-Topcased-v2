 ...
 * 
 */
public class TaskUsePropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, TaskUsePropertiesEditionPart {
	 ...
	 */
	public TaskUsePropertiesEditionPartForm() { super(); }
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							TaskUsePropertiesEditionPartForm.this,
							SpemViewsRepository.TaskUse.Properties.presentationName,
		...
		briefDescription.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							TaskUsePropertiesEditionPartForm.this,
							SpemViewsRepository.TaskUse.Properties.briefDescription,
		...
		mainDescription.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							TaskUsePropertiesEditionPartForm.this,
							SpemViewsRepository.TaskUse.Properties.mainDescription,
		...
		purpose.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							TaskUsePropertiesEditionPartForm.this,
							SpemViewsRepository.TaskUse.Properties.purpose,
	...
	protected Composite createGuidanceReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.guidance = new ReferencesTable(getDescription(SpemViewsRepository.TaskUse.Properties.guidance, SpemMessages.TaskUsePropertiesEditionPart_GuidanceLabel), new ReferencesTableListener	() {
	...
	protected Composite createMetricReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.metric = new ReferencesTable(getDescription(SpemViewsRepository.TaskUse.Properties.metric, SpemMessages.TaskUsePropertiesEditionPart_MetricLabel), new ReferencesTableListener	() {
	...
	protected Composite createCategoryReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.category = new ReferencesTable(getDescription(SpemViewsRepository.TaskUse.Properties.category, SpemMessages.TaskUsePropertiesEditionPart_CategoryLabel), new ReferencesTableListener	() {
		...
		copyright.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							TaskUsePropertiesEditionPartForm.this,
							SpemViewsRepository.TaskUse.Properties.copyright,
	...
	protected Composite createAuthorMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
		...
		editAuthor = widgetFactory.createButton(parent, getDescription(SpemViewsRepository.TaskUse.Properties.author, SpemMessages.TaskUsePropertiesEditionPart_AuthorLabel), SWT.NONE);
		...
		changeDate.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							TaskUsePropertiesEditionPartForm.this,
							SpemViewsRepository.TaskUse.Properties.changeDate,
		...
		changeDescription.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							TaskUsePropertiesEditionPartForm.this,
							SpemViewsRepository.TaskUse.Properties.changeDescription,
		...
		version.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							TaskUsePropertiesEditionPartForm.this,
							SpemViewsRepository.TaskUse.Properties.version,
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							TaskUsePropertiesEditionPartForm.this,
							SpemViewsRepository.TaskUse.Properties.name,
	...
	protected Composite createHasMultipleOccurrencesCheckbox(FormToolkit widgetFactory, Composite parent) {
		hasMultipleOccurrences = widgetFactory.createButton(parent, getDescription(SpemViewsRepository.TaskUse.Properties.hasMultipleOccurrences, SpemMessages.TaskUsePropertiesEditionPart_HasMultipleOccurrencesLabel), SWT.CHECK);
	...
	protected Composite createIsOptionalCheckbox(FormToolkit widgetFactory, Composite parent) {
		isOptional = widgetFactory.createButton(parent, getDescription(SpemViewsRepository.TaskUse.Properties.isOptional, SpemMessages.TaskUsePropertiesEditionPart_IsOptionalLabel), SWT.CHECK);
	...
	protected Composite createIsPlannedCheckbox(FormToolkit widgetFactory, Composite parent) {
		isPlanned = widgetFactory.createButton(parent, getDescription(SpemViewsRepository.TaskUse.Properties.isPlanned, SpemMessages.TaskUsePropertiesEditionPart_IsPlannedLabel), SWT.CHECK);
	...
	protected Composite createIsSynchronizedWithSourceCheckbox(FormToolkit widgetFactory, Composite parent) {
		isSynchronizedWithSource = widgetFactory.createButton(parent, getDescription(SpemViewsRepository.TaskUse.Properties.isSynchronizedWithSource, SpemMessages.TaskUsePropertiesEditionPart_IsSynchronizedWithSourceLabel), SWT.CHECK);
	...
	protected Composite createIsRepeatableCheckbox(FormToolkit widgetFactory, Composite parent) {
		isRepeatable = widgetFactory.createButton(parent, getDescription(SpemViewsRepository.TaskUse.Properties.isRepeatable, SpemMessages.TaskUsePropertiesEditionPart_IsRepeatableLabel), SWT.CHECK);
	...
	protected Composite createIsOngoingCheckbox(FormToolkit widgetFactory, Composite parent) {
		isOngoing = widgetFactory.createButton(parent, getDescription(SpemViewsRepository.TaskUse.Properties.isOngoing, SpemMessages.TaskUsePropertiesEditionPart_IsOngoingLabel), SWT.CHECK);
	...
	protected Composite createIsEventDrivenCheckbox(FormToolkit widgetFactory, Composite parent) {
		isEventDriven = widgetFactory.createButton(parent, getDescription(SpemViewsRepository.TaskUse.Properties.isEventDriven, SpemMessages.TaskUsePropertiesEditionPart_IsEventDrivenLabel), SWT.CHECK);
	...
	protected Composite createLinkToPredecessorReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.linkToPredecessor = new ReferencesTable(getDescription(SpemViewsRepository.TaskUse.Properties.linkToPredecessor, SpemMessages.TaskUsePropertiesEditionPart_LinkToPredecessorLabel), new ReferencesTableListener	() {
	...
	protected Composite createLinkToSuccessorReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.linkToSuccessor = new ReferencesTable(getDescription(SpemViewsRepository.TaskUse.Properties.linkToSuccessor, SpemMessages.TaskUsePropertiesEditionPart_LinkToSuccessorLabel), new ReferencesTableListener	() {
	...
	protected Composite createUsedQualificationReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.usedQualification = new ReferencesTable(getDescription(SpemViewsRepository.TaskUse.Properties.usedQualification, SpemMessages.TaskUsePropertiesEditionPart_UsedQualificationLabel), new ReferencesTableListener	() {
		...
		// Start of user code for createUsedQualificationReferencesTable
	...
	protected Composite createSelectedStepReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.selectedStep = new ReferencesTable(getDescription(SpemViewsRepository.TaskUse.Properties.selectedStep, SpemMessages.TaskUsePropertiesEditionPart_SelectedStepLabel), new ReferencesTableListener	() {
		...
		// Start of user code for createSelectedStepReferencesTable
		...
		preCondition.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							TaskUsePropertiesEditionPartForm.this,
							SpemViewsRepository.TaskUse.Properties.preCondition,
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, preCondition.getText()));
					propertiesEditionComponent
							.firePropertiesChanged(new PropertiesEditionEvent(
									TaskUsePropertiesEditionPartForm.this,
									SpemViewsRepository.TaskUse.Properties.preCondition,
									PropertiesEditionEvent.FOCUS_CHANGED, PropertiesEditionEvent.FOCUS_LOST,
									null, preCondition.getText()));
				}
			}
		...
		postCondition.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							TaskUsePropertiesEditionPartForm.this,
							SpemViewsRepository.TaskUse.Properties.postCondition,
							PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, postCondition.getText()));
					propertiesEditionComponent
							.firePropertiesChanged(new PropertiesEditionEvent(
									TaskUsePropertiesEditionPartForm.this,
									SpemViewsRepository.TaskUse.Properties.postCondition,
									PropertiesEditionEvent.FOCUS_CHANGED, PropertiesEditionEvent.FOCUS_LOST,
									null, postCondition.getText()));
				}
			}
