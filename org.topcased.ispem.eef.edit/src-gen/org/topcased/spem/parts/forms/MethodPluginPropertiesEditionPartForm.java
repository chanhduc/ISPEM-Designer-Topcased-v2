 ...
 * 
 */
public class MethodPluginPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, MethodPluginPropertiesEditionPart {
	 ...
	 */
	public MethodPluginPropertiesEditionPartForm() { super(); }
	...
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		createDescription(parent, SpemViewsRepository.MethodPlugin.Properties.name, SpemMessages.MethodPluginPropertiesEditionPart_NameLabel);
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							MethodPluginPropertiesEditionPartForm.this,
							SpemViewsRepository.MethodPlugin.Properties.name,
	...
	protected Composite createOwnedMethodContentPackageTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.ownedMethodContentPackage = new ReferencesTable(getDescription(SpemViewsRepository.MethodPlugin.Properties.ownedMethodContentPackage, SpemMessages.MethodPluginPropertiesEditionPart_OwnedMethodContentPackageLabel), new ReferencesTableListener() {
		...
		// Start of user code for createOwnedMethodContentPackageTableComposition
	...
	protected Composite createOwnedProcessPackageTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.ownedProcessPackage = new ReferencesTable(getDescription(SpemViewsRepository.MethodPlugin.Properties.ownedProcessPackage, SpemMessages.MethodPluginPropertiesEditionPart_OwnedProcessPackageLabel), new ReferencesTableListener() {
			public void handleAdd() {
		...
		// Start of user code for createOwnedProcessPackageTableComposition
	...
	protected Composite createBasePluginReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.basePlugin = new ReferencesTable(getDescription(SpemViewsRepository.MethodPlugin.Properties.basePlugin, SpemMessages.MethodPluginPropertiesEditionPart_BasePluginLabel), new ReferencesTableListener	() {
		...
		// Start of user code for createBasePluginReferencesTable
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.MethodPluginPropertiesEditionPart#getName()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.MethodPluginPropertiesEditionPart#setName(String newValue)
	 * 
	 */
	public void setName(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.MethodPlugin.Properties.name);
		if (eefElementEditorReadOnlyState && name.isEnabled()) {
			name.setEnabled(false);
			name.setToolTipText(SpemMessages.MethodPlugin_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.MethodPluginPropertiesEditionPart#initOwnedMethodContentPackage(EObject current, EReference containingFeature, EReference feature)
	 */
	public void initOwnedMethodContentPackage(ReferencesTableSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.MethodPlugin.Properties.ownedMethodContentPackage);
		if (eefElementEditorReadOnlyState && ownedMethodContentPackage.isEnabled()) {
			ownedMethodContentPackage.setEnabled(false);
			ownedMethodContentPackage.setToolTipText(SpemMessages.MethodPlugin_ReadOnly);
		} else if (!eefElementEditorReadOnlyState && !ownedMethodContentPackage.isEnabled()) {
			ownedMethodContentPackage.setEnabled(true);
		}	
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.MethodPluginPropertiesEditionPart#updateOwnedMethodContentPackage()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.MethodPluginPropertiesEditionPart#addFilterOwnedMethodContentPackage(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.MethodPluginPropertiesEditionPart#addBusinessFilterOwnedMethodContentPackage(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.MethodPluginPropertiesEditionPart#isContainedInOwnedMethodContentPackageTable(EObject element)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.MethodPluginPropertiesEditionPart#initOwnedProcessPackage(EObject current, EReference containingFeature, EReference feature)
	 */
	public void initOwnedProcessPackage(ReferencesTableSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.MethodPlugin.Properties.ownedProcessPackage);
		if (eefElementEditorReadOnlyState && ownedProcessPackage.isEnabled()) {
			ownedProcessPackage.setEnabled(false);
			ownedProcessPackage.setToolTipText(SpemMessages.MethodPlugin_ReadOnly);
		} else if (!eefElementEditorReadOnlyState && !ownedProcessPackage.isEnabled()) {
			ownedProcessPackage.setEnabled(true);
		}	
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.MethodPluginPropertiesEditionPart#updateOwnedProcessPackage()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.MethodPluginPropertiesEditionPart#addFilterOwnedProcessPackage(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.MethodPluginPropertiesEditionPart#addBusinessFilterOwnedProcessPackage(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.MethodPluginPropertiesEditionPart#isContainedInOwnedProcessPackageTable(EObject element)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.MethodPluginPropertiesEditionPart#initBasePlugin(org.eclipse.emf.eef.runtime.ui.widgets.referencestable.ReferencesTableSettings)
	 */
	public void initBasePlugin(ReferencesTableSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.MethodPlugin.Properties.basePlugin);
		if (eefElementEditorReadOnlyState && basePlugin.getTable().isEnabled()) {
			basePlugin.setEnabled(false);
			basePlugin.setToolTipText(SpemMessages.MethodPlugin_ReadOnly);
		} else if (!eefElementEditorReadOnlyState && !basePlugin.getTable().isEnabled()) {
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.MethodPluginPropertiesEditionPart#updateBasePlugin()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.MethodPluginPropertiesEditionPart#addFilterBasePlugin(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.MethodPluginPropertiesEditionPart#addBusinessFilterBasePlugin(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.MethodPluginPropertiesEditionPart#isContainedInBasePluginTable(EObject element)
	 * 
	 */
