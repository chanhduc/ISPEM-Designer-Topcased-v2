 ...
 * 
 */
public class WorkProductDefinitionRelationshipPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, WorkProductDefinitionRelationshipPropertiesEditionPart {
	 ...
	 */
	public WorkProductDefinitionRelationshipPropertiesEditionPartForm() { super(); }
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							WorkProductDefinitionRelationshipPropertiesEditionPartForm.this,
							SpemViewsRepository.WorkProductDefinitionRelationship.Properties.presentationName,
		...
		briefDescription.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							WorkProductDefinitionRelationshipPropertiesEditionPartForm.this,
							SpemViewsRepository.WorkProductDefinitionRelationship.Properties.briefDescription,
		...
		mainDescription.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							WorkProductDefinitionRelationshipPropertiesEditionPartForm.this,
							SpemViewsRepository.WorkProductDefinitionRelationship.Properties.mainDescription,
		...
		purpose.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							WorkProductDefinitionRelationshipPropertiesEditionPartForm.this,
							SpemViewsRepository.WorkProductDefinitionRelationship.Properties.purpose,
	...
	protected Composite createGuidanceReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.guidance = new ReferencesTable(getDescription(SpemViewsRepository.WorkProductDefinitionRelationship.Properties.guidance, SpemMessages.WorkProductDefinitionRelationshipPropertiesEditionPart_GuidanceLabel), new ReferencesTableListener	() {
	...
	protected Composite createMetricReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.metric = new ReferencesTable(getDescription(SpemViewsRepository.WorkProductDefinitionRelationship.Properties.metric, SpemMessages.WorkProductDefinitionRelationshipPropertiesEditionPart_MetricLabel), new ReferencesTableListener	() {
	...
	protected Composite createCategoryReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.category = new ReferencesTable(getDescription(SpemViewsRepository.WorkProductDefinitionRelationship.Properties.category, SpemMessages.WorkProductDefinitionRelationshipPropertiesEditionPart_CategoryLabel), new ReferencesTableListener	() {
		...
		copyright.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							WorkProductDefinitionRelationshipPropertiesEditionPartForm.this,
							SpemViewsRepository.WorkProductDefinitionRelationship.Properties.copyright,
	...
	protected Composite createAuthorMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
		...
		editAuthor = widgetFactory.createButton(parent, getDescription(SpemViewsRepository.WorkProductDefinitionRelationship.Properties.author, SpemMessages.WorkProductDefinitionRelationshipPropertiesEditionPart_AuthorLabel), SWT.NONE);
		...
		changeDate.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							WorkProductDefinitionRelationshipPropertiesEditionPartForm.this,
							SpemViewsRepository.WorkProductDefinitionRelationship.Properties.changeDate,
		...
		changeDescription.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							WorkProductDefinitionRelationshipPropertiesEditionPartForm.this,
							SpemViewsRepository.WorkProductDefinitionRelationship.Properties.changeDescription,
		...
		version.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							WorkProductDefinitionRelationshipPropertiesEditionPartForm.this,
							SpemViewsRepository.WorkProductDefinitionRelationship.Properties.version,
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							WorkProductDefinitionRelationshipPropertiesEditionPartForm.this,
							SpemViewsRepository.WorkProductDefinitionRelationship.Properties.name,
	...
	protected Composite createTargetReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.target = new ReferencesTable(getDescription(SpemViewsRepository.WorkProductDefinitionRelationship.Properties.target, SpemMessages.WorkProductDefinitionRelationshipPropertiesEditionPart_TargetLabel), new ReferencesTableListener	() {
