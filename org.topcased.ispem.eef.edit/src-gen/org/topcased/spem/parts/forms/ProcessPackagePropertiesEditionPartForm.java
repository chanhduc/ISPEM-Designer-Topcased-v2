 ...
 * 
 */
public class ProcessPackagePropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, ProcessPackagePropertiesEditionPart {
	 ...
	 */
	public ProcessPackagePropertiesEditionPartForm() { super(); }
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							ProcessPackagePropertiesEditionPartForm.this,
							SpemViewsRepository.ProcessPackage.Properties.name,
