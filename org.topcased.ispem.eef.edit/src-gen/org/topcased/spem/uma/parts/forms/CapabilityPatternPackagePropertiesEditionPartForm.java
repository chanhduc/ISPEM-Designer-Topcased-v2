 ...
 * 
 */
public class CapabilityPatternPackagePropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, CapabilityPatternPackagePropertiesEditionPart {
	 ...
	 */
	public CapabilityPatternPackagePropertiesEditionPartForm() { super(); }
	...
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		createDescription(parent, UmaViewsRepository.CapabilityPatternPackage.Properties.name, UmaMessages.CapabilityPatternPackagePropertiesEditionPart_NameLabel);
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							CapabilityPatternPackagePropertiesEditionPartForm.this,
							UmaViewsRepository.CapabilityPatternPackage.Properties.name,
	...
	protected Composite createOwnedProcessMemberTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.ownedProcessMember = new ReferencesTable(getDescription(UmaViewsRepository.CapabilityPatternPackage.Properties.ownedProcessMember, UmaMessages.CapabilityPatternPackagePropertiesEditionPart_OwnedProcessMemberLabel), new ReferencesTableListener() {
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.CapabilityPatternPackagePropertiesEditionPart#getName()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.CapabilityPatternPackagePropertiesEditionPart#setName(String newValue)
	 * 
	 */
	public void setName(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(UmaViewsRepository.CapabilityPatternPackage.Properties.name);
		if (eefElementEditorReadOnlyState && name.isEnabled()) {
			name.setEnabled(false);
			name.setToolTipText(UmaMessages.CapabilityPatternPackage_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.CapabilityPatternPackagePropertiesEditionPart#initOwnedProcessMember(EObject current, EReference containingFeature, EReference feature)
	 */
	public void initOwnedProcessMember(ReferencesTableSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(UmaViewsRepository.CapabilityPatternPackage.Properties.ownedProcessMember);
		if (eefElementEditorReadOnlyState && ownedProcessMember.isEnabled()) {
			ownedProcessMember.setEnabled(false);
			ownedProcessMember.setToolTipText(UmaMessages.CapabilityPatternPackage_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.CapabilityPatternPackagePropertiesEditionPart#updateOwnedProcessMember()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.CapabilityPatternPackagePropertiesEditionPart#addFilterOwnedProcessMember(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.CapabilityPatternPackagePropertiesEditionPart#addBusinessFilterOwnedProcessMember(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.CapabilityPatternPackagePropertiesEditionPart#isContainedInOwnedProcessMemberTable(EObject element)
	 * 
	 */
