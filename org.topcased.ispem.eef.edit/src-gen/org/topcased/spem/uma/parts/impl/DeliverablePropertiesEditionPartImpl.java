...
public class DeliverablePropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, DeliverablePropertiesEditionPart {
	...
	protected Composite createGuidanceAdvancedReferencesTable(Composite parent) {
		String label = getDescription(UmaViewsRepository.Deliverable.Properties.guidance, UmaMessages.DeliverablePropertiesEditionPart_GuidanceLabel);		 
	...
	protected Composite createMetricAdvancedReferencesTable(Composite parent) {
		String label = getDescription(UmaViewsRepository.Deliverable.Properties.metric, UmaMessages.DeliverablePropertiesEditionPart_MetricLabel);		 
	...
	protected Composite createCategoryAdvancedReferencesTable(Composite parent) {
		String label = getDescription(UmaViewsRepository.Deliverable.Properties.category, UmaMessages.DeliverablePropertiesEditionPart_CategoryLabel);		 
	...
	protected Composite createAuthorMultiValuedEditor(Composite parent) {
		...
		editAuthor.setText(getDescription(UmaViewsRepository.Deliverable.Properties.author, UmaMessages.DeliverablePropertiesEditionPart_AuthorLabel));
	...
	protected Composite createHasMultipleOccurrencesCheckbox(Composite parent) {
		...
		hasMultipleOccurrences.setText(getDescription(UmaViewsRepository.Deliverable.Properties.hasMultipleOccurrences, UmaMessages.DeliverablePropertiesEditionPart_HasMultipleOccurrencesLabel));
	...
	protected Composite createIsOptionalCheckbox(Composite parent) {
		...
		isOptional.setText(getDescription(UmaViewsRepository.Deliverable.Properties.isOptional, UmaMessages.DeliverablePropertiesEditionPart_IsOptionalLabel));
	...
	protected Composite createIsPlannedCheckbox(Composite parent) {
		...
		isPlanned.setText(getDescription(UmaViewsRepository.Deliverable.Properties.isPlanned, UmaMessages.DeliverablePropertiesEditionPart_IsPlannedLabel));
	...
	protected Composite createIsSynchronizedWithSourceCheckbox(Composite parent) {
		...
		isSynchronizedWithSource.setText(getDescription(UmaViewsRepository.Deliverable.Properties.isSynchronizedWithSource, UmaMessages.DeliverablePropertiesEditionPart_IsSynchronizedWithSourceLabel));
	...
	protected Composite createDeliveredProductAdvancedReferencesTable(Composite parent) {
		String label = getDescription(UmaViewsRepository.Deliverable.Properties.deliveredProduct, UmaMessages.DeliverablePropertiesEditionPart_DeliveredProductLabel);		 
		this.deliveredProduct = new ReferencesTable(label, new ReferencesTableListener() {
	...
	protected Composite createExternalDescriptionText(Composite parent) {
		...
		externalDescription = SWTUtils.createScrollableText(parent, SWT.BORDER);
	...
	protected Composite createPackagingGuidanceText(Composite parent) {
		...
		packagingGuidance = SWTUtils.createScrollableText(parent, SWT.BORDER);
