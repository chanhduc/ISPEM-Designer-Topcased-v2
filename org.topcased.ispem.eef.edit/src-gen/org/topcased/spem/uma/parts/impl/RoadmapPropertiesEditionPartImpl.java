...
public class RoadmapPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, RoadmapPropertiesEditionPart {
	...
	protected Composite createGuidanceAdvancedReferencesTable(Composite parent) {
		String label = getDescription(UmaViewsRepository.Roadmap.Properties.guidance, UmaMessages.RoadmapPropertiesEditionPart_GuidanceLabel);		 
	...
	protected Composite createMetricAdvancedReferencesTable(Composite parent) {
		String label = getDescription(UmaViewsRepository.Roadmap.Properties.metric, UmaMessages.RoadmapPropertiesEditionPart_MetricLabel);		 
	...
	protected Composite createCategoryAdvancedReferencesTable(Composite parent) {
		String label = getDescription(UmaViewsRepository.Roadmap.Properties.category, UmaMessages.RoadmapPropertiesEditionPart_CategoryLabel);		 
	...
	protected Composite createAuthorMultiValuedEditor(Composite parent) {
		...
		editAuthor.setText(getDescription(UmaViewsRepository.Roadmap.Properties.author, UmaMessages.RoadmapPropertiesEditionPart_AuthorLabel));
