 ...
 * 
 */
public interface DomainArtifactDefinitionPropertiesEditionPart {
	...
	/**
	 * Init the organized
	 * @param settings settings for the organized ReferencesTable 
	 */
	public void initOrganized(ReferencesTableSettings settings);

	/**
	 * Update the organized
	 * @param newValue the organized to update
	 * 
	 */
	public void updateOrganized();

	/**
	 * Adds the given filter to the organized edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return true if the given element is contained inside the organized table
	 * 
	 */
