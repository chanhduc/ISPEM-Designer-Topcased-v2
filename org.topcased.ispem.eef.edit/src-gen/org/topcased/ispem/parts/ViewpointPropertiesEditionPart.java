 ...
 * 
 */
public interface ViewpointPropertiesEditionPart {
	...
	/**
	 * Init the caracterizes
	 * @param settings settings for the caracterizes ReferencesTable 
	 */
	public void initCaracterizes(ReferencesTableSettings settings);

	/**
	 * Update the caracterizes
	 * @param newValue the caracterizes to update
	 * 
	 */
	public void updateCaracterizes();

	/**
	 * Adds the given filter to the caracterizes edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
	...
	/**
	 * @return true if the given element is contained inside the caracterizes table
	 * 
	 */
