 ...
 * 
 */
public class LanguageTaskDefinitionPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, LanguageTaskDefinitionPropertiesEditionPart {
	 ...
	 * 
	 */
	public LanguageTaskDefinitionPropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(Composite parent) {
		...
		propertiesGroup.setText(IspemMessages.LanguageTaskDefinitionPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createKindFlatComboViewer(Composite parent) {
		...
		kind = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(IspemViewsRepository.LanguageTaskDefinition.Properties.kind, IspemViewsRepository.SWT_KIND));
		kind.setLabelProvider(new AdapterFactoryLabelProvider(adapterFactory));

		kind.addSelectionChangedListener(new ISelectionChangedListener() {

			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LanguageTaskDefinitionPropertiesEditionPartImpl.this, IspemViewsRepository.LanguageTaskDefinition.Properties.kind, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getKind()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(IspemViewsRepository.LanguageTaskDefinition.Properties.kind, IspemViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createPresentationNameText(Composite parent) {
		...
		presentationName.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LanguageTaskDefinitionPropertiesEditionPartImpl.this, IspemViewsRepository.LanguageTaskDefinition.Properties.presentationName, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, presentationName.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(IspemViewsRepository.LanguageTaskDefinition.Properties.presentationName, IspemViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createBriefDescriptionText(Composite parent) {
		...
		briefDescription.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LanguageTaskDefinitionPropertiesEditionPartImpl.this, IspemViewsRepository.LanguageTaskDefinition.Properties.briefDescription, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, briefDescription.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(IspemViewsRepository.LanguageTaskDefinition.Properties.briefDescription, IspemViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createMainDescriptionText(Composite parent) {
		...
		mainDescription.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LanguageTaskDefinitionPropertiesEditionPartImpl.this, IspemViewsRepository.LanguageTaskDefinition.Properties.mainDescription, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, mainDescription.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(IspemViewsRepository.LanguageTaskDefinition.Properties.mainDescription, IspemViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createPurposeText(Composite parent) {
		...
		purpose.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LanguageTaskDefinitionPropertiesEditionPartImpl.this, IspemViewsRepository.LanguageTaskDefinition.Properties.purpose, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, purpose.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(IspemViewsRepository.LanguageTaskDefinition.Properties.purpose, IspemViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createGuidanceAdvancedReferencesTable(Composite parent) {
		String label = getDescription(IspemViewsRepository.LanguageTaskDefinition.Properties.guidance, IspemMessages.LanguageTaskDefinitionPropertiesEditionPart_GuidanceLabel);		 
		...
		this.guidance.setHelpText(propertiesEditionComponent.getHelpContent(IspemViewsRepository.LanguageTaskDefinition.Properties.guidance, IspemViewsRepository.SWT_KIND));
		this.guidance.createControls(parent);
		this.guidance.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LanguageTaskDefinitionPropertiesEditionPartImpl.this, IspemViewsRepository.LanguageTaskDefinition.Properties.guidance, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		"guidance", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LanguageTaskDefinitionPropertiesEditionPartImpl.this, IspemViewsRepository.LanguageTaskDefinition.Properties.guidance,
	...
	protected void moveGuidance(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LanguageTaskDefinitionPropertiesEditionPartImpl.this, IspemViewsRepository.LanguageTaskDefinition.Properties.guidance, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		guidance.refresh();
	}
	...
	protected void removeFromGuidance(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LanguageTaskDefinitionPropertiesEditionPartImpl.this, IspemViewsRepository.LanguageTaskDefinition.Properties.guidance, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		guidance.refresh();
	}
	...
	protected Composite createMetricAdvancedReferencesTable(Composite parent) {
		String label = getDescription(IspemViewsRepository.LanguageTaskDefinition.Properties.metric, IspemMessages.LanguageTaskDefinitionPropertiesEditionPart_MetricLabel);		 
		...
		this.metric.setHelpText(propertiesEditionComponent.getHelpContent(IspemViewsRepository.LanguageTaskDefinition.Properties.metric, IspemViewsRepository.SWT_KIND));
		this.metric.createControls(parent);
		this.metric.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LanguageTaskDefinitionPropertiesEditionPartImpl.this, IspemViewsRepository.LanguageTaskDefinition.Properties.metric, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addMetric() {
		...
		"metric", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LanguageTaskDefinitionPropertiesEditionPartImpl.this, IspemViewsRepository.LanguageTaskDefinition.Properties.metric,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
				metric.refresh();
			}
	...
	protected void moveMetric(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LanguageTaskDefinitionPropertiesEditionPartImpl.this, IspemViewsRepository.LanguageTaskDefinition.Properties.metric, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		metric.refresh();
	}
	...
	protected void removeFromMetric(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LanguageTaskDefinitionPropertiesEditionPartImpl.this, IspemViewsRepository.LanguageTaskDefinition.Properties.metric, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		metric.refresh();
	}
	...
	protected Composite createCategoryAdvancedReferencesTable(Composite parent) {
		String label = getDescription(IspemViewsRepository.LanguageTaskDefinition.Properties.category, IspemMessages.LanguageTaskDefinitionPropertiesEditionPart_CategoryLabel);		 
		...
		this.category.setHelpText(propertiesEditionComponent.getHelpContent(IspemViewsRepository.LanguageTaskDefinition.Properties.category, IspemViewsRepository.SWT_KIND));
		this.category.createControls(parent);
		this.category.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LanguageTaskDefinitionPropertiesEditionPartImpl.this, IspemViewsRepository.LanguageTaskDefinition.Properties.category, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addCategory() {
		...
		"category", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LanguageTaskDefinitionPropertiesEditionPartImpl.this, IspemViewsRepository.LanguageTaskDefinition.Properties.category,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
				category.refresh();
			}
	...
	protected void moveCategory(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LanguageTaskDefinitionPropertiesEditionPartImpl.this, IspemViewsRepository.LanguageTaskDefinition.Properties.category, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		category.refresh();
	}
	...
	protected void removeFromCategory(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LanguageTaskDefinitionPropertiesEditionPartImpl.this, IspemViewsRepository.LanguageTaskDefinition.Properties.category, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		category.refresh();
	}
	...
	protected Composite createCopyrightText(Composite parent) {
		...
		copyright.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LanguageTaskDefinitionPropertiesEditionPartImpl.this, IspemViewsRepository.LanguageTaskDefinition.Properties.copyright, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, copyright.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(IspemViewsRepository.LanguageTaskDefinition.Properties.copyright, IspemViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createAuthorMultiValuedEditor(Composite parent) {
		...
		editAuthor.setText(getDescription(IspemViewsRepository.LanguageTaskDefinition.Properties.author, IspemMessages.LanguageTaskDefinitionPropertiesEditionPart_AuthorLabel));
		...
		editAuthor.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				if (dialog.open() == Window.OK) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LanguageTaskDefinitionPropertiesEditionPartImpl.this, IspemViewsRepository.LanguageTaskDefinition.Properties.author, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new BasicEList(authorList)));
					setHasChanged(true);
				}
			}
		});
	...
	protected Composite createChangeDateText(Composite parent) {
		...
		changeDate.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LanguageTaskDefinitionPropertiesEditionPartImpl.this, IspemViewsRepository.LanguageTaskDefinition.Properties.changeDate, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, changeDate.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(IspemViewsRepository.LanguageTaskDefinition.Properties.changeDate, IspemViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createChangeDescriptionText(Composite parent) {
		...
		changeDescription.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LanguageTaskDefinitionPropertiesEditionPartImpl.this, IspemViewsRepository.LanguageTaskDefinition.Properties.changeDescription, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, changeDescription.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(IspemViewsRepository.LanguageTaskDefinition.Properties.changeDescription, IspemViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createVersionText(Composite parent) {
		...
		version.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LanguageTaskDefinitionPropertiesEditionPartImpl.this, IspemViewsRepository.LanguageTaskDefinition.Properties.version, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, version.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(IspemViewsRepository.LanguageTaskDefinition.Properties.version, IspemViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createUriText(Composite parent) {
		...
		uri.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LanguageTaskDefinitionPropertiesEditionPartImpl.this, IspemViewsRepository.LanguageTaskDefinition.Properties.uri, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, uri.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(IspemViewsRepository.LanguageTaskDefinition.Properties.uri, IspemViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createPreConditionMultiValuedEditor(Composite parent) {
		...
		editPreCondition.setText(getDescription(IspemViewsRepository.LanguageTaskDefinition.Properties.preCondition, IspemMessages.LanguageTaskDefinitionPropertiesEditionPart_PreConditionLabel));
		...
		editPreCondition.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				if (dialog.open() == Window.OK) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LanguageTaskDefinitionPropertiesEditionPartImpl.this, IspemViewsRepository.LanguageTaskDefinition.Properties.preCondition, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new BasicEList(preConditionList)));
					setHasChanged(true);
				}
			}
		});
	...
	protected Composite createPostConditionMultiValuedEditor(Composite parent) {
		...
		editPostCondition.setText(getDescription(IspemViewsRepository.LanguageTaskDefinition.Properties.postCondition, IspemMessages.LanguageTaskDefinitionPropertiesEditionPart_PostConditionLabel));
		...
		editPostCondition.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				if (dialog.open() == Window.OK) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LanguageTaskDefinitionPropertiesEditionPartImpl.this, IspemViewsRepository.LanguageTaskDefinition.Properties.postCondition, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new BasicEList(postConditionList)));
					setHasChanged(true);
				}
			}
		});
	...
	protected Composite createNameText(Composite parent) {
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LanguageTaskDefinitionPropertiesEditionPartImpl.this, IspemViewsRepository.LanguageTaskDefinition.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(IspemViewsRepository.LanguageTaskDefinition.Properties.name, IspemViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createVariabilityTypeEMFComboViewer(Composite parent) {
		...
		variabilityType.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LanguageTaskDefinitionPropertiesEditionPartImpl.this, IspemViewsRepository.LanguageTaskDefinition.Properties.variabilityType, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getVariabilityType()));
			}

		});
		variabilityType.setID(IspemViewsRepository.LanguageTaskDefinition.Properties.variabilityType);
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(IspemViewsRepository.LanguageTaskDefinition.Properties.variabilityType, IspemViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createVariabilityBasedOnElementFlatComboViewer(Composite parent) {
		...
		variabilityBasedOnElement = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(IspemViewsRepository.LanguageTaskDefinition.Properties.variabilityBasedOnElement, IspemViewsRepository.SWT_KIND));
		...
		variabilityBasedOnElement.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LanguageTaskDefinitionPropertiesEditionPartImpl.this, IspemViewsRepository.LanguageTaskDefinition.Properties.variabilityBasedOnElement, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getVariabilityBasedOnElement()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(IspemViewsRepository.LanguageTaskDefinition.Properties.variabilityBasedOnElement, IspemViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createMethodContentKindFlatComboViewer(Composite parent) {
		...
		methodContentKind = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(IspemViewsRepository.LanguageTaskDefinition.Properties.methodContentKind, IspemViewsRepository.SWT_KIND));
		...
		methodContentKind.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LanguageTaskDefinitionPropertiesEditionPartImpl.this, IspemViewsRepository.LanguageTaskDefinition.Properties.methodContentKind, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getMethodContentKind()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(IspemViewsRepository.LanguageTaskDefinition.Properties.methodContentKind, IspemViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createOwnedTaskDefinitionParameterAdvancedTableComposition(Composite parent) {
		this.ownedTaskDefinitionParameter = new ReferencesTable(getDescription(IspemViewsRepository.LanguageTaskDefinition.Properties.ownedTaskDefinitionParameter, IspemMessages.LanguageTaskDefinitionPropertiesEditionPart_OwnedTaskDefinitionParameterLabel), new ReferencesTableListener() {
			public void handleAdd() { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LanguageTaskDefinitionPropertiesEditionPartImpl.this, IspemViewsRepository.LanguageTaskDefinition.Properties.ownedTaskDefinitionParameter, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				ownedTaskDefinitionParameter.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LanguageTaskDefinitionPropertiesEditionPartImpl.this, IspemViewsRepository.LanguageTaskDefinition.Properties.ownedTaskDefinitionParameter, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				ownedTaskDefinitionParameter.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LanguageTaskDefinitionPropertiesEditionPartImpl.this, IspemViewsRepository.LanguageTaskDefinition.Properties.ownedTaskDefinitionParameter, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				ownedTaskDefinitionParameter.refresh();
			}
			public void handleRemove(EObject element) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LanguageTaskDefinitionPropertiesEditionPartImpl.this, IspemViewsRepository.LanguageTaskDefinition.Properties.ownedTaskDefinitionParameter, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				ownedTaskDefinitionParameter.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.ownedTaskDefinitionParameter.setHelpText(propertiesEditionComponent.getHelpContent(IspemViewsRepository.LanguageTaskDefinition.Properties.ownedTaskDefinitionParameter, IspemViewsRepository.SWT_KIND));
		...
		this.ownedTaskDefinitionParameter.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LanguageTaskDefinitionPropertiesEditionPartImpl.this, IspemViewsRepository.LanguageTaskDefinition.Properties.ownedTaskDefinitionParameter, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected Composite createRequiredQualificationAdvancedReferencesTable(Composite parent) {
		String label = getDescription(IspemViewsRepository.LanguageTaskDefinition.Properties.requiredQualification, IspemMessages.LanguageTaskDefinitionPropertiesEditionPart_RequiredQualificationLabel);		 
		...
		this.requiredQualification.setHelpText(propertiesEditionComponent.getHelpContent(IspemViewsRepository.LanguageTaskDefinition.Properties.requiredQualification, IspemViewsRepository.SWT_KIND));
		this.requiredQualification.createControls(parent);
		this.requiredQualification.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LanguageTaskDefinitionPropertiesEditionPartImpl.this, IspemViewsRepository.LanguageTaskDefinition.Properties.requiredQualification, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addRequiredQualification() {
		...
		"requiredQualification", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LanguageTaskDefinitionPropertiesEditionPartImpl.this, IspemViewsRepository.LanguageTaskDefinition.Properties.requiredQualification,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveRequiredQualification(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LanguageTaskDefinitionPropertiesEditionPartImpl.this, IspemViewsRepository.LanguageTaskDefinition.Properties.requiredQualification, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		requiredQualification.refresh();
	}
	...
	protected void removeFromRequiredQualification(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LanguageTaskDefinitionPropertiesEditionPartImpl.this, IspemViewsRepository.LanguageTaskDefinition.Properties.requiredQualification, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		requiredQualification.refresh();
	}
	...
	protected Composite createUsedToolAdvancedReferencesTable(Composite parent) {
		String label = getDescription(IspemViewsRepository.LanguageTaskDefinition.Properties.usedTool, IspemMessages.LanguageTaskDefinitionPropertiesEditionPart_UsedToolLabel);		 
		...
		this.usedTool.setHelpText(propertiesEditionComponent.getHelpContent(IspemViewsRepository.LanguageTaskDefinition.Properties.usedTool, IspemViewsRepository.SWT_KIND));
		this.usedTool.createControls(parent);
		this.usedTool.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LanguageTaskDefinitionPropertiesEditionPartImpl.this, IspemViewsRepository.LanguageTaskDefinition.Properties.usedTool, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addUsedTool() {
		...
		"usedTool", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LanguageTaskDefinitionPropertiesEditionPartImpl.this, IspemViewsRepository.LanguageTaskDefinition.Properties.usedTool,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
				usedTool.refresh();
			}
	...
	protected void moveUsedTool(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LanguageTaskDefinitionPropertiesEditionPartImpl.this, IspemViewsRepository.LanguageTaskDefinition.Properties.usedTool, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		usedTool.refresh();
	}
	...
	protected void removeFromUsedTool(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LanguageTaskDefinitionPropertiesEditionPartImpl.this, IspemViewsRepository.LanguageTaskDefinition.Properties.usedTool, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		usedTool.refresh();
	}
	...
	protected Composite createSpecializedByFlatComboViewer(Composite parent) {
		...
		specializedBy = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(IspemViewsRepository.LanguageTaskDefinition.Properties.specializedBy, IspemViewsRepository.SWT_KIND));
		...
		specializedBy.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(LanguageTaskDefinitionPropertiesEditionPartImpl.this, IspemViewsRepository.LanguageTaskDefinition.Properties.specializedBy, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getSpecializedBy()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(IspemViewsRepository.LanguageTaskDefinition.Properties.specializedBy, IspemViewsRepository.SWT_KIND), null); //$NON-NLS-1$
