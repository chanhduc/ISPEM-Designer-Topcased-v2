...
public class ToolDefinitionPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, ToolDefinitionPropertiesEditionPart {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							...
							SpemViewsRepository.ToolDefinition.Properties.presentationName,
		...
		briefDescription.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							ToolDefinitionPropertiesEditionPartForm.this,
							SpemViewsRepository.ToolDefinition.Properties.briefDescription,
		...
		mainDescription.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							ToolDefinitionPropertiesEditionPartForm.this,
							SpemViewsRepository.ToolDefinition.Properties.mainDescription,
		...
		purpose.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							ToolDefinitionPropertiesEditionPartForm.this,
							SpemViewsRepository.ToolDefinition.Properties.purpose,
	...
	protected Composite createGuidanceReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.guidance = new ReferencesTable(getDescription(SpemViewsRepository.ToolDefinition.Properties.guidance, SpemMessages.ToolDefinitionPropertiesEditionPart_GuidanceLabel), new ReferencesTableListener	() {
	...
	protected Composite createMetricReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.metric = new ReferencesTable(getDescription(SpemViewsRepository.ToolDefinition.Properties.metric, SpemMessages.ToolDefinitionPropertiesEditionPart_MetricLabel), new ReferencesTableListener	() {
	...
	protected Composite createCategoryReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.category = new ReferencesTable(getDescription(SpemViewsRepository.ToolDefinition.Properties.category, SpemMessages.ToolDefinitionPropertiesEditionPart_CategoryLabel), new ReferencesTableListener	() {
		...
		copyright.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							ToolDefinitionPropertiesEditionPartForm.this,
							SpemViewsRepository.ToolDefinition.Properties.copyright,
	...
	protected Composite createAuthorMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
		...
		editAuthor = widgetFactory.createButton(parent, getDescription(SpemViewsRepository.ToolDefinition.Properties.author, SpemMessages.ToolDefinitionPropertiesEditionPart_AuthorLabel), SWT.NONE);
		...
		changeDate.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							ToolDefinitionPropertiesEditionPartForm.this,
							SpemViewsRepository.ToolDefinition.Properties.changeDate,
		...
		changeDescription.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							ToolDefinitionPropertiesEditionPartForm.this,
							SpemViewsRepository.ToolDefinition.Properties.changeDescription,
		...
		version.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							ToolDefinitionPropertiesEditionPartForm.this,
							SpemViewsRepository.ToolDefinition.Properties.version,
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							ToolDefinitionPropertiesEditionPartForm.this,
							SpemViewsRepository.ToolDefinition.Properties.name,
	...
	protected Composite createManagedWorkProductReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.managedWorkProduct = new ReferencesTable(getDescription(SpemViewsRepository.ToolDefinition.Properties.managedWorkProduct, SpemMessages.ToolDefinitionPropertiesEditionPart_ManagedWorkProductLabel), new ReferencesTableListener	() {
