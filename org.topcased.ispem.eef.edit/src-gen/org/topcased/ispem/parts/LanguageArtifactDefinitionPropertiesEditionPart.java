 ...
 * 
 */
public interface LanguageArtifactDefinitionPropertiesEditionPart {
	...
	/**
	 * Init the representedBy
	 * @param settings the combo setting
	 */
	public void initRepresentedBy(EObjectFlatComboSettings settings);

	/**
	 * Defines a new representedBy
	 * @param newValue the new representedBy to set
	 * 
	 */
	...
	/**
	 * Adds the given filter to the representedBy edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
