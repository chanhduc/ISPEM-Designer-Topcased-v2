...
public class ProcessParameterPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, ProcessParameterPropertiesEditionPart {
	...
	protected Composite createGuidanceAdvancedReferencesTable(Composite parent) {
		String label = getDescription(SpemViewsRepository.ProcessParameter.Properties.guidance, SpemMessages.ProcessParameterPropertiesEditionPart_GuidanceLabel);		 
	...
	protected Composite createMetricAdvancedReferencesTable(Composite parent) {
		String label = getDescription(SpemViewsRepository.ProcessParameter.Properties.metric, SpemMessages.ProcessParameterPropertiesEditionPart_MetricLabel);		 
	...
	protected Composite createCategoryAdvancedReferencesTable(Composite parent) {
		String label = getDescription(SpemViewsRepository.ProcessParameter.Properties.category, SpemMessages.ProcessParameterPropertiesEditionPart_CategoryLabel);		 
	...
	protected Composite createAuthorMultiValuedEditor(Composite parent) {
		...
		editAuthor.setText(getDescription(SpemViewsRepository.ProcessParameter.Properties.author, SpemMessages.ProcessParameterPropertiesEditionPart_AuthorLabel));
	...
	protected Composite createHasMultipleOccurrencesCheckbox(Composite parent) {
		...
		hasMultipleOccurrences.setText(getDescription(SpemViewsRepository.ProcessParameter.Properties.hasMultipleOccurrences, SpemMessages.ProcessParameterPropertiesEditionPart_HasMultipleOccurrencesLabel));
	...
	protected Composite createIsOptionalCheckbox(Composite parent) {
		...
		isOptional.setText(getDescription(SpemViewsRepository.ProcessParameter.Properties.isOptional, SpemMessages.ProcessParameterPropertiesEditionPart_IsOptionalLabel));
	...
	protected Composite createIsPlannedCheckbox(Composite parent) {
		...
		isPlanned.setText(getDescription(SpemViewsRepository.ProcessParameter.Properties.isPlanned, SpemMessages.ProcessParameterPropertiesEditionPart_IsPlannedLabel));
