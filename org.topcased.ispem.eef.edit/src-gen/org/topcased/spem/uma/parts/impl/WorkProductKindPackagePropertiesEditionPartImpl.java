...
public class WorkProductKindPackagePropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, WorkProductKindPackagePropertiesEditionPart {
	...
	protected Composite createReusedPackageAdvancedReferencesTable(Composite parent) {
		String label = getDescription(UmaViewsRepository.WorkProductKindPackage.Properties.reusedPackage, UmaMessages.WorkProductKindPackagePropertiesEditionPart_ReusedPackageLabel);		 
