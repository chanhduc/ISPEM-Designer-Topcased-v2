...
public class PlanningDataPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, PlanningDataPropertiesEditionPart {
	...
	protected Composite createKindFlatComboViewer(Composite parent) {
		createDescription(parent, SpemViewsRepository.PlanningData.Properties.kind, SpemMessages.PlanningDataPropertiesEditionPart_KindLabel);
	...
	protected Composite createPresentationNameText(Composite parent) {
		createDescription(parent, SpemViewsRepository.PlanningData.Properties.presentationName, SpemMessages.PlanningDataPropertiesEditionPart_PresentationNameLabel);
	...
	protected Composite createBriefDescriptionText(Composite parent) {
		createDescription(parent, SpemViewsRepository.PlanningData.Properties.briefDescription, SpemMessages.PlanningDataPropertiesEditionPart_BriefDescriptionLabel);
	...
	protected Composite createMainDescriptionText(Composite parent) {
		createDescription(parent, SpemViewsRepository.PlanningData.Properties.mainDescription, SpemMessages.PlanningDataPropertiesEditionPart_MainDescriptionLabel);
	...
	protected Composite createPurposeText(Composite parent) {
		createDescription(parent, SpemViewsRepository.PlanningData.Properties.purpose, SpemMessages.PlanningDataPropertiesEditionPart_PurposeLabel);
	...
	protected Composite createGuidanceAdvancedReferencesTable(Composite parent) {
		String label = getDescription(SpemViewsRepository.PlanningData.Properties.guidance, SpemMessages.PlanningDataPropertiesEditionPart_GuidanceLabel);		 
	...
	protected Composite createMetricAdvancedReferencesTable(Composite parent) {
		String label = getDescription(SpemViewsRepository.PlanningData.Properties.metric, SpemMessages.PlanningDataPropertiesEditionPart_MetricLabel);		 
	...
	protected Composite createCategoryAdvancedReferencesTable(Composite parent) {
		String label = getDescription(SpemViewsRepository.PlanningData.Properties.category, SpemMessages.PlanningDataPropertiesEditionPart_CategoryLabel);		 
	...
	protected Composite createCopyrightText(Composite parent) {
		createDescription(parent, SpemViewsRepository.PlanningData.Properties.copyright, SpemMessages.PlanningDataPropertiesEditionPart_CopyrightLabel);
	...
	protected Composite createAuthorMultiValuedEditor(Composite parent) {
		...
		editAuthor.setText(getDescription(SpemViewsRepository.PlanningData.Properties.author, SpemMessages.PlanningDataPropertiesEditionPart_AuthorLabel));
	...
	protected Composite createChangeDateText(Composite parent) {
		createDescription(parent, SpemViewsRepository.PlanningData.Properties.changeDate, SpemMessages.PlanningDataPropertiesEditionPart_ChangeDateLabel);
	...
	protected Composite createChangeDescriptionText(Composite parent) {
		createDescription(parent, SpemViewsRepository.PlanningData.Properties.changeDescription, SpemMessages.PlanningDataPropertiesEditionPart_ChangeDescriptionLabel);
	...
	protected Composite createVersionText(Composite parent) {
		createDescription(parent, SpemViewsRepository.PlanningData.Properties.version, SpemMessages.PlanningDataPropertiesEditionPart_VersionLabel);
	...
	protected Composite createNameText(Composite parent) {
		createDescription(parent, SpemViewsRepository.PlanningData.Properties.name, SpemMessages.PlanningDataPropertiesEditionPart_NameLabel);
	...
	protected Composite createStartDateText(Composite parent) {
		createDescription(parent, SpemViewsRepository.PlanningData.Properties.startDate, SpemMessages.PlanningDataPropertiesEditionPart_StartDateLabel);
		startDate = SWTUtils.createScrollableText(parent, SWT.BORDER);
		...
		// Start of user code for createStartDateText
	...
	protected Composite createFinishDateText(Composite parent) {
		createDescription(parent, SpemViewsRepository.PlanningData.Properties.finishDate, SpemMessages.PlanningDataPropertiesEditionPart_FinishDateLabel);
		finishDate = SWTUtils.createScrollableText(parent, SWT.BORDER);
		...
		// Start of user code for createFinishDateText
	...
	protected Composite createRankText(Composite parent) {
		createDescription(parent, SpemViewsRepository.PlanningData.Properties.rank, SpemMessages.PlanningDataPropertiesEditionPart_RankLabel);
		rank = SWTUtils.createScrollableText(parent, SWT.BORDER);
		...
		// Start of user code for createRankText
	...
	protected Composite createDurationText(Composite parent) {
		createDescription(parent, SpemViewsRepository.PlanningData.Properties.duration, SpemMessages.PlanningDataPropertiesEditionPart_DurationLabel);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.PlanningDataPropertiesEditionPart#getKind()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.PlanningDataPropertiesEditionPart#initKind(EObjectFlatComboSettings)
	 */
	public void initKind(EObjectFlatComboSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.PlanningData.Properties.kind);
		if (eefElementEditorReadOnlyState && kind.isEnabled()) {
			kind.setEnabled(false);
			kind.setToolTipText(SpemMessages.PlanningData_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.PlanningDataPropertiesEditionPart#setKind(EObject newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.PlanningDataPropertiesEditionPart#setKindButtonMode(ButtonsModeEnum newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.PlanningDataPropertiesEditionPart#addFilterKind(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.PlanningDataPropertiesEditionPart#addBusinessFilterKind(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.PlanningDataPropertiesEditionPart#getPresentationName()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.PlanningDataPropertiesEditionPart#setPresentationName(String newValue)
	 * 
	 */
	public void setPresentationName(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.PlanningData.Properties.presentationName);
		if (eefElementEditorReadOnlyState && presentationName.isEnabled()) {
			presentationName.setEnabled(false);
			presentationName.setToolTipText(SpemMessages.PlanningData_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.PlanningDataPropertiesEditionPart#getBriefDescription()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.PlanningDataPropertiesEditionPart#setBriefDescription(String newValue)
	 * 
	 */
	public void setBriefDescription(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.PlanningData.Properties.briefDescription);
		if (eefElementEditorReadOnlyState && briefDescription.isEnabled()) {
			briefDescription.setEnabled(false);
			briefDescription.setToolTipText(SpemMessages.PlanningData_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.PlanningDataPropertiesEditionPart#getMainDescription()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.PlanningDataPropertiesEditionPart#setMainDescription(String newValue)
	 * 
	 */
	public void setMainDescription(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.PlanningData.Properties.mainDescription);
		if (eefElementEditorReadOnlyState && mainDescription.isEnabled()) {
			mainDescription.setEnabled(false);
			mainDescription.setToolTipText(SpemMessages.PlanningData_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.PlanningDataPropertiesEditionPart#getPurpose()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.PlanningDataPropertiesEditionPart#setPurpose(String newValue)
	 * 
	 */
	public void setPurpose(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.PlanningData.Properties.purpose);
		if (eefElementEditorReadOnlyState && purpose.isEnabled()) {
			purpose.setEnabled(false);
			purpose.setToolTipText(SpemMessages.PlanningData_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.PlanningDataPropertiesEditionPart#initGuidance(org.eclipse.emf.eef.runtime.ui.widgets.referencestable.ReferencesTableSettings)
	 */
	public void initGuidance(ReferencesTableSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.PlanningData.Properties.guidance);
		if (eefElementEditorReadOnlyState && guidance.getTable().isEnabled()) {
			guidance.setEnabled(false);
			guidance.setToolTipText(SpemMessages.PlanningData_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.PlanningDataPropertiesEditionPart#updateGuidance()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.PlanningDataPropertiesEditionPart#addFilterGuidance(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.PlanningDataPropertiesEditionPart#addBusinessFilterGuidance(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.PlanningDataPropertiesEditionPart#isContainedInGuidanceTable(EObject element)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.PlanningDataPropertiesEditionPart#initMetric(org.eclipse.emf.eef.runtime.ui.widgets.referencestable.ReferencesTableSettings)
	 */
	public void initMetric(ReferencesTableSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.PlanningData.Properties.metric);
		if (eefElementEditorReadOnlyState && metric.getTable().isEnabled()) {
			metric.setEnabled(false);
			metric.setToolTipText(SpemMessages.PlanningData_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.PlanningDataPropertiesEditionPart#updateMetric()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.PlanningDataPropertiesEditionPart#addFilterMetric(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.PlanningDataPropertiesEditionPart#addBusinessFilterMetric(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.PlanningDataPropertiesEditionPart#isContainedInMetricTable(EObject element)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.PlanningDataPropertiesEditionPart#initCategory(org.eclipse.emf.eef.runtime.ui.widgets.referencestable.ReferencesTableSettings)
	 */
	public void initCategory(ReferencesTableSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.PlanningData.Properties.category);
		if (eefElementEditorReadOnlyState && category.getTable().isEnabled()) {
			category.setEnabled(false);
			category.setToolTipText(SpemMessages.PlanningData_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.PlanningDataPropertiesEditionPart#updateCategory()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.PlanningDataPropertiesEditionPart#addFilterCategory(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.PlanningDataPropertiesEditionPart#addBusinessFilterCategory(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.PlanningDataPropertiesEditionPart#isContainedInCategoryTable(EObject element)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.PlanningDataPropertiesEditionPart#getCopyright()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.PlanningDataPropertiesEditionPart#setCopyright(String newValue)
	 * 
	 */
	public void setCopyright(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.PlanningData.Properties.copyright);
		if (eefElementEditorReadOnlyState && copyright.isEnabled()) {
			copyright.setEnabled(false);
			copyright.setToolTipText(SpemMessages.PlanningData_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.PlanningDataPropertiesEditionPart#getAuthor()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.PlanningDataPropertiesEditionPart#setAuthor(EList newValue)
	 * 
	 */
	public void setAuthor(EList newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.PlanningData.Properties.author);
		if (eefElementEditorReadOnlyState && author.isEnabled()) {
			author.setEnabled(false);
			author.setToolTipText(SpemMessages.PlanningData_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.PlanningDataPropertiesEditionPart#getChangeDate()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.PlanningDataPropertiesEditionPart#setChangeDate(String newValue)
	 * 
	 */
	public void setChangeDate(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.PlanningData.Properties.changeDate);
		if (eefElementEditorReadOnlyState && changeDate.isEnabled()) {
			changeDate.setEnabled(false);
			changeDate.setToolTipText(SpemMessages.PlanningData_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.PlanningDataPropertiesEditionPart#getChangeDescription()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.PlanningDataPropertiesEditionPart#setChangeDescription(String newValue)
	 * 
	 */
	public void setChangeDescription(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.PlanningData.Properties.changeDescription);
		if (eefElementEditorReadOnlyState && changeDescription.isEnabled()) {
			changeDescription.setEnabled(false);
			changeDescription.setToolTipText(SpemMessages.PlanningData_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.PlanningDataPropertiesEditionPart#getVersion()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.PlanningDataPropertiesEditionPart#setVersion(String newValue)
	 * 
	 */
	public void setVersion(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.PlanningData.Properties.version);
		if (eefElementEditorReadOnlyState && version.isEnabled()) {
			version.setEnabled(false);
			version.setToolTipText(SpemMessages.PlanningData_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.PlanningDataPropertiesEditionPart#getName()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.PlanningDataPropertiesEditionPart#setName(String newValue)
	 * 
	 */
	public void setName(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.PlanningData.Properties.name);
		if (eefElementEditorReadOnlyState && name.isEnabled()) {
			name.setEnabled(false);
			name.setToolTipText(SpemMessages.PlanningData_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.PlanningDataPropertiesEditionPart#getStartDate()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.PlanningDataPropertiesEditionPart#setStartDate(String newValue)
	 * 
	 */
	public void setStartDate(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.PlanningData.Properties.startDate);
		if (eefElementEditorReadOnlyState && startDate.isEnabled()) {
			startDate.setEnabled(false);
			startDate.setToolTipText(SpemMessages.PlanningData_ReadOnly);
		} else if (!eefElementEditorReadOnlyState && !startDate.isEnabled()) {
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.PlanningDataPropertiesEditionPart#getFinishDate()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.PlanningDataPropertiesEditionPart#setFinishDate(String newValue)
	 * 
	 */
	public void setFinishDate(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.PlanningData.Properties.finishDate);
		if (eefElementEditorReadOnlyState && finishDate.isEnabled()) {
			finishDate.setEnabled(false);
			finishDate.setToolTipText(SpemMessages.PlanningData_ReadOnly);
		} else if (!eefElementEditorReadOnlyState && !finishDate.isEnabled()) {
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.PlanningDataPropertiesEditionPart#getRank()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.PlanningDataPropertiesEditionPart#setRank(String newValue)
	 * 
	 */
	public void setRank(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.PlanningData.Properties.rank);
		if (eefElementEditorReadOnlyState && rank.isEnabled()) {
			rank.setEnabled(false);
			rank.setToolTipText(SpemMessages.PlanningData_ReadOnly);
		} else if (!eefElementEditorReadOnlyState && !rank.isEnabled()) {
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.PlanningDataPropertiesEditionPart#getDuration()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.parts.PlanningDataPropertiesEditionPart#setDuration(String newValue)
	 * 
	 */
	public void setDuration(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(SpemViewsRepository.PlanningData.Properties.duration);
		if (eefElementEditorReadOnlyState && duration.isEnabled()) {
			duration.setEnabled(false);
			duration.setToolTipText(SpemMessages.PlanningData_ReadOnly);
