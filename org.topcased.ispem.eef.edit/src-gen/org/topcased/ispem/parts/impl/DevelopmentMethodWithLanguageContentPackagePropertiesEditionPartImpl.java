 ...
 * 
 */
public class DevelopmentMethodWithLanguageContentPackagePropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, DevelopmentMethodWithLanguageContentPackagePropertiesEditionPart {
	 ...
	 * 
	 */
	public DevelopmentMethodWithLanguageContentPackagePropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
		...
		composer = new PartComposer(developmentMethodWithLanguageContentPackageStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == IspemViewsRepository.DevelopmentMethodWithLanguageContentPackage.Properties.relatedLanguage) {
					return createRelatedLanguageFlatComboViewer(parent);
				}
	...
	protected Composite createPropertiesGroup(Composite parent) {
		...
		propertiesGroup.setText(IspemMessages.DevelopmentMethodWithLanguageContentPackagePropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createNameText(Composite parent) {
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DevelopmentMethodWithLanguageContentPackagePropertiesEditionPartImpl.this, IspemViewsRepository.DevelopmentMethodWithLanguageContentPackage.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(IspemViewsRepository.DevelopmentMethodWithLanguageContentPackage.Properties.name, IspemViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createOwnedMethodContentMemberAdvancedTableComposition(Composite parent) {
		this.ownedMethodContentMember = new ReferencesTable(getDescription(IspemViewsRepository.DevelopmentMethodWithLanguageContentPackage.Properties.ownedMethodContentMember, IspemMessages.DevelopmentMethodWithLanguageContentPackagePropertiesEditionPart_OwnedMethodContentMemberLabel), new ReferencesTableListener() {
			public void handleAdd() { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DevelopmentMethodWithLanguageContentPackagePropertiesEditionPartImpl.this, IspemViewsRepository.DevelopmentMethodWithLanguageContentPackage.Properties.ownedMethodContentMember, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				ownedMethodContentMember.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DevelopmentMethodWithLanguageContentPackagePropertiesEditionPartImpl.this, IspemViewsRepository.DevelopmentMethodWithLanguageContentPackage.Properties.ownedMethodContentMember, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				ownedMethodContentMember.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DevelopmentMethodWithLanguageContentPackagePropertiesEditionPartImpl.this, IspemViewsRepository.DevelopmentMethodWithLanguageContentPackage.Properties.ownedMethodContentMember, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				ownedMethodContentMember.refresh();
			}
			public void handleRemove(EObject element) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DevelopmentMethodWithLanguageContentPackagePropertiesEditionPartImpl.this, IspemViewsRepository.DevelopmentMethodWithLanguageContentPackage.Properties.ownedMethodContentMember, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				ownedMethodContentMember.refresh();
			}
		...
		this.ownedMethodContentMember.setHelpText(propertiesEditionComponent.getHelpContent(IspemViewsRepository.DevelopmentMethodWithLanguageContentPackage.Properties.ownedMethodContentMember, IspemViewsRepository.SWT_KIND));
		...
		this.ownedMethodContentMember.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DevelopmentMethodWithLanguageContentPackagePropertiesEditionPartImpl.this, IspemViewsRepository.DevelopmentMethodWithLanguageContentPackage.Properties.ownedMethodContentMember, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected Composite createReusedPackageAdvancedReferencesTable(Composite parent) {
		String label = getDescription(IspemViewsRepository.DevelopmentMethodWithLanguageContentPackage.Properties.reusedPackage, IspemMessages.DevelopmentMethodWithLanguageContentPackagePropertiesEditionPart_ReusedPackageLabel);		 
		...
		this.reusedPackage.setHelpText(propertiesEditionComponent.getHelpContent(IspemViewsRepository.DevelopmentMethodWithLanguageContentPackage.Properties.reusedPackage, IspemViewsRepository.SWT_KIND));
		this.reusedPackage.createControls(parent);
		this.reusedPackage.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DevelopmentMethodWithLanguageContentPackagePropertiesEditionPartImpl.this, IspemViewsRepository.DevelopmentMethodWithLanguageContentPackage.Properties.reusedPackage, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		"reusedPackage", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DevelopmentMethodWithLanguageContentPackagePropertiesEditionPartImpl.this, IspemViewsRepository.DevelopmentMethodWithLanguageContentPackage.Properties.reusedPackage,
	...
	protected void moveReusedPackage(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DevelopmentMethodWithLanguageContentPackagePropertiesEditionPartImpl.this, IspemViewsRepository.DevelopmentMethodWithLanguageContentPackage.Properties.reusedPackage, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		reusedPackage.refresh();
	}
	...
	protected void removeFromReusedPackage(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DevelopmentMethodWithLanguageContentPackagePropertiesEditionPartImpl.this, IspemViewsRepository.DevelopmentMethodWithLanguageContentPackage.Properties.reusedPackage, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		reusedPackage.refresh();
	}
	 ...
	 * 
	 */
	protected Composite createRelatedLanguageFlatComboViewer(Composite parent) {
		...
		relatedLanguage = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(IspemViewsRepository.DevelopmentMethodWithLanguageContentPackage.Properties.relatedLanguage, IspemViewsRepository.SWT_KIND));
		...
		relatedLanguage.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DevelopmentMethodWithLanguageContentPackagePropertiesEditionPartImpl.this, IspemViewsRepository.DevelopmentMethodWithLanguageContentPackage.Properties.relatedLanguage, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getRelatedLanguage()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(IspemViewsRepository.DevelopmentMethodWithLanguageContentPackage.Properties.relatedLanguage, IspemViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createRelatedMethodFlatComboViewer(Composite parent) {
		...
		relatedMethod = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(IspemViewsRepository.DevelopmentMethodWithLanguageContentPackage.Properties.relatedMethod, IspemViewsRepository.SWT_KIND));
		...
		relatedMethod.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DevelopmentMethodWithLanguageContentPackagePropertiesEditionPartImpl.this, IspemViewsRepository.DevelopmentMethodWithLanguageContentPackage.Properties.relatedMethod, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getRelatedMethod()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(IspemViewsRepository.DevelopmentMethodWithLanguageContentPackage.Properties.relatedMethod, IspemViewsRepository.SWT_KIND), null); //$NON-NLS-1$
