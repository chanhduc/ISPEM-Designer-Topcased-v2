...
public class JoinNodePropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, JoinNodePropertiesEditionPart {
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(ActivityMessages.JoinNodePropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createKindFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		...
		kind = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(ActivityViewsRepository.JoinNode.Properties.kind, ActivityViewsRepository.FORM_KIND));
		...
		kind.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(JoinNodePropertiesEditionPartForm.this, ActivityViewsRepository.JoinNode.Properties.kind, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getKind()));
			}

		});
		kind.setID(ActivityViewsRepository.JoinNode.Properties.kind);
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ActivityViewsRepository.JoinNode.Properties.kind, ActivityViewsRepository.FORM_KIND), null); //$NON-NLS-1$
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							...
							ActivityViewsRepository.JoinNode.Properties.presentationName,
		...
		presentationName.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(JoinNodePropertiesEditionPartForm.this, ActivityViewsRepository.JoinNode.Properties.presentationName, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, presentationName.getText()));
				}
			}
		});
		EditingUtils.setID(presentationName, ActivityViewsRepository.JoinNode.Properties.presentationName);
		EditingUtils.setEEFtype(presentationName, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ActivityViewsRepository.JoinNode.Properties.presentationName, ActivityViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createBriefDescriptionText(FormToolkit widgetFactory, Composite parent) {
		...
		briefDescription.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							JoinNodePropertiesEditionPartForm.this,
							ActivityViewsRepository.JoinNode.Properties.briefDescription,
		...
		briefDescription.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(JoinNodePropertiesEditionPartForm.this, ActivityViewsRepository.JoinNode.Properties.briefDescription, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, briefDescription.getText()));
				}
			}
		});
		EditingUtils.setID(briefDescription, ActivityViewsRepository.JoinNode.Properties.briefDescription);
		EditingUtils.setEEFtype(briefDescription, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ActivityViewsRepository.JoinNode.Properties.briefDescription, ActivityViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createMainDescriptionText(FormToolkit widgetFactory, Composite parent) {
		...
		mainDescription.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							JoinNodePropertiesEditionPartForm.this,
							ActivityViewsRepository.JoinNode.Properties.mainDescription,
		...
		mainDescription.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(JoinNodePropertiesEditionPartForm.this, ActivityViewsRepository.JoinNode.Properties.mainDescription, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, mainDescription.getText()));
				}
			}
		});
		EditingUtils.setID(mainDescription, ActivityViewsRepository.JoinNode.Properties.mainDescription);
		EditingUtils.setEEFtype(mainDescription, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ActivityViewsRepository.JoinNode.Properties.mainDescription, ActivityViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createPurposeText(FormToolkit widgetFactory, Composite parent) {
		...
		purpose.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							JoinNodePropertiesEditionPartForm.this,
							ActivityViewsRepository.JoinNode.Properties.purpose,
		...
		purpose.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(JoinNodePropertiesEditionPartForm.this, ActivityViewsRepository.JoinNode.Properties.purpose, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, purpose.getText()));
				}
			}
		});
		EditingUtils.setID(purpose, ActivityViewsRepository.JoinNode.Properties.purpose);
		EditingUtils.setEEFtype(purpose, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ActivityViewsRepository.JoinNode.Properties.purpose, ActivityViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createGuidanceReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.guidance = new ReferencesTable(getDescription(ActivityViewsRepository.JoinNode.Properties.guidance, ActivityMessages.JoinNodePropertiesEditionPart_GuidanceLabel), new ReferencesTableListener	() {
		...
		this.guidance.setHelpText(propertiesEditionComponent.getHelpContent(ActivityViewsRepository.JoinNode.Properties.guidance, ActivityViewsRepository.FORM_KIND));
		this.guidance.createControls(parent, widgetFactory);
		this.guidance.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(JoinNodePropertiesEditionPartForm.this, ActivityViewsRepository.JoinNode.Properties.guidance, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		"guidance", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(JoinNodePropertiesEditionPartForm.this, ActivityViewsRepository.JoinNode.Properties.guidance,
	...
	protected void moveGuidance(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(JoinNodePropertiesEditionPartForm.this, ActivityViewsRepository.JoinNode.Properties.guidance, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		guidance.refresh();
	}
	...
	protected void removeFromGuidance(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(JoinNodePropertiesEditionPartForm.this, ActivityViewsRepository.JoinNode.Properties.guidance, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		guidance.refresh();
	}
	...
	protected Composite createMetricReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.metric = new ReferencesTable(getDescription(ActivityViewsRepository.JoinNode.Properties.metric, ActivityMessages.JoinNodePropertiesEditionPart_MetricLabel), new ReferencesTableListener	() {
		...
		this.metric.setHelpText(propertiesEditionComponent.getHelpContent(ActivityViewsRepository.JoinNode.Properties.metric, ActivityViewsRepository.FORM_KIND));
		this.metric.createControls(parent, widgetFactory);
		this.metric.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(JoinNodePropertiesEditionPartForm.this, ActivityViewsRepository.JoinNode.Properties.metric, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addMetric() {
		...
		"metric", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(JoinNodePropertiesEditionPartForm.this, ActivityViewsRepository.JoinNode.Properties.metric,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
				metric.refresh();
			}
	...
	protected void moveMetric(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(JoinNodePropertiesEditionPartForm.this, ActivityViewsRepository.JoinNode.Properties.metric, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		metric.refresh();
	}
	...
	protected void removeFromMetric(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(JoinNodePropertiesEditionPartForm.this, ActivityViewsRepository.JoinNode.Properties.metric, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		metric.refresh();
	}
	...
	protected Composite createCategoryReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.category = new ReferencesTable(getDescription(ActivityViewsRepository.JoinNode.Properties.category, ActivityMessages.JoinNodePropertiesEditionPart_CategoryLabel), new ReferencesTableListener	() {
		...
		this.category.setHelpText(propertiesEditionComponent.getHelpContent(ActivityViewsRepository.JoinNode.Properties.category, ActivityViewsRepository.FORM_KIND));
		this.category.createControls(parent, widgetFactory);
		this.category.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(JoinNodePropertiesEditionPartForm.this, ActivityViewsRepository.JoinNode.Properties.category, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addCategory() {
		...
		"category", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(JoinNodePropertiesEditionPartForm.this, ActivityViewsRepository.JoinNode.Properties.category,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
				category.refresh();
			}
	...
	protected void moveCategory(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(JoinNodePropertiesEditionPartForm.this, ActivityViewsRepository.JoinNode.Properties.category, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		category.refresh();
	}
	...
	protected void removeFromCategory(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(JoinNodePropertiesEditionPartForm.this, ActivityViewsRepository.JoinNode.Properties.category, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		category.refresh();
	}
	...
	protected Composite createCopyrightText(FormToolkit widgetFactory, Composite parent) {
		...
		copyright.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							JoinNodePropertiesEditionPartForm.this,
							ActivityViewsRepository.JoinNode.Properties.copyright,
		...
		copyright.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(JoinNodePropertiesEditionPartForm.this, ActivityViewsRepository.JoinNode.Properties.copyright, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, copyright.getText()));
				}
			}
		});
		EditingUtils.setID(copyright, ActivityViewsRepository.JoinNode.Properties.copyright);
		EditingUtils.setEEFtype(copyright, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ActivityViewsRepository.JoinNode.Properties.copyright, ActivityViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createAuthorMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
		...
		editAuthor = widgetFactory.createButton(parent, getDescription(ActivityViewsRepository.JoinNode.Properties.author, ActivityMessages.JoinNodePropertiesEditionPart_AuthorLabel), SWT.NONE);
		...
		editAuthor.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				if (dialog.open() == Window.OK) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(JoinNodePropertiesEditionPartForm.this, ActivityViewsRepository.JoinNode.Properties.author, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new BasicEList(authorList)));
					setHasChanged(true);
				}
			}
		});
	...
	protected Composite createChangeDateText(FormToolkit widgetFactory, Composite parent) {
		...
		changeDate.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							JoinNodePropertiesEditionPartForm.this,
							ActivityViewsRepository.JoinNode.Properties.changeDate,
		...
		changeDate.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(JoinNodePropertiesEditionPartForm.this, ActivityViewsRepository.JoinNode.Properties.changeDate, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, changeDate.getText()));
				}
			}
		});
		EditingUtils.setID(changeDate, ActivityViewsRepository.JoinNode.Properties.changeDate);
		EditingUtils.setEEFtype(changeDate, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ActivityViewsRepository.JoinNode.Properties.changeDate, ActivityViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createChangeDescriptionText(FormToolkit widgetFactory, Composite parent) {
		...
		changeDescription.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							JoinNodePropertiesEditionPartForm.this,
							ActivityViewsRepository.JoinNode.Properties.changeDescription,
		...
		changeDescription.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(JoinNodePropertiesEditionPartForm.this, ActivityViewsRepository.JoinNode.Properties.changeDescription, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, changeDescription.getText()));
				}
			}
		});
		EditingUtils.setID(changeDescription, ActivityViewsRepository.JoinNode.Properties.changeDescription);
		EditingUtils.setEEFtype(changeDescription, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ActivityViewsRepository.JoinNode.Properties.changeDescription, ActivityViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createVersionText(FormToolkit widgetFactory, Composite parent) {
		...
		version.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							JoinNodePropertiesEditionPartForm.this,
							ActivityViewsRepository.JoinNode.Properties.version,
		...
		version.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(JoinNodePropertiesEditionPartForm.this, ActivityViewsRepository.JoinNode.Properties.version, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, version.getText()));
				}
			}
		});
		EditingUtils.setID(version, ActivityViewsRepository.JoinNode.Properties.version);
		EditingUtils.setEEFtype(version, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ActivityViewsRepository.JoinNode.Properties.version, ActivityViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							JoinNodePropertiesEditionPartForm.this,
							ActivityViewsRepository.JoinNode.Properties.name,
		...
		name.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(JoinNodePropertiesEditionPartForm.this, ActivityViewsRepository.JoinNode.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
				}
			}
		});
		EditingUtils.setID(name, ActivityViewsRepository.JoinNode.Properties.name);
		EditingUtils.setEEFtype(name, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ActivityViewsRepository.JoinNode.Properties.name, ActivityViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createHasMultipleOccurrencesCheckbox(FormToolkit widgetFactory, Composite parent) {
		hasMultipleOccurrences = widgetFactory.createButton(parent, getDescription(ActivityViewsRepository.JoinNode.Properties.hasMultipleOccurrences, ActivityMessages.JoinNodePropertiesEditionPart_HasMultipleOccurrencesLabel), SWT.CHECK);
		hasMultipleOccurrences.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(JoinNodePropertiesEditionPartForm.this, ActivityViewsRepository.JoinNode.Properties.hasMultipleOccurrences, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new Boolean(hasMultipleOccurrences.getSelection())));
			}
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ActivityViewsRepository.JoinNode.Properties.hasMultipleOccurrences, ActivityViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createIsOptionalCheckbox(FormToolkit widgetFactory, Composite parent) {
		isOptional = widgetFactory.createButton(parent, getDescription(ActivityViewsRepository.JoinNode.Properties.isOptional, ActivityMessages.JoinNodePropertiesEditionPart_IsOptionalLabel), SWT.CHECK);
		isOptional.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(JoinNodePropertiesEditionPartForm.this, ActivityViewsRepository.JoinNode.Properties.isOptional, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new Boolean(isOptional.getSelection())));
			}
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ActivityViewsRepository.JoinNode.Properties.isOptional, ActivityViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createIsPlannedCheckbox(FormToolkit widgetFactory, Composite parent) {
		isPlanned = widgetFactory.createButton(parent, getDescription(ActivityViewsRepository.JoinNode.Properties.isPlanned, ActivityMessages.JoinNodePropertiesEditionPart_IsPlannedLabel), SWT.CHECK);
		isPlanned.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(JoinNodePropertiesEditionPartForm.this, ActivityViewsRepository.JoinNode.Properties.isPlanned, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new Boolean(isPlanned.getSelection())));
			}
		...
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(ActivityViewsRepository.JoinNode.Properties.isPlanned, ActivityViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createIncomingEdgeReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.incomingEdge = new ReferencesTable(getDescription(ActivityViewsRepository.JoinNode.Properties.incomingEdge, ActivityMessages.JoinNodePropertiesEditionPart_IncomingEdgeLabel), new ReferencesTableListener	() {
		...
		this.incomingEdge.setHelpText(propertiesEditionComponent.getHelpContent(ActivityViewsRepository.JoinNode.Properties.incomingEdge, ActivityViewsRepository.FORM_KIND));
		this.incomingEdge.createControls(parent, widgetFactory);
		this.incomingEdge.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(JoinNodePropertiesEditionPartForm.this, ActivityViewsRepository.JoinNode.Properties.incomingEdge, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addIncomingEdge() {
		...
		"incomingEdge", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(JoinNodePropertiesEditionPartForm.this, ActivityViewsRepository.JoinNode.Properties.incomingEdge,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveIncomingEdge(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(JoinNodePropertiesEditionPartForm.this, ActivityViewsRepository.JoinNode.Properties.incomingEdge, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		incomingEdge.refresh();
	}
	...
	protected void removeFromIncomingEdge(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(JoinNodePropertiesEditionPartForm.this, ActivityViewsRepository.JoinNode.Properties.incomingEdge, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		incomingEdge.refresh();
	}
	...
	protected Composite createOutgoingEdgeReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.outgoingEdge = new ReferencesTable(getDescription(ActivityViewsRepository.JoinNode.Properties.outgoingEdge, ActivityMessages.JoinNodePropertiesEditionPart_OutgoingEdgeLabel), new ReferencesTableListener	() {
		...
		this.outgoingEdge.setHelpText(propertiesEditionComponent.getHelpContent(ActivityViewsRepository.JoinNode.Properties.outgoingEdge, ActivityViewsRepository.FORM_KIND));
		this.outgoingEdge.createControls(parent, widgetFactory);
		this.outgoingEdge.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(JoinNodePropertiesEditionPartForm.this, ActivityViewsRepository.JoinNode.Properties.outgoingEdge, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addOutgoingEdge() {
		...
		"outgoingEdge", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(JoinNodePropertiesEditionPartForm.this, ActivityViewsRepository.JoinNode.Properties.outgoingEdge,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveOutgoingEdge(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(JoinNodePropertiesEditionPartForm.this, ActivityViewsRepository.JoinNode.Properties.outgoingEdge, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		outgoingEdge.refresh();
	}
	...
	protected void removeFromOutgoingEdge(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(JoinNodePropertiesEditionPartForm.this, ActivityViewsRepository.JoinNode.Properties.outgoingEdge, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		outgoingEdge.refresh();
	}
