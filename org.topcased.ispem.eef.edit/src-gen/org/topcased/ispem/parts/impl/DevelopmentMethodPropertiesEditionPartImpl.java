 ...
 * 
 */
public class DevelopmentMethodPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, DevelopmentMethodPropertiesEditionPart {
	 ...
	 * 
	 */
	public DevelopmentMethodPropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
		...
		composer = new PartComposer(developmentMethodStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == IspemViewsRepository.DevelopmentMethod.Properties.defines) {
					return createDefinesFlatComboViewer(parent);
				}
				return parent;
			}
		};
	...
	protected Composite createPropertiesGroup(Composite parent) {
		...
		propertiesGroup.setText(IspemMessages.DevelopmentMethodPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createKindFlatComboViewer(Composite parent) {
		...
		kind = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(IspemViewsRepository.DevelopmentMethod.Properties.kind, IspemViewsRepository.SWT_KIND));
		kind.setLabelProvider(new AdapterFactoryLabelProvider(adapterFactory));

		kind.addSelectionChangedListener(new ISelectionChangedListener() {

			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DevelopmentMethodPropertiesEditionPartImpl.this, IspemViewsRepository.DevelopmentMethod.Properties.kind, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getKind()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(IspemViewsRepository.DevelopmentMethod.Properties.kind, IspemViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createPresentationNameText(Composite parent) {
		...
		presentationName.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DevelopmentMethodPropertiesEditionPartImpl.this, IspemViewsRepository.DevelopmentMethod.Properties.presentationName, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, presentationName.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(IspemViewsRepository.DevelopmentMethod.Properties.presentationName, IspemViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createBriefDescriptionText(Composite parent) {
		...
		briefDescription.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DevelopmentMethodPropertiesEditionPartImpl.this, IspemViewsRepository.DevelopmentMethod.Properties.briefDescription, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, briefDescription.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(IspemViewsRepository.DevelopmentMethod.Properties.briefDescription, IspemViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createMainDescriptionText(Composite parent) {
		...
		mainDescription.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DevelopmentMethodPropertiesEditionPartImpl.this, IspemViewsRepository.DevelopmentMethod.Properties.mainDescription, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, mainDescription.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(IspemViewsRepository.DevelopmentMethod.Properties.mainDescription, IspemViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createPurposeText(Composite parent) {
		...
		purpose.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DevelopmentMethodPropertiesEditionPartImpl.this, IspemViewsRepository.DevelopmentMethod.Properties.purpose, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, purpose.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(IspemViewsRepository.DevelopmentMethod.Properties.purpose, IspemViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createGuidanceAdvancedReferencesTable(Composite parent) {
		String label = getDescription(IspemViewsRepository.DevelopmentMethod.Properties.guidance, IspemMessages.DevelopmentMethodPropertiesEditionPart_GuidanceLabel);		 
		...
		this.guidance.setHelpText(propertiesEditionComponent.getHelpContent(IspemViewsRepository.DevelopmentMethod.Properties.guidance, IspemViewsRepository.SWT_KIND));
		this.guidance.createControls(parent);
		this.guidance.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DevelopmentMethodPropertiesEditionPartImpl.this, IspemViewsRepository.DevelopmentMethod.Properties.guidance, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		"guidance", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DevelopmentMethodPropertiesEditionPartImpl.this, IspemViewsRepository.DevelopmentMethod.Properties.guidance,
	...
	protected void moveGuidance(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DevelopmentMethodPropertiesEditionPartImpl.this, IspemViewsRepository.DevelopmentMethod.Properties.guidance, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		guidance.refresh();
	}
	...
	protected void removeFromGuidance(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DevelopmentMethodPropertiesEditionPartImpl.this, IspemViewsRepository.DevelopmentMethod.Properties.guidance, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		guidance.refresh();
	}
	...
	protected Composite createMetricAdvancedReferencesTable(Composite parent) {
		String label = getDescription(IspemViewsRepository.DevelopmentMethod.Properties.metric, IspemMessages.DevelopmentMethodPropertiesEditionPart_MetricLabel);		 
		...
		this.metric.setHelpText(propertiesEditionComponent.getHelpContent(IspemViewsRepository.DevelopmentMethod.Properties.metric, IspemViewsRepository.SWT_KIND));
		this.metric.createControls(parent);
		this.metric.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DevelopmentMethodPropertiesEditionPartImpl.this, IspemViewsRepository.DevelopmentMethod.Properties.metric, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addMetric() {
		...
		"metric", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DevelopmentMethodPropertiesEditionPartImpl.this, IspemViewsRepository.DevelopmentMethod.Properties.metric,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
				metric.refresh();
			}
	...
	protected void moveMetric(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DevelopmentMethodPropertiesEditionPartImpl.this, IspemViewsRepository.DevelopmentMethod.Properties.metric, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		metric.refresh();
	}
	...
	protected void removeFromMetric(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DevelopmentMethodPropertiesEditionPartImpl.this, IspemViewsRepository.DevelopmentMethod.Properties.metric, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		metric.refresh();
	}
	...
	protected Composite createCategoryAdvancedReferencesTable(Composite parent) {
		String label = getDescription(IspemViewsRepository.DevelopmentMethod.Properties.category, IspemMessages.DevelopmentMethodPropertiesEditionPart_CategoryLabel);		 
		...
		this.category.setHelpText(propertiesEditionComponent.getHelpContent(IspemViewsRepository.DevelopmentMethod.Properties.category, IspemViewsRepository.SWT_KIND));
		this.category.createControls(parent);
		this.category.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DevelopmentMethodPropertiesEditionPartImpl.this, IspemViewsRepository.DevelopmentMethod.Properties.category, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addCategory() {
		...
		"category", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DevelopmentMethodPropertiesEditionPartImpl.this, IspemViewsRepository.DevelopmentMethod.Properties.category,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
				category.refresh();
			}
	...
	protected void moveCategory(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DevelopmentMethodPropertiesEditionPartImpl.this, IspemViewsRepository.DevelopmentMethod.Properties.category, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		category.refresh();
	}
	...
	protected void removeFromCategory(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DevelopmentMethodPropertiesEditionPartImpl.this, IspemViewsRepository.DevelopmentMethod.Properties.category, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		category.refresh();
	}
	...
	protected Composite createCopyrightText(Composite parent) {
		...
		copyright.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DevelopmentMethodPropertiesEditionPartImpl.this, IspemViewsRepository.DevelopmentMethod.Properties.copyright, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, copyright.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(IspemViewsRepository.DevelopmentMethod.Properties.copyright, IspemViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createAuthorMultiValuedEditor(Composite parent) {
		...
		editAuthor.setText(getDescription(IspemViewsRepository.DevelopmentMethod.Properties.author, IspemMessages.DevelopmentMethodPropertiesEditionPart_AuthorLabel));
		...
		editAuthor.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				if (dialog.open() == Window.OK) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DevelopmentMethodPropertiesEditionPartImpl.this, IspemViewsRepository.DevelopmentMethod.Properties.author, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new BasicEList(authorList)));
					setHasChanged(true);
				}
			}
		});
	...
	protected Composite createChangeDateText(Composite parent) {
		...
		changeDate.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DevelopmentMethodPropertiesEditionPartImpl.this, IspemViewsRepository.DevelopmentMethod.Properties.changeDate, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, changeDate.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(IspemViewsRepository.DevelopmentMethod.Properties.changeDate, IspemViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createChangeDescriptionText(Composite parent) {
		...
		changeDescription.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DevelopmentMethodPropertiesEditionPartImpl.this, IspemViewsRepository.DevelopmentMethod.Properties.changeDescription, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, changeDescription.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(IspemViewsRepository.DevelopmentMethod.Properties.changeDescription, IspemViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createVersionText(Composite parent) {
		...
		version.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DevelopmentMethodPropertiesEditionPartImpl.this, IspemViewsRepository.DevelopmentMethod.Properties.version, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, version.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(IspemViewsRepository.DevelopmentMethod.Properties.version, IspemViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createUriText(Composite parent) {
		...
		uri.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DevelopmentMethodPropertiesEditionPartImpl.this, IspemViewsRepository.DevelopmentMethod.Properties.uri, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, uri.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(IspemViewsRepository.DevelopmentMethod.Properties.uri, IspemViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createNameText(Composite parent) {
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DevelopmentMethodPropertiesEditionPartImpl.this, IspemViewsRepository.DevelopmentMethod.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(IspemViewsRepository.DevelopmentMethod.Properties.name, IspemViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createVariabilityTypeEMFComboViewer(Composite parent) {
		...
		variabilityType.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DevelopmentMethodPropertiesEditionPartImpl.this, IspemViewsRepository.DevelopmentMethod.Properties.variabilityType, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getVariabilityType()));
			}

		});
		variabilityType.setID(IspemViewsRepository.DevelopmentMethod.Properties.variabilityType);
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(IspemViewsRepository.DevelopmentMethod.Properties.variabilityType, IspemViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createVariabilityBasedOnElementFlatComboViewer(Composite parent) {
		...
		variabilityBasedOnElement = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(IspemViewsRepository.DevelopmentMethod.Properties.variabilityBasedOnElement, IspemViewsRepository.SWT_KIND));
		...
		variabilityBasedOnElement.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DevelopmentMethodPropertiesEditionPartImpl.this, IspemViewsRepository.DevelopmentMethod.Properties.variabilityBasedOnElement, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getVariabilityBasedOnElement()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(IspemViewsRepository.DevelopmentMethod.Properties.variabilityBasedOnElement, IspemViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createMethodContentKindFlatComboViewer(Composite parent) {
		...
		methodContentKind = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(IspemViewsRepository.DevelopmentMethod.Properties.methodContentKind, IspemViewsRepository.SWT_KIND));
		...
		methodContentKind.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DevelopmentMethodPropertiesEditionPartImpl.this, IspemViewsRepository.DevelopmentMethod.Properties.methodContentKind, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getMethodContentKind()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(IspemViewsRepository.DevelopmentMethod.Properties.methodContentKind, IspemViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createSubCategoryAdvancedReferencesTable(Composite parent) {
		String label = getDescription(IspemViewsRepository.DevelopmentMethod.Properties.subCategory, IspemMessages.DevelopmentMethodPropertiesEditionPart_SubCategoryLabel);		 
		...
		this.subCategory.setHelpText(propertiesEditionComponent.getHelpContent(IspemViewsRepository.DevelopmentMethod.Properties.subCategory, IspemViewsRepository.SWT_KIND));
		this.subCategory.createControls(parent);
		this.subCategory.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DevelopmentMethodPropertiesEditionPartImpl.this, IspemViewsRepository.DevelopmentMethod.Properties.subCategory, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addSubCategory() {
		...
		"subCategory", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DevelopmentMethodPropertiesEditionPartImpl.this, IspemViewsRepository.DevelopmentMethod.Properties.subCategory,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
				subCategory.refresh();
			}
	...
	protected void moveSubCategory(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DevelopmentMethodPropertiesEditionPartImpl.this, IspemViewsRepository.DevelopmentMethod.Properties.subCategory, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		subCategory.refresh();
	}
	...
	protected void removeFromSubCategory(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DevelopmentMethodPropertiesEditionPartImpl.this, IspemViewsRepository.DevelopmentMethod.Properties.subCategory, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		subCategory.refresh();
	}
	...
	protected Composite createCategorizedElementAdvancedReferencesTable(Composite parent) {
		String label = getDescription(IspemViewsRepository.DevelopmentMethod.Properties.categorizedElement, IspemMessages.DevelopmentMethodPropertiesEditionPart_CategorizedElementLabel);		 
		...
		this.categorizedElement.setHelpText(propertiesEditionComponent.getHelpContent(IspemViewsRepository.DevelopmentMethod.Properties.categorizedElement, IspemViewsRepository.SWT_KIND));
		this.categorizedElement.createControls(parent);
		this.categorizedElement.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DevelopmentMethodPropertiesEditionPartImpl.this, IspemViewsRepository.DevelopmentMethod.Properties.categorizedElement, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addCategorizedElement() {
		...
		"categorizedElement", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DevelopmentMethodPropertiesEditionPartImpl.this, IspemViewsRepository.DevelopmentMethod.Properties.categorizedElement,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveCategorizedElement(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DevelopmentMethodPropertiesEditionPartImpl.this, IspemViewsRepository.DevelopmentMethod.Properties.categorizedElement, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		categorizedElement.refresh();
	}
	...
	protected void removeFromCategorizedElement(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DevelopmentMethodPropertiesEditionPartImpl.this, IspemViewsRepository.DevelopmentMethod.Properties.categorizedElement, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		categorizedElement.refresh();
	}
	...
	protected Composite createSupportsAdvancedReferencesTable(Composite parent) {
		String label = getDescription(IspemViewsRepository.DevelopmentMethod.Properties.supports, IspemMessages.DevelopmentMethodPropertiesEditionPart_SupportsLabel);		 
		...
		this.supports.setHelpText(propertiesEditionComponent.getHelpContent(IspemViewsRepository.DevelopmentMethod.Properties.supports, IspemViewsRepository.SWT_KIND));
		this.supports.createControls(parent);
		this.supports.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DevelopmentMethodPropertiesEditionPartImpl.this, IspemViewsRepository.DevelopmentMethod.Properties.supports, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addSupports() {
		...
		"supports", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DevelopmentMethodPropertiesEditionPartImpl.this, IspemViewsRepository.DevelopmentMethod.Properties.supports,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
				supports.refresh();
			}
	...
	protected void moveSupports(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DevelopmentMethodPropertiesEditionPartImpl.this, IspemViewsRepository.DevelopmentMethod.Properties.supports, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		supports.refresh();
	}
	...
	protected void removeFromSupports(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DevelopmentMethodPropertiesEditionPartImpl.this, IspemViewsRepository.DevelopmentMethod.Properties.supports, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		supports.refresh();
	}
	 ...
	 * 
	 */
	protected Composite createDefinesFlatComboViewer(Composite parent) {
		...
		defines = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(IspemViewsRepository.DevelopmentMethod.Properties.defines, IspemViewsRepository.SWT_KIND));
		...
		defines.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DevelopmentMethodPropertiesEditionPartImpl.this, IspemViewsRepository.DevelopmentMethod.Properties.defines, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getDefines()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(IspemViewsRepository.DevelopmentMethod.Properties.defines, IspemViewsRepository.SWT_KIND), null); //$NON-NLS-1$
