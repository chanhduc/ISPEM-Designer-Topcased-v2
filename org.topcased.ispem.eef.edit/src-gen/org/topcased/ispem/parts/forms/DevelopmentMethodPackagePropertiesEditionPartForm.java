 ...
 * 
 */
public class DevelopmentMethodPackagePropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, DevelopmentMethodPackagePropertiesEditionPart {
	 ...
	 */
	public DevelopmentMethodPackagePropertiesEditionPartForm() { super(); }
	 ...
	 * 
	 */
	public DevelopmentMethodPackagePropertiesEditionPartForm(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(FormToolkit widgetFactory, final Composite parent) {
		...
		propertiesSection.setText(IspemMessages.DevelopmentMethodPackagePropertiesEditionPart_PropertiesGroupLabel);
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							DevelopmentMethodPackagePropertiesEditionPartForm.this,
							IspemViewsRepository.DevelopmentMethodPackage.Properties.name,
		...
		name.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				if (e.character == SWT.CR) {
					if (propertiesEditionComponent != null)
						propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DevelopmentMethodPackagePropertiesEditionPartForm.this, IspemViewsRepository.DevelopmentMethodPackage.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
				}
			}
		});
		EditingUtils.setID(name, IspemViewsRepository.DevelopmentMethodPackage.Properties.name);
		EditingUtils.setEEFtype(name, "eef::Text"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(IspemViewsRepository.DevelopmentMethodPackage.Properties.name, IspemViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createOwnedMethodContentMemberTableComposition(FormToolkit widgetFactory, Composite parent) {
		this.ownedMethodContentMember = new ReferencesTable(getDescription(IspemViewsRepository.DevelopmentMethodPackage.Properties.ownedMethodContentMember, IspemMessages.DevelopmentMethodPackagePropertiesEditionPart_OwnedMethodContentMemberLabel), new ReferencesTableListener() {
			public void handleAdd() {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DevelopmentMethodPackagePropertiesEditionPartForm.this, IspemViewsRepository.DevelopmentMethodPackage.Properties.ownedMethodContentMember, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				ownedMethodContentMember.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DevelopmentMethodPackagePropertiesEditionPartForm.this, IspemViewsRepository.DevelopmentMethodPackage.Properties.ownedMethodContentMember, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				ownedMethodContentMember.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DevelopmentMethodPackagePropertiesEditionPartForm.this, IspemViewsRepository.DevelopmentMethodPackage.Properties.ownedMethodContentMember, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				ownedMethodContentMember.refresh();
			}
			public void handleRemove(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DevelopmentMethodPackagePropertiesEditionPartForm.this, IspemViewsRepository.DevelopmentMethodPackage.Properties.ownedMethodContentMember, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				ownedMethodContentMember.refresh();
			}
		...
		this.ownedMethodContentMember.setHelpText(propertiesEditionComponent.getHelpContent(IspemViewsRepository.DevelopmentMethodPackage.Properties.ownedMethodContentMember, IspemViewsRepository.FORM_KIND));
		...
		this.ownedMethodContentMember.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DevelopmentMethodPackagePropertiesEditionPartForm.this, IspemViewsRepository.DevelopmentMethodPackage.Properties.ownedMethodContentMember, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected Composite createReusedPackageReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.reusedPackage = new ReferencesTable(getDescription(IspemViewsRepository.DevelopmentMethodPackage.Properties.reusedPackage, IspemMessages.DevelopmentMethodPackagePropertiesEditionPart_ReusedPackageLabel), new ReferencesTableListener	() {
		...
		this.reusedPackage.setHelpText(propertiesEditionComponent.getHelpContent(IspemViewsRepository.DevelopmentMethodPackage.Properties.reusedPackage, IspemViewsRepository.FORM_KIND));
		this.reusedPackage.createControls(parent, widgetFactory);
		this.reusedPackage.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DevelopmentMethodPackagePropertiesEditionPartForm.this, IspemViewsRepository.DevelopmentMethodPackage.Properties.reusedPackage, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		"reusedPackage", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DevelopmentMethodPackagePropertiesEditionPartForm.this, IspemViewsRepository.DevelopmentMethodPackage.Properties.reusedPackage,
	...
	protected void moveReusedPackage(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DevelopmentMethodPackagePropertiesEditionPartForm.this, IspemViewsRepository.DevelopmentMethodPackage.Properties.reusedPackage, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		reusedPackage.refresh();
	}
	...
	protected void removeFromReusedPackage(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(DevelopmentMethodPackagePropertiesEditionPartForm.this, IspemViewsRepository.DevelopmentMethodPackage.Properties.reusedPackage, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		reusedPackage.refresh();
	}
