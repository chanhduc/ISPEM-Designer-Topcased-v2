...
public class ProcessPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, ProcessPropertiesEditionPart {
	...
	protected Composite createPreConditionMultiValuedEditor(Composite parent) {
		...
		editPreCondition.setText(getDescription(UmaViewsRepository.Process.Properties.preCondition, UmaMessages.ProcessPropertiesEditionPart_PreConditionLabel));
	...
	protected Composite createPostConditionMultiValuedEditor(Composite parent) {
		...
		editPostCondition.setText(getDescription(UmaViewsRepository.Process.Properties.postCondition, UmaMessages.ProcessPropertiesEditionPart_PostConditionLabel));
	...
	protected Composite createGuidanceAdvancedReferencesTable(Composite parent) {
		String label = getDescription(UmaViewsRepository.Process.Properties.guidance, UmaMessages.ProcessPropertiesEditionPart_GuidanceLabel);		 
	...
	protected Composite createMetricAdvancedReferencesTable(Composite parent) {
		String label = getDescription(UmaViewsRepository.Process.Properties.metric, UmaMessages.ProcessPropertiesEditionPart_MetricLabel);		 
	...
	protected Composite createCategoryAdvancedReferencesTable(Composite parent) {
		String label = getDescription(UmaViewsRepository.Process.Properties.category, UmaMessages.ProcessPropertiesEditionPart_CategoryLabel);		 
	...
	protected Composite createAuthorMultiValuedEditor(Composite parent) {
		...
		editAuthor.setText(getDescription(UmaViewsRepository.Process.Properties.author, UmaMessages.ProcessPropertiesEditionPart_AuthorLabel));
	...
	protected Composite createHasMultipleOccurrencesCheckbox(Composite parent) {
		...
		hasMultipleOccurrences.setText(getDescription(UmaViewsRepository.Process.Properties.hasMultipleOccurrences, UmaMessages.ProcessPropertiesEditionPart_HasMultipleOccurrencesLabel));
	...
	protected Composite createIsOptionalCheckbox(Composite parent) {
		...
		isOptional.setText(getDescription(UmaViewsRepository.Process.Properties.isOptional, UmaMessages.ProcessPropertiesEditionPart_IsOptionalLabel));
	...
	protected Composite createIsPlannedCheckbox(Composite parent) {
		...
		isPlanned.setText(getDescription(UmaViewsRepository.Process.Properties.isPlanned, UmaMessages.ProcessPropertiesEditionPart_IsPlannedLabel));
	...
	protected Composite createIsRepeatableCheckbox(Composite parent) {
		...
		isRepeatable.setText(getDescription(UmaViewsRepository.Process.Properties.isRepeatable, UmaMessages.ProcessPropertiesEditionPart_IsRepeatableLabel));
	...
	protected Composite createIsOngoingCheckbox(Composite parent) {
		...
		isOngoing.setText(getDescription(UmaViewsRepository.Process.Properties.isOngoing, UmaMessages.ProcessPropertiesEditionPart_IsOngoingLabel));
	...
	protected Composite createIsEventDrivenCheckbox(Composite parent) {
		...
		isEventDriven.setText(getDescription(UmaViewsRepository.Process.Properties.isEventDriven, UmaMessages.ProcessPropertiesEditionPart_IsEventDrivenLabel));
	...
	protected Composite createLinkToPredecessorAdvancedReferencesTable(Composite parent) {
		String label = getDescription(UmaViewsRepository.Process.Properties.linkToPredecessor, UmaMessages.ProcessPropertiesEditionPart_LinkToPredecessorLabel);		 
	...
	protected Composite createLinkToSuccessorAdvancedReferencesTable(Composite parent) {
		String label = getDescription(UmaViewsRepository.Process.Properties.linkToSuccessor, UmaMessages.ProcessPropertiesEditionPart_LinkToSuccessorLabel);		 
	...
	protected Composite createSuppressedBreakdownElementAdvancedReferencesTable(Composite parent) {
		String label = getDescription(UmaViewsRepository.Process.Properties.suppressedBreakdownElement, UmaMessages.ProcessPropertiesEditionPart_SuppressedBreakdownElementLabel);		 
	...
	protected Composite createValidContextAdvancedReferencesTable(Composite parent) {
		String label = getDescription(UmaViewsRepository.Process.Properties.validContext, UmaMessages.ProcessPropertiesEditionPart_ValidContextLabel);		 
	...
	protected Composite createIsEnactableCheckbox(Composite parent) {
		...
		isEnactable.setText(getDescription(UmaViewsRepository.Process.Properties.isEnactable, UmaMessages.ProcessPropertiesEditionPart_IsEnactableLabel));
		isEnactable.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartImpl.this, UmaViewsRepository.Process.Properties.isEnactable, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new Boolean(isEnactable.getSelection())));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(UmaViewsRepository.Process.Properties.isEnactable, UmaViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createUsageNoteMultiValuedEditor(Composite parent) {
		...
		editUsageNote.setText(getDescription(UmaViewsRepository.Process.Properties.usageNote, UmaMessages.ProcessPropertiesEditionPart_UsageNoteLabel));
