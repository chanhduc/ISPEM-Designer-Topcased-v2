 ...
 * 
 */
public class WorkProductUsePropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, WorkProductUsePropertiesEditionPart {
	 ...
	 */
	public WorkProductUsePropertiesEditionPartForm() { super(); }
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							WorkProductUsePropertiesEditionPartForm.this,
							SpemViewsRepository.WorkProductUse.Properties.presentationName,
		...
		briefDescription.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							WorkProductUsePropertiesEditionPartForm.this,
							SpemViewsRepository.WorkProductUse.Properties.briefDescription,
		...
		mainDescription.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							WorkProductUsePropertiesEditionPartForm.this,
							SpemViewsRepository.WorkProductUse.Properties.mainDescription,
		...
		purpose.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							WorkProductUsePropertiesEditionPartForm.this,
							SpemViewsRepository.WorkProductUse.Properties.purpose,
	...
	protected Composite createGuidanceReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.guidance = new ReferencesTable(getDescription(SpemViewsRepository.WorkProductUse.Properties.guidance, SpemMessages.WorkProductUsePropertiesEditionPart_GuidanceLabel), new ReferencesTableListener	() {
	...
	protected Composite createMetricReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.metric = new ReferencesTable(getDescription(SpemViewsRepository.WorkProductUse.Properties.metric, SpemMessages.WorkProductUsePropertiesEditionPart_MetricLabel), new ReferencesTableListener	() {
	...
	protected Composite createCategoryReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.category = new ReferencesTable(getDescription(SpemViewsRepository.WorkProductUse.Properties.category, SpemMessages.WorkProductUsePropertiesEditionPart_CategoryLabel), new ReferencesTableListener	() {
		...
		copyright.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							WorkProductUsePropertiesEditionPartForm.this,
							SpemViewsRepository.WorkProductUse.Properties.copyright,
	...
	protected Composite createAuthorMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
		...
		editAuthor = widgetFactory.createButton(parent, getDescription(SpemViewsRepository.WorkProductUse.Properties.author, SpemMessages.WorkProductUsePropertiesEditionPart_AuthorLabel), SWT.NONE);
		...
		changeDate.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							WorkProductUsePropertiesEditionPartForm.this,
							SpemViewsRepository.WorkProductUse.Properties.changeDate,
		...
		changeDescription.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							WorkProductUsePropertiesEditionPartForm.this,
							SpemViewsRepository.WorkProductUse.Properties.changeDescription,
		...
		version.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							WorkProductUsePropertiesEditionPartForm.this,
							SpemViewsRepository.WorkProductUse.Properties.version,
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							WorkProductUsePropertiesEditionPartForm.this,
							SpemViewsRepository.WorkProductUse.Properties.name,
	...
	protected Composite createHasMultipleOccurrencesCheckbox(FormToolkit widgetFactory, Composite parent) {
		hasMultipleOccurrences = widgetFactory.createButton(parent, getDescription(SpemViewsRepository.WorkProductUse.Properties.hasMultipleOccurrences, SpemMessages.WorkProductUsePropertiesEditionPart_HasMultipleOccurrencesLabel), SWT.CHECK);
	...
	protected Composite createIsOptionalCheckbox(FormToolkit widgetFactory, Composite parent) {
		isOptional = widgetFactory.createButton(parent, getDescription(SpemViewsRepository.WorkProductUse.Properties.isOptional, SpemMessages.WorkProductUsePropertiesEditionPart_IsOptionalLabel), SWT.CHECK);
	...
	protected Composite createIsPlannedCheckbox(FormToolkit widgetFactory, Composite parent) {
		isPlanned = widgetFactory.createButton(parent, getDescription(SpemViewsRepository.WorkProductUse.Properties.isPlanned, SpemMessages.WorkProductUsePropertiesEditionPart_IsPlannedLabel), SWT.CHECK);
	...
	protected Composite createIsSynchronizedWithSourceCheckbox(FormToolkit widgetFactory, Composite parent) {
		isSynchronizedWithSource = widgetFactory.createButton(parent, getDescription(SpemViewsRepository.WorkProductUse.Properties.isSynchronizedWithSource, SpemMessages.WorkProductUsePropertiesEditionPart_IsSynchronizedWithSourceLabel), SWT.CHECK);
