 ...
 * 
 */
public interface DevelopmentMethodWithLanguageContentPackagePropertiesEditionPart {
	...
	/**
	 * @return the relatedLanguage
	 * 
	 */
	public EObject getRelatedLanguage();

	/**
	 * Init the relatedLanguage
	 * @param settings the combo setting
	 */
	public void initRelatedLanguage(EObjectFlatComboSettings settings);

	/**
	 * Defines a new relatedLanguage
	 * @param newValue the new relatedLanguage to set
	 * 
	 */
	...
	/**
	 * Adds the given filter to the relatedLanguage edition editor.
	 * 
	 * @param filter
	 *            a viewer filter
	 * @see org.eclipse.jface.viewers.StructuredViewer#addFilter(ViewerFilter)
