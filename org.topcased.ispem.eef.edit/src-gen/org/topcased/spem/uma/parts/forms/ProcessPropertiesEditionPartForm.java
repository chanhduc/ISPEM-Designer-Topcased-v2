...
public class ProcessPropertiesEditionPartForm extends SectionPropertiesEditingPart implements IFormPropertiesEditionPart, ProcessPropertiesEditionPart {
	...
	public void createControls(final FormToolkit widgetFactory, Composite view) {
		...
		propertiesStep.addStep(UmaViewsRepository.Process.Properties.isEnactable);
		...
		composer = new PartComposer(processStep) {
			...
			public Composite addToPart(Composite parent, Object key) {
				...
				if (key == UmaViewsRepository.Process.Properties.isEnactable) {
	...
	protected Composite createPreConditionMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
		...
		editPreCondition = widgetFactory.createButton(parent, getDescription(UmaViewsRepository.Process.Properties.preCondition, UmaMessages.ProcessPropertiesEditionPart_PreConditionLabel), SWT.NONE);
	...
	protected Composite createPostConditionMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
		...
		editPostCondition = widgetFactory.createButton(parent, getDescription(UmaViewsRepository.Process.Properties.postCondition, UmaMessages.ProcessPropertiesEditionPart_PostConditionLabel), SWT.NONE);
	...
	protected Composite createKindFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		createDescription(parent, UmaViewsRepository.Process.Properties.kind, UmaMessages.ProcessPropertiesEditionPart_KindLabel);
	...
	protected Composite createPresentationNameText(FormToolkit widgetFactory, Composite parent) {
		createDescription(parent, UmaViewsRepository.Process.Properties.presentationName, UmaMessages.ProcessPropertiesEditionPart_PresentationNameLabel);
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							...
							UmaViewsRepository.Process.Properties.presentationName,
	...
	protected Composite createBriefDescriptionText(FormToolkit widgetFactory, Composite parent) {
		createDescription(parent, UmaViewsRepository.Process.Properties.briefDescription, UmaMessages.ProcessPropertiesEditionPart_BriefDescriptionLabel);
		...
		briefDescription.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							ProcessPropertiesEditionPartForm.this,
							UmaViewsRepository.Process.Properties.briefDescription,
	...
	protected Composite createMainDescriptionText(FormToolkit widgetFactory, Composite parent) {
		createDescription(parent, UmaViewsRepository.Process.Properties.mainDescription, UmaMessages.ProcessPropertiesEditionPart_MainDescriptionLabel);
		...
		mainDescription.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							ProcessPropertiesEditionPartForm.this,
							UmaViewsRepository.Process.Properties.mainDescription,
	...
	protected Composite createPurposeText(FormToolkit widgetFactory, Composite parent) {
		createDescription(parent, UmaViewsRepository.Process.Properties.purpose, UmaMessages.ProcessPropertiesEditionPart_PurposeLabel);
		...
		purpose.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							ProcessPropertiesEditionPartForm.this,
							UmaViewsRepository.Process.Properties.purpose,
	...
	protected Composite createGuidanceReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.guidance = new ReferencesTable(getDescription(UmaViewsRepository.Process.Properties.guidance, UmaMessages.ProcessPropertiesEditionPart_GuidanceLabel), new ReferencesTableListener	() {
	...
	protected Composite createMetricReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.metric = new ReferencesTable(getDescription(UmaViewsRepository.Process.Properties.metric, UmaMessages.ProcessPropertiesEditionPart_MetricLabel), new ReferencesTableListener	() {
	...
	protected Composite createCategoryReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.category = new ReferencesTable(getDescription(UmaViewsRepository.Process.Properties.category, UmaMessages.ProcessPropertiesEditionPart_CategoryLabel), new ReferencesTableListener	() {
	...
	protected Composite createCopyrightText(FormToolkit widgetFactory, Composite parent) {
		createDescription(parent, UmaViewsRepository.Process.Properties.copyright, UmaMessages.ProcessPropertiesEditionPart_CopyrightLabel);
		...
		copyright.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							ProcessPropertiesEditionPartForm.this,
							UmaViewsRepository.Process.Properties.copyright,
	...
	protected Composite createAuthorMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
		...
		editAuthor = widgetFactory.createButton(parent, getDescription(UmaViewsRepository.Process.Properties.author, UmaMessages.ProcessPropertiesEditionPart_AuthorLabel), SWT.NONE);
	...
	protected Composite createChangeDateText(FormToolkit widgetFactory, Composite parent) {
		createDescription(parent, UmaViewsRepository.Process.Properties.changeDate, UmaMessages.ProcessPropertiesEditionPart_ChangeDateLabel);
		...
		changeDate.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							ProcessPropertiesEditionPartForm.this,
							UmaViewsRepository.Process.Properties.changeDate,
	...
	protected Composite createChangeDescriptionText(FormToolkit widgetFactory, Composite parent) {
		createDescription(parent, UmaViewsRepository.Process.Properties.changeDescription, UmaMessages.ProcessPropertiesEditionPart_ChangeDescriptionLabel);
		...
		changeDescription.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							ProcessPropertiesEditionPartForm.this,
							UmaViewsRepository.Process.Properties.changeDescription,
	...
	protected Composite createVersionText(FormToolkit widgetFactory, Composite parent) {
		createDescription(parent, UmaViewsRepository.Process.Properties.version, UmaMessages.ProcessPropertiesEditionPart_VersionLabel);
		...
		version.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							ProcessPropertiesEditionPartForm.this,
							UmaViewsRepository.Process.Properties.version,
	...
	protected Composite createNameText(FormToolkit widgetFactory, Composite parent) {
		createDescription(parent, UmaViewsRepository.Process.Properties.name, UmaMessages.ProcessPropertiesEditionPart_NameLabel);
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							ProcessPropertiesEditionPartForm.this,
							UmaViewsRepository.Process.Properties.name,
	...
	protected Composite createHasMultipleOccurrencesCheckbox(FormToolkit widgetFactory, Composite parent) {
		hasMultipleOccurrences = widgetFactory.createButton(parent, getDescription(UmaViewsRepository.Process.Properties.hasMultipleOccurrences, UmaMessages.ProcessPropertiesEditionPart_HasMultipleOccurrencesLabel), SWT.CHECK);
	...
	protected Composite createIsOptionalCheckbox(FormToolkit widgetFactory, Composite parent) {
		isOptional = widgetFactory.createButton(parent, getDescription(UmaViewsRepository.Process.Properties.isOptional, UmaMessages.ProcessPropertiesEditionPart_IsOptionalLabel), SWT.CHECK);
	...
	protected Composite createIsPlannedCheckbox(FormToolkit widgetFactory, Composite parent) {
		isPlanned = widgetFactory.createButton(parent, getDescription(UmaViewsRepository.Process.Properties.isPlanned, UmaMessages.ProcessPropertiesEditionPart_IsPlannedLabel), SWT.CHECK);
	...
	protected Composite createIsRepeatableCheckbox(FormToolkit widgetFactory, Composite parent) {
		isRepeatable = widgetFactory.createButton(parent, getDescription(UmaViewsRepository.Process.Properties.isRepeatable, UmaMessages.ProcessPropertiesEditionPart_IsRepeatableLabel), SWT.CHECK);
	...
	protected Composite createIsOngoingCheckbox(FormToolkit widgetFactory, Composite parent) {
		isOngoing = widgetFactory.createButton(parent, getDescription(UmaViewsRepository.Process.Properties.isOngoing, UmaMessages.ProcessPropertiesEditionPart_IsOngoingLabel), SWT.CHECK);
	...
	protected Composite createIsEventDrivenCheckbox(FormToolkit widgetFactory, Composite parent) {
		isEventDriven = widgetFactory.createButton(parent, getDescription(UmaViewsRepository.Process.Properties.isEventDriven, UmaMessages.ProcessPropertiesEditionPart_IsEventDrivenLabel), SWT.CHECK);
	...
	protected Composite createLinkToPredecessorReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.linkToPredecessor = new ReferencesTable(getDescription(UmaViewsRepository.Process.Properties.linkToPredecessor, UmaMessages.ProcessPropertiesEditionPart_LinkToPredecessorLabel), new ReferencesTableListener	() {
	...
	protected Composite createLinkToSuccessorReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.linkToSuccessor = new ReferencesTable(getDescription(UmaViewsRepository.Process.Properties.linkToSuccessor, UmaMessages.ProcessPropertiesEditionPart_LinkToSuccessorLabel), new ReferencesTableListener	() {
	...
	protected Composite createVariabilityTypeEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
		createDescription(parent, UmaViewsRepository.Process.Properties.variabilityType, UmaMessages.ProcessPropertiesEditionPart_VariabilityTypeLabel);
	...
	protected Composite createVariabilityBasedOnElementFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		createDescription(parent, UmaViewsRepository.Process.Properties.variabilityBasedOnElement, UmaMessages.ProcessPropertiesEditionPart_VariabilityBasedOnElementLabel);
	...
	protected Composite createUseKindEMFComboViewer(FormToolkit widgetFactory, Composite parent) {
		createDescription(parent, UmaViewsRepository.Process.Properties.useKind, UmaMessages.ProcessPropertiesEditionPart_UseKindLabel);
	...
	protected Composite createUsedActivityFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		createDescription(parent, UmaViewsRepository.Process.Properties.usedActivity, UmaMessages.ProcessPropertiesEditionPart_UsedActivityLabel);
	...
	protected Composite createSuppressedBreakdownElementReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.suppressedBreakdownElement = new ReferencesTable(getDescription(UmaViewsRepository.Process.Properties.suppressedBreakdownElement, UmaMessages.ProcessPropertiesEditionPart_SuppressedBreakdownElementLabel), new ReferencesTableListener	() {
	...
	protected Composite createDefaultContextFlatComboViewer(Composite parent, FormToolkit widgetFactory) {
		createDescription(parent, UmaViewsRepository.Process.Properties.defaultContext, UmaMessages.ProcessPropertiesEditionPart_DefaultContextLabel);
	...
	protected Composite createValidContextReferencesTable(FormToolkit widgetFactory, Composite parent) {
		this.validContext = new ReferencesTable(getDescription(UmaViewsRepository.Process.Properties.validContext, UmaMessages.ProcessPropertiesEditionPart_ValidContextLabel), new ReferencesTableListener	() {
	...
	protected Composite createIsEnactableCheckbox(FormToolkit widgetFactory, Composite parent) {
		isEnactable = widgetFactory.createButton(parent, getDescription(UmaViewsRepository.Process.Properties.isEnactable, UmaMessages.ProcessPropertiesEditionPart_IsEnactableLabel), SWT.CHECK);
		isEnactable.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ProcessPropertiesEditionPartForm.this, UmaViewsRepository.Process.Properties.isEnactable, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new Boolean(isEnactable.getSelection())));
			}
		...
		EditingUtils.setID(isEnactable, UmaViewsRepository.Process.Properties.isEnactable);
		EditingUtils.setEEFtype(isEnactable, "eef::Checkbox"); //$NON-NLS-1$
		FormUtils.createHelpButton(widgetFactory, parent, propertiesEditionComponent.getHelpContent(UmaViewsRepository.Process.Properties.isEnactable, UmaViewsRepository.FORM_KIND), null); //$NON-NLS-1$
	...
	protected Composite createScopeText(FormToolkit widgetFactory, Composite parent) {
		createDescription(parent, UmaViewsRepository.Process.Properties.scope, UmaMessages.ProcessPropertiesEditionPart_ScopeLabel);
		...
		scope.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(
							ProcessPropertiesEditionPartForm.this,
							UmaViewsRepository.Process.Properties.scope,
	...
	protected Composite createUsageNoteMultiValuedEditor(FormToolkit widgetFactory, Composite parent) {
		...
		editUsageNote = widgetFactory.createButton(parent, getDescription(UmaViewsRepository.Process.Properties.usageNote, UmaMessages.ProcessPropertiesEditionPart_UsageNoteLabel), SWT.NONE);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#getPreCondition()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#setPreCondition(EList newValue)
	 * 
	 */
	public void setPreCondition(EList newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(UmaViewsRepository.Process.Properties.preCondition);
		if (eefElementEditorReadOnlyState && preCondition.isEnabled()) {
			preCondition.setEnabled(false);
			preCondition.setToolTipText(UmaMessages.Process_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#getPostCondition()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#setPostCondition(EList newValue)
	 * 
	 */
	public void setPostCondition(EList newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(UmaViewsRepository.Process.Properties.postCondition);
		if (eefElementEditorReadOnlyState && postCondition.isEnabled()) {
			postCondition.setEnabled(false);
			postCondition.setToolTipText(UmaMessages.Process_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#getKind()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#initKind(EObjectFlatComboSettings)
	 */
	public void initKind(EObjectFlatComboSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(UmaViewsRepository.Process.Properties.kind);
		if (eefElementEditorReadOnlyState && kind.isEnabled()) {
			kind.setEnabled(false);
			kind.setToolTipText(UmaMessages.Process_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#setKind(EObject newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#setKindButtonMode(ButtonsModeEnum newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#addFilterKind(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#addBusinessFilterKind(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#getPresentationName()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#setPresentationName(String newValue)
	 * 
	 */
	public void setPresentationName(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(UmaViewsRepository.Process.Properties.presentationName);
		if (eefElementEditorReadOnlyState && presentationName.isEnabled()) {
			presentationName.setEnabled(false);
			presentationName.setToolTipText(UmaMessages.Process_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#getBriefDescription()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#setBriefDescription(String newValue)
	 * 
	 */
	public void setBriefDescription(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(UmaViewsRepository.Process.Properties.briefDescription);
		if (eefElementEditorReadOnlyState && briefDescription.isEnabled()) {
			briefDescription.setEnabled(false);
			briefDescription.setToolTipText(UmaMessages.Process_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#getMainDescription()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#setMainDescription(String newValue)
	 * 
	 */
	public void setMainDescription(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(UmaViewsRepository.Process.Properties.mainDescription);
		if (eefElementEditorReadOnlyState && mainDescription.isEnabled()) {
			mainDescription.setEnabled(false);
			mainDescription.setToolTipText(UmaMessages.Process_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#getPurpose()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#setPurpose(String newValue)
	 * 
	 */
	public void setPurpose(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(UmaViewsRepository.Process.Properties.purpose);
		if (eefElementEditorReadOnlyState && purpose.isEnabled()) {
			purpose.setEnabled(false);
			purpose.setToolTipText(UmaMessages.Process_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#initGuidance(org.eclipse.emf.eef.runtime.ui.widgets.referencestable.ReferencesTableSettings)
	 */
	public void initGuidance(ReferencesTableSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(UmaViewsRepository.Process.Properties.guidance);
		if (eefElementEditorReadOnlyState && guidance.getTable().isEnabled()) {
			guidance.setEnabled(false);
			guidance.setToolTipText(UmaMessages.Process_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#updateGuidance()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#addFilterGuidance(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#addBusinessFilterGuidance(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#isContainedInGuidanceTable(EObject element)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#initMetric(org.eclipse.emf.eef.runtime.ui.widgets.referencestable.ReferencesTableSettings)
	 */
	public void initMetric(ReferencesTableSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(UmaViewsRepository.Process.Properties.metric);
		if (eefElementEditorReadOnlyState && metric.getTable().isEnabled()) {
			metric.setEnabled(false);
			metric.setToolTipText(UmaMessages.Process_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#updateMetric()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#addFilterMetric(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#addBusinessFilterMetric(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#isContainedInMetricTable(EObject element)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#initCategory(org.eclipse.emf.eef.runtime.ui.widgets.referencestable.ReferencesTableSettings)
	 */
	public void initCategory(ReferencesTableSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(UmaViewsRepository.Process.Properties.category);
		if (eefElementEditorReadOnlyState && category.getTable().isEnabled()) {
			category.setEnabled(false);
			category.setToolTipText(UmaMessages.Process_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#updateCategory()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#addFilterCategory(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#addBusinessFilterCategory(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#isContainedInCategoryTable(EObject element)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#getCopyright()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#setCopyright(String newValue)
	 * 
	 */
	public void setCopyright(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(UmaViewsRepository.Process.Properties.copyright);
		if (eefElementEditorReadOnlyState && copyright.isEnabled()) {
			copyright.setEnabled(false);
			copyright.setToolTipText(UmaMessages.Process_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#getAuthor()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#setAuthor(EList newValue)
	 * 
	 */
	public void setAuthor(EList newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(UmaViewsRepository.Process.Properties.author);
		if (eefElementEditorReadOnlyState && author.isEnabled()) {
			author.setEnabled(false);
			author.setToolTipText(UmaMessages.Process_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#getChangeDate()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#setChangeDate(String newValue)
	 * 
	 */
	public void setChangeDate(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(UmaViewsRepository.Process.Properties.changeDate);
		if (eefElementEditorReadOnlyState && changeDate.isEnabled()) {
			changeDate.setEnabled(false);
			changeDate.setToolTipText(UmaMessages.Process_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#getChangeDescription()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#setChangeDescription(String newValue)
	 * 
	 */
	public void setChangeDescription(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(UmaViewsRepository.Process.Properties.changeDescription);
		if (eefElementEditorReadOnlyState && changeDescription.isEnabled()) {
			changeDescription.setEnabled(false);
			changeDescription.setToolTipText(UmaMessages.Process_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#getVersion()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#setVersion(String newValue)
	 * 
	 */
	public void setVersion(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(UmaViewsRepository.Process.Properties.version);
		if (eefElementEditorReadOnlyState && version.isEnabled()) {
			version.setEnabled(false);
			version.setToolTipText(UmaMessages.Process_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#getName()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#setName(String newValue)
	 * 
	 */
	public void setName(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(UmaViewsRepository.Process.Properties.name);
		if (eefElementEditorReadOnlyState && name.isEnabled()) {
			name.setEnabled(false);
			name.setToolTipText(UmaMessages.Process_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#getHasMultipleOccurrences()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#setHasMultipleOccurrences(Boolean newValue)
	 * 
	 */
	public void setHasMultipleOccurrences(Boolean newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(UmaViewsRepository.Process.Properties.hasMultipleOccurrences);
		if (eefElementEditorReadOnlyState && hasMultipleOccurrences.isEnabled()) {
			hasMultipleOccurrences.setEnabled(false);
			hasMultipleOccurrences.setToolTipText(UmaMessages.Process_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#getIsOptional()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#setIsOptional(Boolean newValue)
	 * 
	 */
	public void setIsOptional(Boolean newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(UmaViewsRepository.Process.Properties.isOptional);
		if (eefElementEditorReadOnlyState && isOptional.isEnabled()) {
			isOptional.setEnabled(false);
			isOptional.setToolTipText(UmaMessages.Process_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#getIsPlanned()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#setIsPlanned(Boolean newValue)
	 * 
	 */
	public void setIsPlanned(Boolean newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(UmaViewsRepository.Process.Properties.isPlanned);
		if (eefElementEditorReadOnlyState && isPlanned.isEnabled()) {
			isPlanned.setEnabled(false);
			isPlanned.setToolTipText(UmaMessages.Process_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#getIsRepeatable()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#setIsRepeatable(Boolean newValue)
	 * 
	 */
	public void setIsRepeatable(Boolean newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(UmaViewsRepository.Process.Properties.isRepeatable);
		if (eefElementEditorReadOnlyState && isRepeatable.isEnabled()) {
			isRepeatable.setEnabled(false);
			isRepeatable.setToolTipText(UmaMessages.Process_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#getIsOngoing()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#setIsOngoing(Boolean newValue)
	 * 
	 */
	public void setIsOngoing(Boolean newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(UmaViewsRepository.Process.Properties.isOngoing);
		if (eefElementEditorReadOnlyState && isOngoing.isEnabled()) {
			isOngoing.setEnabled(false);
			isOngoing.setToolTipText(UmaMessages.Process_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#getIsEventDriven()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#setIsEventDriven(Boolean newValue)
	 * 
	 */
	public void setIsEventDriven(Boolean newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(UmaViewsRepository.Process.Properties.isEventDriven);
		if (eefElementEditorReadOnlyState && isEventDriven.isEnabled()) {
			isEventDriven.setEnabled(false);
			isEventDriven.setToolTipText(UmaMessages.Process_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#initLinkToPredecessor(org.eclipse.emf.eef.runtime.ui.widgets.referencestable.ReferencesTableSettings)
	 */
	public void initLinkToPredecessor(ReferencesTableSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(UmaViewsRepository.Process.Properties.linkToPredecessor);
		if (eefElementEditorReadOnlyState && linkToPredecessor.getTable().isEnabled()) {
			linkToPredecessor.setEnabled(false);
			linkToPredecessor.setToolTipText(UmaMessages.Process_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#updateLinkToPredecessor()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#addFilterLinkToPredecessor(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#addBusinessFilterLinkToPredecessor(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#isContainedInLinkToPredecessorTable(EObject element)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#initLinkToSuccessor(org.eclipse.emf.eef.runtime.ui.widgets.referencestable.ReferencesTableSettings)
	 */
	public void initLinkToSuccessor(ReferencesTableSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(UmaViewsRepository.Process.Properties.linkToSuccessor);
		if (eefElementEditorReadOnlyState && linkToSuccessor.getTable().isEnabled()) {
			linkToSuccessor.setEnabled(false);
			linkToSuccessor.setToolTipText(UmaMessages.Process_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#updateLinkToSuccessor()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#addFilterLinkToSuccessor(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#addBusinessFilterLinkToSuccessor(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#isContainedInLinkToSuccessorTable(EObject element)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#getVariabilityType()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#initVariabilityType(Object input, Enumerator current)
	 */
	public void initVariabilityType(Object input, Enumerator current) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(UmaViewsRepository.Process.Properties.variabilityType);
		if (eefElementEditorReadOnlyState && variabilityType.isEnabled()) {
			variabilityType.setEnabled(false);
			variabilityType.setToolTipText(UmaMessages.Process_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#setVariabilityType(Enumerator newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#getVariabilityBasedOnElement()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#initVariabilityBasedOnElement(EObjectFlatComboSettings)
	 */
	public void initVariabilityBasedOnElement(EObjectFlatComboSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(UmaViewsRepository.Process.Properties.variabilityBasedOnElement);
		if (eefElementEditorReadOnlyState && variabilityBasedOnElement.isEnabled()) {
			variabilityBasedOnElement.setEnabled(false);
			variabilityBasedOnElement.setToolTipText(UmaMessages.Process_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#setVariabilityBasedOnElement(EObject newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#setVariabilityBasedOnElementButtonMode(ButtonsModeEnum newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#addFilterVariabilityBasedOnElement(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#addBusinessFilterVariabilityBasedOnElement(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#getUseKind()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#initUseKind(Object input, Enumerator current)
	 */
	public void initUseKind(Object input, Enumerator current) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(UmaViewsRepository.Process.Properties.useKind);
		if (eefElementEditorReadOnlyState && useKind.isEnabled()) {
			useKind.setEnabled(false);
			useKind.setToolTipText(UmaMessages.Process_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#setUseKind(Enumerator newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#getUsedActivity()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#initUsedActivity(EObjectFlatComboSettings)
	 */
	public void initUsedActivity(EObjectFlatComboSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(UmaViewsRepository.Process.Properties.usedActivity);
		if (eefElementEditorReadOnlyState && usedActivity.isEnabled()) {
			usedActivity.setEnabled(false);
			usedActivity.setToolTipText(UmaMessages.Process_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#setUsedActivity(EObject newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#setUsedActivityButtonMode(ButtonsModeEnum newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#addFilterUsedActivity(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#addBusinessFilterUsedActivity(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#initSuppressedBreakdownElement(org.eclipse.emf.eef.runtime.ui.widgets.referencestable.ReferencesTableSettings)
	 */
	public void initSuppressedBreakdownElement(ReferencesTableSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(UmaViewsRepository.Process.Properties.suppressedBreakdownElement);
		if (eefElementEditorReadOnlyState && suppressedBreakdownElement.getTable().isEnabled()) {
			...
			suppressedBreakdownElement.setToolTipText(UmaMessages.Process_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#updateSuppressedBreakdownElement()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#addFilterSuppressedBreakdownElement(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#addBusinessFilterSuppressedBreakdownElement(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#isContainedInSuppressedBreakdownElementTable(EObject element)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#getDefaultContext()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#initDefaultContext(EObjectFlatComboSettings)
	 */
	public void initDefaultContext(EObjectFlatComboSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(UmaViewsRepository.Process.Properties.defaultContext);
		if (eefElementEditorReadOnlyState && defaultContext.isEnabled()) {
			defaultContext.setEnabled(false);
			defaultContext.setToolTipText(UmaMessages.Process_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#setDefaultContext(EObject newValue)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#setDefaultContextButtonMode(ButtonsModeEnum newValue)
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#addFilterDefaultContext(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#addBusinessFilterDefaultContext(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#initValidContext(org.eclipse.emf.eef.runtime.ui.widgets.referencestable.ReferencesTableSettings)
	 */
	public void initValidContext(ReferencesTableSettings settings) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(UmaViewsRepository.Process.Properties.validContext);
		if (eefElementEditorReadOnlyState && validContext.getTable().isEnabled()) {
			validContext.setEnabled(false);
			validContext.setToolTipText(UmaMessages.Process_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#updateValidContext()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#addFilterValidContext(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#addBusinessFilterValidContext(ViewerFilter filter)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#isContainedInValidContextTable(EObject element)
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#getIsEnactable()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#setIsEnactable(Boolean newValue)
	 * 
	 */
	public void setIsEnactable(Boolean newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(UmaViewsRepository.Process.Properties.isEnactable);
		if (eefElementEditorReadOnlyState && isEnactable.isEnabled()) {
			isEnactable.setEnabled(false);
			isEnactable.setToolTipText(UmaMessages.Process_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#getScope()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#setScope(String newValue)
	 * 
	 */
	public void setScope(String newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(UmaViewsRepository.Process.Properties.scope);
		if (eefElementEditorReadOnlyState && scope.isEnabled()) {
			scope.setEnabled(false);
			scope.setToolTipText(UmaMessages.Process_ReadOnly);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#getUsageNote()
	 * 
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.topcased.spem.uma.parts.ProcessPropertiesEditionPart#setUsageNote(EList newValue)
	 * 
	 */
	public void setUsageNote(EList newValue) {
		...
		boolean eefElementEditorReadOnlyState = isReadOnly(UmaViewsRepository.Process.Properties.usageNote);
		if (eefElementEditorReadOnlyState && usageNote.isEnabled()) {
			usageNote.setEnabled(false);
			usageNote.setToolTipText(UmaMessages.Process_ReadOnly);
