 ...
 * 
 */
public class ISPEMMethodLibraryPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, ISPEMMethodLibraryPropertiesEditionPart {
	 ...
	 * 
	 */
	public ISPEMMethodLibraryPropertiesEditionPartImpl(IPropertiesEditionComponent editionComponent) {
	...
	protected Composite createPropertiesGroup(Composite parent) {
		...
		propertiesGroup.setText(IspemMessages.ISPEMMethodLibraryPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createNameText(Composite parent) {
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ISPEMMethodLibraryPropertiesEditionPartImpl.this, IspemViewsRepository.ISPEMMethodLibrary.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(IspemViewsRepository.ISPEMMethodLibrary.Properties.name, IspemViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createOwnedMethodPluginAdvancedTableComposition(Composite parent) {
		this.ownedMethodPlugin = new ReferencesTable(getDescription(IspemViewsRepository.ISPEMMethodLibrary.Properties.ownedMethodPlugin, IspemMessages.ISPEMMethodLibraryPropertiesEditionPart_OwnedMethodPluginLabel), new ReferencesTableListener() {
			public void handleAdd() { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ISPEMMethodLibraryPropertiesEditionPartImpl.this, IspemViewsRepository.ISPEMMethodLibrary.Properties.ownedMethodPlugin, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				ownedMethodPlugin.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ISPEMMethodLibraryPropertiesEditionPartImpl.this, IspemViewsRepository.ISPEMMethodLibrary.Properties.ownedMethodPlugin, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				ownedMethodPlugin.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ISPEMMethodLibraryPropertiesEditionPartImpl.this, IspemViewsRepository.ISPEMMethodLibrary.Properties.ownedMethodPlugin, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				ownedMethodPlugin.refresh();
			}
			public void handleRemove(EObject element) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ISPEMMethodLibraryPropertiesEditionPartImpl.this, IspemViewsRepository.ISPEMMethodLibrary.Properties.ownedMethodPlugin, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				ownedMethodPlugin.refresh();
			}
		...
		this.ownedMethodPlugin.setHelpText(propertiesEditionComponent.getHelpContent(IspemViewsRepository.ISPEMMethodLibrary.Properties.ownedMethodPlugin, IspemViewsRepository.SWT_KIND));
		...
		this.ownedMethodPlugin.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ISPEMMethodLibraryPropertiesEditionPartImpl.this, IspemViewsRepository.ISPEMMethodLibrary.Properties.ownedMethodPlugin, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		// Start of user code for createOwnedMethodPluginAdvancedTableComposition
	...
	protected Composite createPredefinedConfigurationAdvancedTableComposition(Composite parent) {
		this.predefinedConfiguration = new ReferencesTable(getDescription(IspemViewsRepository.ISPEMMethodLibrary.Properties.predefinedConfiguration, IspemMessages.ISPEMMethodLibraryPropertiesEditionPart_PredefinedConfigurationLabel), new ReferencesTableListener() {
			public void handleAdd() { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ISPEMMethodLibraryPropertiesEditionPartImpl.this, IspemViewsRepository.ISPEMMethodLibrary.Properties.predefinedConfiguration, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, null));
				predefinedConfiguration.refresh();
			}
			public void handleEdit(EObject element) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ISPEMMethodLibraryPropertiesEditionPartImpl.this, IspemViewsRepository.ISPEMMethodLibrary.Properties.predefinedConfiguration, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.EDIT, null, element));
				predefinedConfiguration.refresh();
			}
			public void handleMove(EObject element, int oldIndex, int newIndex) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ISPEMMethodLibraryPropertiesEditionPartImpl.this, IspemViewsRepository.ISPEMMethodLibrary.Properties.predefinedConfiguration, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
				predefinedConfiguration.refresh();
			}
			public void handleRemove(EObject element) { 
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ISPEMMethodLibraryPropertiesEditionPartImpl.this, IspemViewsRepository.ISPEMMethodLibrary.Properties.predefinedConfiguration, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
				predefinedConfiguration.refresh();
			}
			public void navigateTo(EObject element) { }
		});
		...
		this.predefinedConfiguration.setHelpText(propertiesEditionComponent.getHelpContent(IspemViewsRepository.ISPEMMethodLibrary.Properties.predefinedConfiguration, IspemViewsRepository.SWT_KIND));
		this.predefinedConfiguration.createControls(parent);
		this.predefinedConfiguration.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ISPEMMethodLibraryPropertiesEditionPartImpl.this, IspemViewsRepository.ISPEMMethodLibrary.Properties.predefinedConfiguration, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		// Start of user code for createPredefinedConfigurationAdvancedTableComposition
