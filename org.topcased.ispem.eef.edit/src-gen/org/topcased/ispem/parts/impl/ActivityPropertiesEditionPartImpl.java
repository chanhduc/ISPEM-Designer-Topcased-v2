...
public class ActivityPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, ActivityPropertiesEditionPart {
	...
	protected Composite createPropertiesGroup(Composite parent) {
		...
		propertiesGroup.setText(IspemMessages.ActivityPropertiesEditionPart_PropertiesGroupLabel);
	...
	protected Composite createPreConditionMultiValuedEditor(Composite parent) {
		...
		editPreCondition.setText(getDescription(IspemViewsRepository.Activity.Properties.preCondition, IspemMessages.ActivityPropertiesEditionPart_PreConditionLabel));
		...
		editPreCondition.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				if (dialog.open() == Window.OK) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActivityPropertiesEditionPartImpl.this, IspemViewsRepository.Activity.Properties.preCondition, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new BasicEList(preConditionList)));
					setHasChanged(true);
				}
			}
		});
	...
	protected Composite createPostConditionMultiValuedEditor(Composite parent) {
		...
		editPostCondition.setText(getDescription(IspemViewsRepository.Activity.Properties.postCondition, IspemMessages.ActivityPropertiesEditionPart_PostConditionLabel));
		...
		editPostCondition.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				if (dialog.open() == Window.OK) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActivityPropertiesEditionPartImpl.this, IspemViewsRepository.Activity.Properties.postCondition, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new BasicEList(postConditionList)));
					setHasChanged(true);
				}
			}
		});
	...
	protected Composite createKindFlatComboViewer(Composite parent) {
		...
		kind = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(IspemViewsRepository.Activity.Properties.kind, IspemViewsRepository.SWT_KIND));
		kind.setLabelProvider(new AdapterFactoryLabelProvider(adapterFactory));

		kind.addSelectionChangedListener(new ISelectionChangedListener() {

			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActivityPropertiesEditionPartImpl.this, IspemViewsRepository.Activity.Properties.kind, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getKind()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(IspemViewsRepository.Activity.Properties.kind, IspemViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createPresentationNameText(Composite parent) {
		...
		presentationName.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActivityPropertiesEditionPartImpl.this, IspemViewsRepository.Activity.Properties.presentationName, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, presentationName.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(IspemViewsRepository.Activity.Properties.presentationName, IspemViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createBriefDescriptionText(Composite parent) {
		...
		briefDescription.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActivityPropertiesEditionPartImpl.this, IspemViewsRepository.Activity.Properties.briefDescription, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, briefDescription.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(IspemViewsRepository.Activity.Properties.briefDescription, IspemViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createMainDescriptionText(Composite parent) {
		...
		mainDescription.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActivityPropertiesEditionPartImpl.this, IspemViewsRepository.Activity.Properties.mainDescription, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, mainDescription.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(IspemViewsRepository.Activity.Properties.mainDescription, IspemViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createPurposeText(Composite parent) {
		...
		purpose.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActivityPropertiesEditionPartImpl.this, IspemViewsRepository.Activity.Properties.purpose, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, purpose.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(IspemViewsRepository.Activity.Properties.purpose, IspemViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createGuidanceAdvancedReferencesTable(Composite parent) {
		String label = getDescription(IspemViewsRepository.Activity.Properties.guidance, IspemMessages.ActivityPropertiesEditionPart_GuidanceLabel);		 
		...
		this.guidance.setHelpText(propertiesEditionComponent.getHelpContent(IspemViewsRepository.Activity.Properties.guidance, IspemViewsRepository.SWT_KIND));
		this.guidance.createControls(parent);
		this.guidance.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActivityPropertiesEditionPartImpl.this, IspemViewsRepository.Activity.Properties.guidance, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
		...
		"guidance", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActivityPropertiesEditionPartImpl.this, IspemViewsRepository.Activity.Properties.guidance,
	...
	protected void moveGuidance(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActivityPropertiesEditionPartImpl.this, IspemViewsRepository.Activity.Properties.guidance, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		guidance.refresh();
	}
	...
	protected void removeFromGuidance(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActivityPropertiesEditionPartImpl.this, IspemViewsRepository.Activity.Properties.guidance, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		guidance.refresh();
	}
	...
	protected Composite createMetricAdvancedReferencesTable(Composite parent) {
		String label = getDescription(IspemViewsRepository.Activity.Properties.metric, IspemMessages.ActivityPropertiesEditionPart_MetricLabel);		 
		...
		this.metric.setHelpText(propertiesEditionComponent.getHelpContent(IspemViewsRepository.Activity.Properties.metric, IspemViewsRepository.SWT_KIND));
		this.metric.createControls(parent);
		this.metric.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActivityPropertiesEditionPartImpl.this, IspemViewsRepository.Activity.Properties.metric, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addMetric() {
		...
		"metric", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActivityPropertiesEditionPartImpl.this, IspemViewsRepository.Activity.Properties.metric,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
				metric.refresh();
			}
	...
	protected void moveMetric(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActivityPropertiesEditionPartImpl.this, IspemViewsRepository.Activity.Properties.metric, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		metric.refresh();
	}
	...
	protected void removeFromMetric(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActivityPropertiesEditionPartImpl.this, IspemViewsRepository.Activity.Properties.metric, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		metric.refresh();
	}
	...
	protected Composite createCategoryAdvancedReferencesTable(Composite parent) {
		String label = getDescription(IspemViewsRepository.Activity.Properties.category, IspemMessages.ActivityPropertiesEditionPart_CategoryLabel);		 
		...
		this.category.setHelpText(propertiesEditionComponent.getHelpContent(IspemViewsRepository.Activity.Properties.category, IspemViewsRepository.SWT_KIND));
		this.category.createControls(parent);
		this.category.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActivityPropertiesEditionPartImpl.this, IspemViewsRepository.Activity.Properties.category, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addCategory() {
		...
		"category", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActivityPropertiesEditionPartImpl.this, IspemViewsRepository.Activity.Properties.category,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
				category.refresh();
			}
	...
	protected void moveCategory(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActivityPropertiesEditionPartImpl.this, IspemViewsRepository.Activity.Properties.category, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		category.refresh();
	}
	...
	protected void removeFromCategory(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActivityPropertiesEditionPartImpl.this, IspemViewsRepository.Activity.Properties.category, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		category.refresh();
	}
	...
	protected Composite createCopyrightText(Composite parent) {
		...
		copyright.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActivityPropertiesEditionPartImpl.this, IspemViewsRepository.Activity.Properties.copyright, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, copyright.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(IspemViewsRepository.Activity.Properties.copyright, IspemViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createAuthorMultiValuedEditor(Composite parent) {
		...
		editAuthor.setText(getDescription(IspemViewsRepository.Activity.Properties.author, IspemMessages.ActivityPropertiesEditionPart_AuthorLabel));
		...
		editAuthor.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				if (dialog.open() == Window.OK) {
					...
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActivityPropertiesEditionPartImpl.this, IspemViewsRepository.Activity.Properties.author, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new BasicEList(authorList)));
					setHasChanged(true);
				}
			}
		});
	...
	protected Composite createChangeDateText(Composite parent) {
		...
		changeDate.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActivityPropertiesEditionPartImpl.this, IspemViewsRepository.Activity.Properties.changeDate, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, changeDate.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(IspemViewsRepository.Activity.Properties.changeDate, IspemViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createChangeDescriptionText(Composite parent) {
		...
		changeDescription.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActivityPropertiesEditionPartImpl.this, IspemViewsRepository.Activity.Properties.changeDescription, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, changeDescription.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(IspemViewsRepository.Activity.Properties.changeDescription, IspemViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createVersionText(Composite parent) {
		...
		version.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActivityPropertiesEditionPartImpl.this, IspemViewsRepository.Activity.Properties.version, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, version.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(IspemViewsRepository.Activity.Properties.version, IspemViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createNameText(Composite parent) {
		...
		name.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActivityPropertiesEditionPartImpl.this, IspemViewsRepository.Activity.Properties.name, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, name.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(IspemViewsRepository.Activity.Properties.name, IspemViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createHasMultipleOccurrencesCheckbox(Composite parent) {
		...
		hasMultipleOccurrences.setText(getDescription(IspemViewsRepository.Activity.Properties.hasMultipleOccurrences, IspemMessages.ActivityPropertiesEditionPart_HasMultipleOccurrencesLabel));
		hasMultipleOccurrences.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActivityPropertiesEditionPartImpl.this, IspemViewsRepository.Activity.Properties.hasMultipleOccurrences, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new Boolean(hasMultipleOccurrences.getSelection())));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(IspemViewsRepository.Activity.Properties.hasMultipleOccurrences, IspemViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createIsOptionalCheckbox(Composite parent) {
		...
		isOptional.setText(getDescription(IspemViewsRepository.Activity.Properties.isOptional, IspemMessages.ActivityPropertiesEditionPart_IsOptionalLabel));
		isOptional.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActivityPropertiesEditionPartImpl.this, IspemViewsRepository.Activity.Properties.isOptional, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new Boolean(isOptional.getSelection())));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(IspemViewsRepository.Activity.Properties.isOptional, IspemViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createIsPlannedCheckbox(Composite parent) {
		...
		isPlanned.setText(getDescription(IspemViewsRepository.Activity.Properties.isPlanned, IspemMessages.ActivityPropertiesEditionPart_IsPlannedLabel));
		isPlanned.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActivityPropertiesEditionPartImpl.this, IspemViewsRepository.Activity.Properties.isPlanned, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new Boolean(isPlanned.getSelection())));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(IspemViewsRepository.Activity.Properties.isPlanned, IspemViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createIsRepeatableCheckbox(Composite parent) {
		...
		isRepeatable.setText(getDescription(IspemViewsRepository.Activity.Properties.isRepeatable, IspemMessages.ActivityPropertiesEditionPart_IsRepeatableLabel));
		isRepeatable.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActivityPropertiesEditionPartImpl.this, IspemViewsRepository.Activity.Properties.isRepeatable, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new Boolean(isRepeatable.getSelection())));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(IspemViewsRepository.Activity.Properties.isRepeatable, IspemViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createIsOngoingCheckbox(Composite parent) {
		...
		isOngoing.setText(getDescription(IspemViewsRepository.Activity.Properties.isOngoing, IspemMessages.ActivityPropertiesEditionPart_IsOngoingLabel));
		isOngoing.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActivityPropertiesEditionPartImpl.this, IspemViewsRepository.Activity.Properties.isOngoing, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new Boolean(isOngoing.getSelection())));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(IspemViewsRepository.Activity.Properties.isOngoing, IspemViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createIsEventDrivenCheckbox(Composite parent) {
		...
		isEventDriven.setText(getDescription(IspemViewsRepository.Activity.Properties.isEventDriven, IspemMessages.ActivityPropertiesEditionPart_IsEventDrivenLabel));
		isEventDriven.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActivityPropertiesEditionPartImpl.this, IspemViewsRepository.Activity.Properties.isEventDriven, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new Boolean(isEventDriven.getSelection())));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(IspemViewsRepository.Activity.Properties.isEventDriven, IspemViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createLinkToPredecessorAdvancedReferencesTable(Composite parent) {
		String label = getDescription(IspemViewsRepository.Activity.Properties.linkToPredecessor, IspemMessages.ActivityPropertiesEditionPart_LinkToPredecessorLabel);		 
		...
		this.linkToPredecessor.setHelpText(propertiesEditionComponent.getHelpContent(IspemViewsRepository.Activity.Properties.linkToPredecessor, IspemViewsRepository.SWT_KIND));
		this.linkToPredecessor.createControls(parent);
		this.linkToPredecessor.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActivityPropertiesEditionPartImpl.this, IspemViewsRepository.Activity.Properties.linkToPredecessor, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addLinkToPredecessor() {
		...
		"linkToPredecessor", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActivityPropertiesEditionPartImpl.this, IspemViewsRepository.Activity.Properties.linkToPredecessor,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveLinkToPredecessor(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActivityPropertiesEditionPartImpl.this, IspemViewsRepository.Activity.Properties.linkToPredecessor, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		linkToPredecessor.refresh();
	}
	...
	protected void removeFromLinkToPredecessor(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActivityPropertiesEditionPartImpl.this, IspemViewsRepository.Activity.Properties.linkToPredecessor, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		linkToPredecessor.refresh();
	}
	...
	protected Composite createLinkToSuccessorAdvancedReferencesTable(Composite parent) {
		String label = getDescription(IspemViewsRepository.Activity.Properties.linkToSuccessor, IspemMessages.ActivityPropertiesEditionPart_LinkToSuccessorLabel);		 
		...
		this.linkToSuccessor.setHelpText(propertiesEditionComponent.getHelpContent(IspemViewsRepository.Activity.Properties.linkToSuccessor, IspemViewsRepository.SWT_KIND));
		this.linkToSuccessor.createControls(parent);
		this.linkToSuccessor.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActivityPropertiesEditionPartImpl.this, IspemViewsRepository.Activity.Properties.linkToSuccessor, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addLinkToSuccessor() {
		...
		"linkToSuccessor", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActivityPropertiesEditionPartImpl.this, IspemViewsRepository.Activity.Properties.linkToSuccessor,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveLinkToSuccessor(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActivityPropertiesEditionPartImpl.this, IspemViewsRepository.Activity.Properties.linkToSuccessor, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		linkToSuccessor.refresh();
	}
	...
	protected void removeFromLinkToSuccessor(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActivityPropertiesEditionPartImpl.this, IspemViewsRepository.Activity.Properties.linkToSuccessor, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		linkToSuccessor.refresh();
	}
	...
	protected Composite createVariabilityTypeEMFComboViewer(Composite parent) {
		...
		variabilityType.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActivityPropertiesEditionPartImpl.this, IspemViewsRepository.Activity.Properties.variabilityType, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getVariabilityType()));
			}

		});
		variabilityType.setID(IspemViewsRepository.Activity.Properties.variabilityType);
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(IspemViewsRepository.Activity.Properties.variabilityType, IspemViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createVariabilityBasedOnElementFlatComboViewer(Composite parent) {
		...
		variabilityBasedOnElement = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(IspemViewsRepository.Activity.Properties.variabilityBasedOnElement, IspemViewsRepository.SWT_KIND));
		...
		variabilityBasedOnElement.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActivityPropertiesEditionPartImpl.this, IspemViewsRepository.Activity.Properties.variabilityBasedOnElement, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getVariabilityBasedOnElement()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(IspemViewsRepository.Activity.Properties.variabilityBasedOnElement, IspemViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createUseKindEMFComboViewer(Composite parent) {
		...
		useKind.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActivityPropertiesEditionPartImpl.this, IspemViewsRepository.Activity.Properties.useKind, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, getUseKind()));
			}

		});
		useKind.setID(IspemViewsRepository.Activity.Properties.useKind);
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(IspemViewsRepository.Activity.Properties.useKind, IspemViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createUsedActivityFlatComboViewer(Composite parent) {
		...
		usedActivity = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(IspemViewsRepository.Activity.Properties.usedActivity, IspemViewsRepository.SWT_KIND));
		...
		usedActivity.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActivityPropertiesEditionPartImpl.this, IspemViewsRepository.Activity.Properties.usedActivity, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getUsedActivity()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(IspemViewsRepository.Activity.Properties.usedActivity, IspemViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createSuppressedBreakdownElementAdvancedReferencesTable(Composite parent) {
		String label = getDescription(IspemViewsRepository.Activity.Properties.suppressedBreakdownElement, IspemMessages.ActivityPropertiesEditionPart_SuppressedBreakdownElementLabel);		 
		...
		this.suppressedBreakdownElement.setHelpText(propertiesEditionComponent.getHelpContent(IspemViewsRepository.Activity.Properties.suppressedBreakdownElement, IspemViewsRepository.SWT_KIND));
		...
		this.suppressedBreakdownElement.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActivityPropertiesEditionPartImpl.this, IspemViewsRepository.Activity.Properties.suppressedBreakdownElement, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addSuppressedBreakdownElement() {
		...
		"suppressedBreakdownElement", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActivityPropertiesEditionPartImpl.this, IspemViewsRepository.Activity.Properties.suppressedBreakdownElement,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveSuppressedBreakdownElement(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActivityPropertiesEditionPartImpl.this, IspemViewsRepository.Activity.Properties.suppressedBreakdownElement, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		suppressedBreakdownElement.refresh();
	}
	...
	protected void removeFromSuppressedBreakdownElement(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActivityPropertiesEditionPartImpl.this, IspemViewsRepository.Activity.Properties.suppressedBreakdownElement, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		suppressedBreakdownElement.refresh();
	}
	...
	protected Composite createDefaultContextFlatComboViewer(Composite parent) {
		...
		defaultContext = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(IspemViewsRepository.Activity.Properties.defaultContext, IspemViewsRepository.SWT_KIND));
		...
		defaultContext.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActivityPropertiesEditionPartImpl.this, IspemViewsRepository.Activity.Properties.defaultContext, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getDefaultContext()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(IspemViewsRepository.Activity.Properties.defaultContext, IspemViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createValidContextAdvancedReferencesTable(Composite parent) {
		String label = getDescription(IspemViewsRepository.Activity.Properties.validContext, IspemMessages.ActivityPropertiesEditionPart_ValidContextLabel);		 
		...
		this.validContext.setHelpText(propertiesEditionComponent.getHelpContent(IspemViewsRepository.Activity.Properties.validContext, IspemViewsRepository.SWT_KIND));
		this.validContext.createControls(parent);
		this.validContext.addSelectionListener(new SelectionAdapter() {
			
			public void widgetSelected(SelectionEvent e) {
				if (e.item != null && e.item.getData() instanceof EObject) {
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActivityPropertiesEditionPartImpl.this, IspemViewsRepository.Activity.Properties.validContext, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SELECTION_CHANGED, null, e.item.getData()));
				}
			}
	...
	protected void addValidContext() {
		...
		"validContext", propertiesEditionComponent.getEditingContext().getAdapterFactory(), current.eResource()) {
			...
			public void process(IStructuredSelection selection) {
				for (Iterator<?> iter = selection.iterator(); iter.hasNext();) {
					EObject elem = (EObject) iter.next();
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActivityPropertiesEditionPartImpl.this, IspemViewsRepository.Activity.Properties.validContext,
						PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.ADD, null, elem));
				}
	...
	protected void moveValidContext(EObject element, int oldIndex, int newIndex) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActivityPropertiesEditionPartImpl.this, IspemViewsRepository.Activity.Properties.validContext, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.MOVE, element, newIndex));
		validContext.refresh();
	}
	...
	protected void removeFromValidContext(EObject element) {
		propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActivityPropertiesEditionPartImpl.this, IspemViewsRepository.Activity.Properties.validContext, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.REMOVE, null, element));
		validContext.refresh();
	}
	...
	protected Composite createIsEnactableCheckbox(Composite parent) {
		...
		isEnactable.setText(getDescription(IspemViewsRepository.Activity.Properties.isEnactable, IspemMessages.ActivityPropertiesEditionPart_IsEnactableLabel));
		isEnactable.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActivityPropertiesEditionPartImpl.this, IspemViewsRepository.Activity.Properties.isEnactable, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, new Boolean(isEnactable.getSelection())));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(IspemViewsRepository.Activity.Properties.isEnactable, IspemViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createUriText(Composite parent) {
		...
		uri.addFocusListener(new FocusAdapter() {
			...
			public void focusLost(FocusEvent e) {
				if (propertiesEditionComponent != null)
					propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActivityPropertiesEditionPartImpl.this, IspemViewsRepository.Activity.Properties.uri, PropertiesEditionEvent.COMMIT, PropertiesEditionEvent.SET, null, uri.getText()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(IspemViewsRepository.Activity.Properties.uri, IspemViewsRepository.SWT_KIND), null); //$NON-NLS-1$
	...
	protected Composite createContextFlatComboViewer(Composite parent) {
		...
		context = new EObjectFlatComboViewer(parent, !propertiesEditionComponent.isRequired(IspemViewsRepository.Activity.Properties.context, IspemViewsRepository.SWT_KIND));
		...
		context.addSelectionChangedListener(new ISelectionChangedListener() {
			...
			public void selectionChanged(SelectionChangedEvent event) {
				propertiesEditionComponent.firePropertiesChanged(new PropertiesEditionEvent(ActivityPropertiesEditionPartImpl.this, IspemViewsRepository.Activity.Properties.context, PropertiesEditionEvent.CHANGE, PropertiesEditionEvent.SET, null, getContext()));
			}
		...
		SWTUtils.createHelpButton(parent, propertiesEditionComponent.getHelpContent(IspemViewsRepository.Activity.Properties.context, IspemViewsRepository.SWT_KIND), null); //$NON-NLS-1$
