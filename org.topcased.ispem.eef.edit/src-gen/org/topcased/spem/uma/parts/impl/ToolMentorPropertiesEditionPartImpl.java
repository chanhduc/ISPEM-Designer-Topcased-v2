...
public class ToolMentorPropertiesEditionPartImpl extends CompositePropertiesEditionPart implements ISWTPropertiesEditionPart, ToolMentorPropertiesEditionPart {
	...
	protected Composite createGuidanceAdvancedReferencesTable(Composite parent) {
		String label = getDescription(UmaViewsRepository.ToolMentor.Properties.guidance, UmaMessages.ToolMentorPropertiesEditionPart_GuidanceLabel);		 
	...
	protected Composite createMetricAdvancedReferencesTable(Composite parent) {
		String label = getDescription(UmaViewsRepository.ToolMentor.Properties.metric, UmaMessages.ToolMentorPropertiesEditionPart_MetricLabel);		 
	...
	protected Composite createCategoryAdvancedReferencesTable(Composite parent) {
		String label = getDescription(UmaViewsRepository.ToolMentor.Properties.category, UmaMessages.ToolMentorPropertiesEditionPart_CategoryLabel);		 
	...
	protected Composite createAuthorMultiValuedEditor(Composite parent) {
		...
		editAuthor.setText(getDescription(UmaViewsRepository.ToolMentor.Properties.author, UmaMessages.ToolMentorPropertiesEditionPart_AuthorLabel));
